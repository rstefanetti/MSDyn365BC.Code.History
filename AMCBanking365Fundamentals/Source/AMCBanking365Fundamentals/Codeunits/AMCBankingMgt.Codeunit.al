codeunit 20105 "AMC Banking Mgt."
{
    ...
    //AMC-JN - To substitute code in Codeunit 2 "Company-Initialize"
    ...
    procedure AMCBankInitializeBaseData(); //AMC-JN
    begin
    ...
    local procedure InitAMCBankingPmtTypes() //AMC-JN
    var
    ...
    local procedure InitPaymentMethods() //AMC-JN
    var
    ...
    local procedure InitBankClearingStandard() //AMC-JN
    var
    ...
    local procedure InsertBankClearingStandard(CodeText: Text[50]; DescriptionText: Text[80]) //AMC-JN
    var
    ...
    local procedure InsertAMCBankingPmtType(CodeText: Text[50]; DescriptionText: Text[80]) //AMC-JN
    var
        AMCBankPmtType: Record "AMC Bank Pmt. Type";
    begin
    ...
    local procedure InitBankDataConvServiceSetup() //AMC-JN
    var
        AMCBankServiceSetup: Record "AMC Banking Setup";
    begin
        with AMCBankServiceSetup do begin
    ...
    procedure GetLicenseNumber(): Text[40]; //AMC-JN 23-08-2019
    var
