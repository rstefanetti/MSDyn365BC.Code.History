                ...
                textelement(banktransjournal)
                {
                    ...
                    tableelement("Data Exch. Field"; "Data Exch. Field")
                    {
                        ...
                        textelement(banktransthem)
                        {
                            ...
                            textelement(paymenttypecode_sec) //AMC-JN - Only for NA, webservice is setting a default value
                            {
                                MinOccurs = Zero;
                            ...
                            textelement(paymenttypecode_atc) //AMC-JN - Only for NA, webservice is setting a default value
                            {
                                MinOccurs = Zero;
                                XmlName = 'paymenttypecode';
