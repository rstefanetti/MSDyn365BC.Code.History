page 9273 "Abs. Over. by Cat. Matrix"
{
    ...
    procedure Load(MatrixColumns1: array[32] of Text[80]; var MatrixRecords1: array[32] of Record "Time Activity"; PeriodType1: Option Day,Week,Month,Quarter,Year,"Accounting Period"; AbsenceAmountType1: Option "Balance at Date","Net Change"; EmployeeNoFilter1: Text)
    var
        i: Integer;
    begin
