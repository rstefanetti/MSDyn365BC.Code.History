table 85 "Acc. Schedule Line"
{
    ...
    fields
    {
        ...
        field(6; "Totaling Type"; Option)
        {
            ...
            OptionCaption = 'Posting Accounts,Total Accounts,Formula,,,Set Base For Percent,Cost Type,Cost Type Total,Cash Flow Entry Accounts,Cash Flow Total Accounts,,,,,Custom,Constant';
            OptionMembers = "Posting Accounts","Total Accounts",Formula,,,"Set Base For Percent","Cost Type","Cost Type Total","Cash Flow Entry Accounts","Cash Flow Total Accounts",,,,,Custom,Constant;
