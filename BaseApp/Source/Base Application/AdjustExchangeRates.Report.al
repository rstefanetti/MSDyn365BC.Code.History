report 595 "Adjust Exchange Rates"
{
    ...
    begin
        with GenJnlLine do
            if PostingAmount <> 0 then begin
                ...
                "Journal Template Name" := GenJnlLine2."Journal Template Name";
                "Journal Batch Name" := GenJnlLine2."Journal Batch Name";
    ...
    begin
        InitializeRequest(
          GenJournalLine."Posting Date", GenJournalLine."Posting Date", Text016, GenJournalLine."Posting Date",
