report 595 "Adjust Exchange Rates"
{
    ...
    var
        ...
        AdjVend: Boolean;
        AdjBank: Boolean;
        Text12401: Label 'You must determine period';
        TestMode: Boolean;
        ColumnDimPos: Text[250];
        Text12402: Label 'Dimensions';
    ...
    begin
        with GenJnlLine do
            if PostingAmount <> 0 then begin
                ...
                "Agreement No." := CVLedgEntryBuf."Agreement No.";
    ...
    begin
        with CusLedgerEntry do begin
            ...
            if GLSetup."Cancel Curr. Prepmt. Adjmt." and Prepayment then begin
                "Remaining Amt. (LCY)" :=
                  GetTaxAccRemainingAmt(0, "Entry No.", PostingDate2, "Remaining Amt. (LCY)");
    ...
    begin
        with VendLedgerEntry do begin
            ...
            if GLSetup."Cancel Curr. Prepmt. Adjmt." and Prepayment then begin
                "Remaining Amt. (LCY)" :=
                  GetTaxAccRemainingAmt(1, "Entry No.", PostingDate2, "Remaining Amt. (LCY)");
                TaxAccRemainingAmt := "Remaining Amt. (LCY)";
            end;
