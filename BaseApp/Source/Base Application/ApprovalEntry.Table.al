        ...
        case RecRef.Number of
            ...
            DATABASE::"Payment Order Header":
                begin
                    ...
                    PaymentOrderHeader.CalcFields("Bank Account Name", Amount);
            ...
            DATABASE::"Sales Advance Letter Header":
                begin
                    ...
                    exit(StrSubstNo('%1 ; %2: %3', SalesAdvanceLetterHeader."Bill-to Name",
                        SalesAdvanceLetterHeader.FieldCaption("Amount Including VAT"),
            ...
            DATABASE::"Purch. Advance Letter Header":
                begin
                    ...
                    exit(StrSubstNo('%1 ; %2: %3', PurchAdvanceLetterHeader."Pay-to Name",
                        PurchAdvanceLetterHeader.FieldCaption("Amount Including VAT"),
