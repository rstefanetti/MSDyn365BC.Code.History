codeunit 900 "Assembly-Post"
{
    ...
    begin
        ...
        ItemTrackingMgt.CheckWhseItemTrkgSetup(ItemJnlLine."Item No.", ItemJnlLine."Location Code", WhseSNRequired, WhseLNRequired, WhseCDRequired, false);
                    ...
                    if TrackingExists then begin
                        ...
                        if IsATOHeader then begin
                            ...
                            CreateReservEntry.CreateReservEntryFrom(
                              ...
                              "Qty. per Unit of Measure", "Serial No.", "Lot No.", "CD No.");
