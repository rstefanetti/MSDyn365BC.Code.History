report 10406 "Bank Rec. Process Lines"
{
    ...
    local procedure WriteAdjLine(BankRecHdr2: Record "Bank Rec. Header"; var BankRecLine2: Record "Bank Rec. Line"; UseRecordType: Option Check,Deposit,Adjustment; UseDocumentType: Option " ",Payment,Invoice,"Credit Memo","Finance Charge Memo",Reminder,Refund; UseDocumentNo: Code[20]; UseDescription: Text[100]; UseAmount: Decimal; UseExtDocNo: Code[35]; UseSourceType: Option Check,Deposit,Adjustment; DimSetID: Integer)
    var
        Ok: Boolean;
