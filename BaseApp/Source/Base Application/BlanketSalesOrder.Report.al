report 210 "Blanket Sales Order"
{
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(PmtTermsCaption; PaymentTermsCaptionLbl)
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(BankCaption; BankNameCaptionLbl)
                    {
                    }
                    column(AccNoCaption; BankAcctNoCaptionLbl)
                    {
                    }
                    ...
                    dataitem(DimensionLoop1; "Integer")
                    {
                        ...
                        column(HeaderDimCaption; HeaderDimensionsCaptionLbl)
                        {
                        }
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(PmtDiscGivenAmount_SalesLine; TotalPmtDiscGivenAmount)
                        {
                        }
                        ...
                        column(Amount1_SalesLineLine; "Sales Line"."Line Amount")
                        {
                        ...
                        column(LineAmtInvDiscAmtPmtDiscGivenAmt; SalesLine."Line Amount" - SalesLine."Inv. Discount Amount" - SalesLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(LineAmtInvDiscAmtPmtDiscGivenAmtVATAmt; SalesLine."Line Amount" - SalesLine."Inv. Discount Amount" - SalesLine."Pmt. Discount Amount" + VATAmount)
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        begin
                            ...
                            TotalPmtDiscGivenAmount += SalesLine."Pmt. Discount Amount";
                        end;
                    ...
                    dataitem(VATCounter; "Integer")
                    {
                        ...
                        column(VATAmtSpECPercentCaption; VATAmtSpecificationCaptionLbl)
                        {
                        }
                        column(VATIdentifierCaption; VATIdentifierCaptionLbl)
                        {
                        }
                        column(InvDiscBaseAmtCaption; InvDiscBaseAmountCaptionLbl)
                        {
                        }
                        column(LineAmtCaption; LineAmountCaptionLbl)
                        {
                        }
                        column(InvAndPmtDiscCaption; InvAndPmtDiscCaptionLbl)
                        {
                        }
    ...
    var
        ...
        TotalPmtDiscGivenAmount: Decimal;
        ...
        InvAndPmtDiscCaptionLbl: Label 'Invoice and Payment Discounts';
