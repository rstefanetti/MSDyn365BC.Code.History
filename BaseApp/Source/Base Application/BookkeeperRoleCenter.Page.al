    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group(Administration)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Automatic Acc. list (new)';
                    Image = Account;
        ...
        area(processing)
        {
            ...
            action("General Ledger Setup")
            {
                ...
                ToolTip = 'View or edit general information, such as rounding precision and document number series, regarding how the company keeps its accounts.';
            }
