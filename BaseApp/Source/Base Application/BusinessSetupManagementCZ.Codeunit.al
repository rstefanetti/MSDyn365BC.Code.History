codeunit 31071 "Business Setup Management CZ"
{
    ...
    var
        ...
        CashDeskEventsSetupNameTxt: Label 'Cash Desk Events Setup';
        ...
        CurrencyNominalValuesNameTxt: Label 'Currency Nominal Values';
        ...
        CashDeskSetupNameTxt: Label 'Cash Desk Setup';
        ...
        StatReportingSetupNameTxt: Label 'State/Statistic Reporting Setup';
        ...
        ExcelTemplateNameTxt: Label 'Excel Template';
        ...
        VATControlReportSectionsNameTxt: Label 'VAT Control Report Sections';
