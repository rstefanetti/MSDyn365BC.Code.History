table 847 "Cash Flow Forecast Entry"
{
    ...
    fields
    {
        ...
        field(14; "Source Type"; Option)
        {
            Caption = 'Source Type';
            Editable = false;
            OptionCaption = ' ,Receivables,Payables,Liquid Funds,Cash Flow Manual Expense,Cash Flow Manual Revenue,Sales Order,Purchase Order,Fixed Assets Budget,Fixed Assets Disposal,Service Orders,G/L Budget,Sales Advance Letters,Purchase Advance Letters,Job,Tax,Azure AI';
            OptionMembers = " ",Receivables,Payables,"Liquid Funds","Cash Flow Manual Expense","Cash Flow Manual Revenue","Sales Order","Purchase Order","Fixed Assets Budget","Fixed Assets Disposal","Service Orders","G/L Budget","Sales Advance Letters","Purchase Advance Letters",Job,Tax,"Azure AI";
        }
