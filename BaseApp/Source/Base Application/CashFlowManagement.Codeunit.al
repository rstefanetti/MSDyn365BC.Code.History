codeunit 841 "Cash Flow Management"
{
    ...
    begin
        case SourceType of
            ...
            CFWorksheetLine."Source Type"::"Sales Advance Letters":
                ShowSalesAdvLetters(SourceNo);
            CFWorksheetLine."Source Type"::"Purchase Advance Letters":
                ShowPurchAdvLetters(SourceNo);
            // NAVCZ
    ...
    begin
        ...
        CashFlowSetup.Validate(
            "S. Adv. Letter CF Account No.", GetNoFromSourceType(CashFlowAccount."Source Type"::"Sales Advance Letters".AsInteger()));
        CashFlowSetup.Validate(
            "P. Adv. Letter CF Account No.", GetNoFromSourceType(CashFlowAccount."Source Type"::"Purchase Advance Letters".AsInteger()));
