table 846 "Cash Flow Worksheet Line"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Source Type';
            OptionCaption = ' ,Receivables,Payables,Liquid Funds,Cash Flow Manual Expense,Cash Flow Manual Revenue,Sales Orders,Purchase Orders,Fixed Assets Budget,Fixed Assets Disposal,Service Orders,G/L Budget,Sales Advance Letters,Purchase Advance Letters,Job,Tax,Azure AI';
            OptionMembers = " ",Receivables,Payables,"Liquid Funds","Cash Flow Manual Expense","Cash Flow Manual Revenue","Sales Orders","Purchase Orders","Fixed Assets Budget","Fixed Assets Disposal","Service Orders","G/L Budget","Sales Advance Letters","Purchase Advance Letters",Job,Tax,"Azure AI";
