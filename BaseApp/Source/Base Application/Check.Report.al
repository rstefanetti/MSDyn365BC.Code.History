report 1401 Check
{
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("Journal Template Name", "Journal Batch Name", "Posting Date", "Document No.");
            column(JnTempName_GenJnlLine; "Journal Template Name")
            {
            }
            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                dataitem(PrintSettledLoop; "Integer")
                {
                    ...
                    column(LineAmtLineDiscount; LineAmount + LineDiscount)
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                ...
                dataitem(PrintCheck; "Integer")
                {
                    ...
                    column(CheckDateText_PrintCheck; CheckDateText)
                    {
                    }
                    ...
                    column(CheckToAddr1_PrintCheck; CheckToAddr[1])
                    {
                    }
                    ...
                    column(TotalLineAmount; TotalLineAmount - TotWHTAmount)
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    ...
                    column(TotalWHTText; TotalWHTText)
                    {
                    }
                    column(VoidText; VoidText)
                    {
                    }
                    column(TotWHTAmount; TotWHTAmount)
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
            ...
            begin
                ...
                InterestAmountLCY := "Interest Amount (LCY)";
