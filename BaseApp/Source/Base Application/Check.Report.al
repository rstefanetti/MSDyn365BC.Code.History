    ...
    dataset
    {
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                column(ChkToAddr1; CheckToAddr[1])
                {
                }
                column(ChkDateText; CheckDateText)
                {
                }
                column(ChkNoText; CheckNoText)
                {
                }
                ...
                dataitem(PrintSettledLoop; "Integer")
                {
                    ...
                    column(TotalLineDisc; TotalLineDiscount - LineDiscount)
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                    ...
                    column(CurrentLineAmt; CurrentLineAmount)
                    {
                        AutoFormatExpression = GenJnlLine."Currency Code";
                        AutoFormatType = 1;
                    }
                ...
                dataitem(PrintCheck; "Integer")
                {
                    DataItemTableView = SORTING(Number);
                    MaxIteration = 1;
                    column(ChkAmtText; CheckAmountText)
                    {
                    }
                    column(ChkDateText_PrintCheck; CheckDateText)
                    {
                    }
                    ...
                    column(ChkToAddr1_PrintCheck; CheckToAddr[1])
                    {
                    }
                    column(ChkToAddr2; CheckToAddr[2])
                    {
                    }
                    column(ChkToAddr4; CheckToAddr[4])
                    {
                    }
                    column(ChkToAddr3; CheckToAddr[3])
                    {
                    }
                    column(ChkToAddr5; CheckToAddr[5])
                    {
                    }
                    ...
                    column(ChkNoText_PrintCheck; CheckNoText)
                    {
                    }
