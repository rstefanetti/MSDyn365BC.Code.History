...
{
    DefaultLayout = RDLC;
    RDLCLayout = './CheckCheckStubStub.rdlc';
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
                ...
                dataitem(PrintSettledLoop; "Integer")
                {
                    ...
                    begin
                        ...
                        if PreprintedStub then
                            ...
                            TotalText := Text019Txt;
                            Stub2DocNoHeader := USText011Txt;
                            Stub2DocDateHeader := USText012Txt;
                            Stub2AmountHeader := USText013Txt;
                            Stub2DiscountHeader := USText014Txt;
                            Stub2NetAmountHeader := USText015Txt;
                            Stub2PostingDescHeader := USText017Txt;
                        end;
                        GLSetup.Get;
                        PageNo := PageNo + 1;
                    end;
                ...
                dataitem(PrintCheck; "Integer")
                {
                    ...
                    begin
                        if not TestPrint then begin
                            ...
                            if FoundLast and AddedRemainingAmount then begin
                                CheckAmountText := CopyStr(CheckLedgEntry.GetCheckAmountText(BankAcc2."Currency Code", CurrencySymbol), 1, 30);
                            ...
                            CheckLedgEntry."Posting Date" := GenJnlLine."Posting Date";
                            CheckLedgEntry."Document No." := UseCheckNo;
                            CheckLedgEntry.Description := Text023Txt;
                            ...
                            CheckAmountText := Text024Txt;
                            DescriptionLine[1] := Text025Txt;
                            DescriptionLine[2] := DescriptionLine[1];
                            VoidText := Text022Txt;
                        end;
                    ...
                    if not TestPrint then begin
                        ...
                        if ApplyMethod <> ApplyMethod::MoreLinesOneEntry then begin
                            ...
                            if BalancingType <> BalancingType::"G/L Account" then
                                GenJnlLine3.Description := StrSubstNo(Text014Txt, SelectStr(BalancingType + 1, Text062Txt), BalancingNo);
            ...
            begin
                ...
                if not TestPrint then begin
                    ...
                    BalancingNo := Text010Txt;
                    Clear(CheckToAddr);
                    for i := 1 to 5 do
                        CheckToAddr[i] := Text003Txt;
                    Clear(SalespersonPurchaser);
                    CheckNoText := Text011Txt;
                    if CheckStyle = CheckStyle::CA then
    ...
    var
        ...
        PrnChkCheckAmountText: array[2] of Text[40];
        ...
        USText014Txt: Label 'Discount';
        USText015Txt: Label 'Net Amount';
        PostingDesc: Text[100];
        USText017Txt: Label 'Posting Description';
        StartingLen: Integer;
        ControlLen: Integer;
        NewLen: Integer;
    ...
    local procedure ClearGlobalTextVariables()
    begin
    ...
    local procedure SetRemaningAmountToZero()
    begin
        DocNo := '';
        ExtDocNo := '';
    ...
    local procedure ApplyOneLineOneEntry(BalancingType: Option "G/L Account",Customer,Vendor,"Bank Account",,,Employee)
    begin
        case BalancingType of
            BalancingType::Customer:
