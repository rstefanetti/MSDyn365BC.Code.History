            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                dataitem(PrintSettledLoop; "Integer")
                {
                    ...
                    begin
                        ...
                        if TestPrint then begin
                            BankTransitNo := Text003Txt;
                            BankAccountNo := Text003Txt;
                        end;
                    ...
                    if not TestPrint then begin
                        ...
                        if ApplyMethod <> ApplyMethod::MoreLinesOneEntry then begin
                            ...
                            if BalancingType <> BalancingType::"G/L Account" then
                                GenJnlLine3.Description := StrSubstNo(Text014Txt, SelectStr(BalancingType.AsInteger() + 1, Text062Txt), BalancingNo);
