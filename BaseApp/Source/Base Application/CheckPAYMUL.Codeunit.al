codeunit 11000009 "Check PAYMUL"
{
    ...
    begin
        ...
        if (BankAcc."Acc. Hold. Country/Region Code" <> "Bank Country/Region Code") and
           (("Bank Name" = '') or ("Bank City" = ''))
        then begin
        ...
        if StrLen("Bank Account No.") <> 10 then
            Warning := StrSubstNo(Text1000008, FieldCaption("Bank Account No."));
        ...
        if ("Nature of the Payment" <> "Nature of the Payment"::" ") and
           (BankAcc."Acc. Hold. Country/Region Code" = "Bank Country/Region Code") and
           (Amount <= FreelyTransferableMaximum.Amount)
        then begin
            Warning := StrSubstNo(Text1000007,
