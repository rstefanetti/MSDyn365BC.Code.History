report 295 "Combine Shipments"
{
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("Document Type", "Combine Shipments", "Bill-to Customer No.", "Currency Code", "EU 3-Party Trade", "Dimension Set ID", "Journal Template Name") WHERE("Document Type" = CONST(Order), "Combine Shipments" = CONST(true));
    ...
    begin
        ...
        with SalesHeader do begin
            ...
            Validate("Journal Template Name", SalesOrderHeader."Journal Template Name");
    ...
    begin
        Finalize :=
          ...
          (SalesOrderHeader."Journal Template Name" <> SalesHeader."Journal Template Name");
