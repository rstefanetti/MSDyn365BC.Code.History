table 97 "Comment Line"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Table Name';
            OptionCaption = 'G/L Account,Customer,Vendor,Item,Resource,Job,,Resource Group,Bank Account,Campaign,Fixed Asset,Insurance,Nonstock Item,IC Partner,,,,,,,,,,Vendor Agreement,Customer Agreement';
            OptionMembers = "G/L Account",Customer,Vendor,Item,Resource,Job,,"Resource Group","Bank Account",Campaign,"Fixed Asset",Insurance,"Nonstock Item","IC Partner",,,,,,,,,,"Vendor Agreement","Customer Agreement";
        }
        field(2; "No."; Code[20])
        {
            Caption = 'No.';
