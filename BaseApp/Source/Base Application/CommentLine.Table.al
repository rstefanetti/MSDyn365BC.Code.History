table 97 "Comment Line"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Table Name';
            OptionCaption = 'G/L Account,Customer,Vendor,Item,Resource,Job,,Resource Group,Bank Account,Campaign,Fixed Asset,Insurance,Nonstock Item,IC Partner,,,,,,,,,,Historic G/L Account,New G/L Account';
            OptionMembers = "G/L Account",Customer,Vendor,Item,Resource,Job,,"Resource Group","Bank Account",Campaign,"Fixed Asset",Insurance,"Nonstock Item","IC Partner",,,,,,,,,,"Historic G/L Account","New G/L Account";
        }
        field(2; "No."; Code[20])
        {
            Caption = 'No.';
