codeunit 2 "Company-Initialize"
{
    ...
    var
        ...
        Text14800: Label 'PAYRJNL';
        Text14801: Label 'COMPRPAYR';
        Text14802: Label 'EMPLJNL';
        Text14803: Label 'EMPLVACJNL';
        Text14804: Label 'VACORDER';
        Text14805: Label 'SICKORDER';
        Text14806: Label 'PAYRDOC';
        Text14807: Label 'TRAVORDER';
        Text14808: Label 'OTHERORDER';
    ...
    begin
        ...
        ReportSelectionMgt.InitReportSelectionFixedAssets;
    end;
