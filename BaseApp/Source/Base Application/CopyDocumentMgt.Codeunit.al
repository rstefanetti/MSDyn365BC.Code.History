codeunit 6620 "Copy Document Mgt."
{
    ...
    begin
        with ToSalesHeader do begin
            ...
            then
                UpdateCustLedgEntry(ToSalesHeader, FromDocType, FromDocNo, FromSalesInvHeader);
    ...
    local procedure TestPurchEfecs(FromDocType: Option; var ToPurchHeader: Record "Purchase Header"; var FromPurchInvHeader: Record "Purch. Inv. Header"; var VendorLedgEntry: Record "Vendor Ledger Entry")
    var
        ErrorCount: Integer;
    ...
    local procedure TestSalesEfecs(FromDocType: Option; var ToSalesHeader: Record "Sales Header"; var FromSalesInvHeader: Record "Sales Invoice Header"; var CustLedgerEntry: Record "Cust. Ledger Entry")
    var
        ErrorCount: Integer;
    ...
    local procedure UpdateCustLedgEntry(var ToSalesHeader: Record "Sales Header"; FromDocType: Option; FromDocNo: Code[20]; FromSalesInvHeader: Record "Sales Invoice Header")
    var
        CustLedgEntry: Record "Cust. Ledger Entry";
    begin
    ...
    procedure UpdateVendLedgEntry(var ToPurchHeader: Record "Purchase Header"; FromDocType: Option; FromDocNo: Code[20]; FromPurchInvHeader: Record "Purch. Inv. Header")
    var
        VendLedgEntry: Record "Vendor Ledger Entry";
    begin
