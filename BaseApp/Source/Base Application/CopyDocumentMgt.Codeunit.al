codeunit 6620 "Copy Document Mgt."
{
    ...
    begin
        with ToSalesHeader do begin
            ...
            FromSalesHeader."Prepmt. Diff. Appln. Entry No." := ToSalesHeader."Prepmt. Diff. Appln. Entry No.";
            FromSalesHeader."Prepmt. Diff." := ToSalesHeader."Prepmt. Diff.";
    ...
    begin
        ...
        if (ToSalesHeader."Prepmt. Diff. Appln. Entry No." = 0) and not ToSalesHeader."Prepmt. Diff." then
    ...
    begin
        ...
        if (FromPurchLine.Type <> FromPurchLine.Type::" ") and (FromPurchLine."No." <> '') then begin
            if ToPurchLine.Type = ToPurchLine.Type::"G/L Account" then begin
                ...
                ToPurchLine.Validate("No.", FromPurchLine."No.");
            if (FromPurchLine.Type = FromPurchLine.Type::"Fixed Asset") and (FromPurchLine."FA Charge No." <> '') then
                ToPurchLine.Validate("FA Charge No.", FromPurchLine."FA Charge No.");
    ...
    var
        ...
        ToSalesLine: Record "Sales Line";
    begin
        if not (ToSalesHeader."Document Type" in [ToSalesHeader."Document Type"::Order, ToSalesHeader."Document Type"::Invoice]) or
          (ToSalesHeader."Prepmt. Diff.")
        then
            exit;
    ...
    begin
        ...
        if (ToSalesHeader."Prepmt. Diff. Appln. Entry No." <> 0) or ToSalesHeader."Prepmt. Diff." then
            exit;
    ...
    begin
        ...
        if (ToPurchHeader."Prepmt. Diff. Appln. Entry No." <> 0) or ToPurchHeader."Prepmt. Diff." then
            exit;
    ...
    begin
        ...
        if TempItemLedgerEntry.FindSet then
            repeat
                if (TempItemLedgerEntry."Lot No." <> '') or (TempItemLedgerEntry."CD No." <> '') then begin
