codeunit 6620 "Copy Document Mgt."
{
    ...
    begin
        with ToSalesHeader do begin
            ...
            if (("Document Type" in ["Document Type"::"Return Order", "Document Type"::"Credit Memo"]) and
                not (FromDocType in [SalesDocType::"Return Order", SalesDocType::"Credit Memo"])) or
                (not ("Document Type" in ["Document Type"::"Return Order", "Document Type"::"Credit Memo"]) and
                (FromDocType in [SalesDocType::"Return Order", SalesDocType::"Credit Memo"]))
            then
    ...
    begin
        with ToPurchHeader do begin
            ...
            if (("Document Type" in ["Document Type"::"Return Order", "Document Type"::"Credit Memo"]) and
                not (FromDocType in [PurchDocType::"Return Order", PurchDocType::"Credit Memo"])) or
                (not ("Document Type" in ["Document Type"::"Return Order", "Document Type"::"Credit Memo"]) and
                (FromDocType in [PurchDocType::"Return Order", PurchDocType::"Credit Memo"]))
            then
