codeunit 6620 "Copy Document Mgt."
{
    ...
    begin
        with ToSalesHeader do begin
            ...
            if (("Document Type" in ["Document Type"::"Return Order", "Document Type"::"Credit Memo"]) and
                not (FromDocType in ["Sales Document Type From"::"Return Order", "Sales Document Type From"::"Credit Memo"])) or
                (not ("Document Type" in ["Document Type"::"Return Order", "Document Type"::"Credit Memo"]) and
                (FromDocType in ["Sales Document Type From"::"Return Order", "Sales Document Type From"::"Credit Memo"]))
            then
                "Journal Template Name" := OldSalesHeader."Journal Template Name";
    ...
    begin
        with ToPurchHeader do begin
            ...
            if (("Document Type" in ["Document Type"::"Return Order", "Document Type"::"Credit Memo"]) and
                not (FromDocType in ["Purchase Document Type From"::"Return Order", "Purchase Document Type From"::"Credit Memo"])) or
                (not ("Document Type" in ["Document Type"::"Return Order", "Document Type"::"Credit Memo"]) and
                (FromDocType in ["Purchase Document Type From"::"Return Order", "Purchase Document Type From"::"Credit Memo"]))
            then
                "Journal Template Name" := OldPurchHeader."Journal Template Name";
