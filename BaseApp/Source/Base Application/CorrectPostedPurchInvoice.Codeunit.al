codeunit 1313 "Correct Posted Purch. Invoice"
{
    ...
    begin
        ...
        SetCrMemoDefaultReasonCode(PurchaseHeader);
    end;
    ...
    local procedure SetCrMemoDefaultReasonCode(var PurchaseHeader: Record "Purchase Header")
    var
        PurchasesPayablesSetup: Record "Purchases & Payables Setup";
    begin
        ...
        PurchasesPayablesSetup.Get;
        PurchaseHeader.Validate("Reason Code", PurchasesPayablesSetup."Default Cancel Reason Code");
        PurchaseHeader.Modify;

        OnAfterSetDefaultCancelReasonCode(PurchaseHeader);
    end;
