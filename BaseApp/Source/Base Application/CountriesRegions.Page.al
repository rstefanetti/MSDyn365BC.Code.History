    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Local Name"; "Local Name")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the local name of a country/region.';
                }
                ...
                field("EAEU Country/Region Code"; "EAEU Country/Region Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the country/region code for EAEU (Eurasian Economic Union).';
                }
            }
        }
        area(factboxes)
