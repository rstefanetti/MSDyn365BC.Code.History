    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("SEPA Allowed"; "SEPA Allowed")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("IBAN Country/Region"; "IBAN Country/Region")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if this country/region uses the International Bank Account Number (IBAN) format to identify bank accounts.';
                }
