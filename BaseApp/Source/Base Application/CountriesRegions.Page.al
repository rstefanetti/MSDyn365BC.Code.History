    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("VAT Registration No. digits"; "VAT Registration No. digits")
                {
                    ApplicationArea = VAT;
                    ToolTip = 'Specifies the number of digits in the VAT registration numbers for the country/region.';
                    Visible = false;
                }
