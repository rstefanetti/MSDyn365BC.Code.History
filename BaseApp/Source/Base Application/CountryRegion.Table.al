table 9 "Country/Region"
{
    ...
    fields
    {
        ...
        field(12401; "Local Country/Region Code"; Code[10])
        {
            Caption = 'Local Country/Region Code';
        }
        field(12402; "EAEU Country/Region Code"; Code[10])
        {
            Caption = 'EAEU Country/Region Code';
        }
    }
    ...
    [Scope('OnPrem')]
    procedure IsEAEUCountry(): Boolean
    var
        CompanyInformation: Record "Company Information";
        CompInfCountryRegion: Record "Country/Region";
    begin
