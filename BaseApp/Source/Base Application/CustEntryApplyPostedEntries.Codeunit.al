codeunit 226 "CustEntry-Apply Posted Entries"
{
    ...
    begin
        ...
        if DtldCustLedgEntry.Find('-') then
            repeat
                if CheckVATSettlement(DtldCustLedgEntry."Cust. Ledger Entry No.", DtldCustLedgEntry."Posting Date") then
                    Error(Text12100, CustLedgEntry."Document Type", CustLedgEntry."Document No.");
