codeunit 226 "CustEntry-Apply Posted Entries"
{
    ...
    begin
        if PreviewMode then
            ...
            Apply(
              Rec, "Document No.", ApplicationDate, GLSetup."Jnl. Templ. Name for Applying", GLSetup."Jnl. Batch Name for Applying");
        end;
    end;
    ...
    procedure Apply(CustLedgEntry: Record "Cust. Ledger Entry"; DocumentNo: Code[20]; ApplicationDate: Date; JnlTemplateName: Code[10]; JnlBatchName: Code[10]): Boolean
    var
    ...
    begin
        ...
        with CustLedgEntry do begin
            ...
            CustPostApplyCustLedgEntry(CustLedgEntry, DocumentNo, ApplicationDate, JnlTemplateName, JnlBatchName);
            exit(true);
        end;
    end;
    ...
    local procedure CustPostApplyCustLedgEntry(CustLedgEntry: Record "Cust. Ledger Entry"; DocumentNo: Code[20]; ApplicationDate: Date; JnlTemplateName: Code[10]; JnlBatchName: Code[10])
    var
    ...
    procedure PreviewApply(CustLedgEntry: Record "Cust. Ledger Entry"; DocumentNo: Code[20]; ApplicationDate: Date; JnlTemplateName: Code[10]; JnlBatchName: Code[10])
    var
        GenJnlPostPreview: Codeunit "Gen. Jnl.-Post Preview";
    ...
    begin
        ...
        CustEntryApplyPostedEntries.SetApplyContext(ApplicationDate, DocumentNo, JnlTemplateName, JnlBatchName);
