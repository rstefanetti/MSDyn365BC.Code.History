    ...
    begin
        ...
        if TempCustLedgEntry.FindSet then
            repeat
                ...
                CustLedgEntryToUpdate.TestField("Prepayment Type", ApplyingCustLedgEntry."Prepayment Type");  // NAVCZ
                ...
                then
                    ...
                    if CustLedgEntryToUpdate."Amount to Apply" = 0 then begin
                        ...
                        // NAVCZ
                        if CustLedgEntryToUpdate."Document Type" = CustLedgEntryToUpdate."Document Type"::Payment then
                            if CustLedgEntryToUpdate.Prepayment then begin
                                LinkedNotUsedAmt := CustLedgEntryToUpdate.CalcLinkAdvAmount;
                                CustLedgEntryToUpdate."Amount to Apply" := CustLedgEntryToUpdate."Amount to Apply" + LinkedNotUsedAmt;
                            end;
                        CustLedgEntryToUpdate.TestAdvLink;
                        // NAVCZ
                    end;
