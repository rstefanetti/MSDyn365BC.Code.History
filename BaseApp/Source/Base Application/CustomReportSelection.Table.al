table 9657 "Custom Report Selection"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Usage';
            OptionCaption = 'S.Quote,S.Order,S.Invoice,S.Cr.Memo,S.Test,P.Quote,P.Order,P.Invoice,P.Cr.Memo,P.Receipt,P.Ret.Shpt.,P.Test,B.Stmt,B.Recon.Test,B.Check,Reminder,Fin.Charge,Rem.Test,F.C.Test,Prod.Order,S.Blanket,P.Blanket,M1,M2,M3,M4,Inv1,Inv2,Inv3,SM.Quote,SM.Order,SM.Invoice,SM.Credit Memo,SM.Contract Quote,SM.Contract,SM.Test,S.Return,P.Return,S.Shipment,S.Ret.Rcpt.,S.Work Order,Invt.Period Test,SM.Shipment,S.Test Prepmt.,P.Test Prepmt.,S.Arch.Quote,S.Arch.Order,P.Arch.Quote,P.Arch.Order,S.Arch.Return,P.Arch.Return,USI,USCM,UCI,UCO,CB,CI,CO,UAS,AS,UIS,UIR,,IS,IR,,UFAW,UFAR,UFAM,FAW,FAR,FAM,FAJ,FARJ,PIJ,UPI,IRJ,UPCM,Asm.Order,P.Asm.Order,DT,S.Order Pick Instruction,UCSD,CSI,CSCM,C.Statement,V.Remittance,JQ,S.Invoice Draft,Pro Forma S. Invoice,P.Arch.Blanket,S.Arch.Blanket';
