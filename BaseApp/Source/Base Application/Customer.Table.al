table 18 Customer
{
    ...
    fields
    {
        ...
        field(12481; "OKPO Code"; Code[10])
        {
            Caption = 'OKPO Code';
        }
        field(12490; "Agreement Posting"; Option)
        {
        ...
        field(12494; "Agreement Nos."; Code[20])
        {
    ...
    [Scope('OnPrem')]
    procedure CopyFromVendor(var Cust: Record Customer)
    var
        Vend: Record Vendor;
        Text12400: Label 'Copy General information\from Vendor %3 (%4)\to Customer %2 (%1)?';
    begin
    ...
    [Scope('OnPrem')]
    procedure CollectPrepayments(CustNo: Code[20]; DocNo: Code[20]; var TempCustLedgEntry: Record "Cust. Ledger Entry" temporary)
    var
        CustLedgEntry: Record "Cust. Ledger Entry";
