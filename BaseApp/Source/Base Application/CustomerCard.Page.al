    ...
    layout
    {
        area(content)
        {
            ...
            group(Vendor)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the vendor number associated with the customer.';
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the vendor name associated with the customer.';
                    Visible = VendorNameVisible;
                }
                field(VendorBalance; Vend."Balance (LCY)")
                {
                    ApplicationArea = All;
                ...
                field(TotalBalance; "Balance (LCY)" - Vend."Balance (LCY)")
                {
                    ApplicationArea = All;
            ...
            group(Invoicing)
            {
                ...
                field("Act Signed by Name"; "Act Signed by Name")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'This field is used internally.';
                }
                field("Act Signed by Position"; "Act Signed by Position")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'This field is used internally.';
                }
            ...
            group(Payments)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the default bank code associated with the customer.';
                }
                field("KPP Code"; "KPP Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the code of the company registration associated with the customer.';
                }
                field("OKPO Code"; "OKPO Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the Classification of Enterprises and Organizations code associated with the customer.';
                }
        ...
        area(navigation)
        {
            group("&Customer")
            {
                ...
                action(Agreements)
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Category8;
                    RunObject = Page "Customer Agreements";
                    RunPageLink = "Customer No." = FIELD("No.");
            ...
            group(History)
            {
                ...
                action("Copy from Vendor")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Copy from Vendor';
                    Image = Vendor;
                ...
                action("Combine Customers")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Combine Customers';
                    Image = "Action";
                    ToolTip = 'Combine information about two customers.';
