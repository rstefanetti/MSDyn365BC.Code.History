    ...
    layout
    {
        area(content)
        {
            ...
            group(Payments)
            {
                ...
                field("Payment Balance (LCY)"; "Balance (LCY)")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the payment amount that the customer owes for completed sales. This value is also known as the customer''s balance.';
                ...
                field("Payment in progress (LCY)"; "Payment in progress (LCY)")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the customer''s payments in progress.';
                }
                field("""Balance (LCY)"" - ""Payment in progress (LCY)"""; "Balance (LCY)" - "Payment in progress (LCY)")
                {
                    ApplicationArea = Basic, Suite;
