page 302 "Customer Entry Statistics"
{
            ...
            group("Last Documents")
            {
                ...
                fixed(Control1903895301)
                {
                    ...
                    group(Date)
                    {
                        ...
                        field("CustLedgEntry[21].""Posting Date"""; CustLedgEntry[21]."Posting Date")
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Bill';
                            ToolTip = 'Specifies the amount for bills.';
                        }
                    ...
                    group("Document No.")
                    {
                        ...
                        field("CustLedgEntry[21].""Document No."""; CustLedgEntry[21]."Document No.")
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Document No.';
                    ...
                    group("Currency Code")
                    {
                        ...
                        field("CustLedgEntry[21].""Currency Code"""; CustLedgEntry[21]."Currency Code")
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Currency Code';
                    ...
                    group(Amount)
                    {
                        ...
                        field("CustLedgEntry[21].Amount"; CustLedgEntry[21].Amount)
                        {
                            ApplicationArea = Basic, Suite;
                            AutoFormatExpression = CustLedgEntry[21]."Currency Code";
                            AutoFormatType = 1;
                            Caption = 'Amount';
                            ToolTip = 'Specifies the paid amount.';
                        }
                    ...
                    group("Remaining Amount")
                    {
                        ...
                        field("CustLedgEntry[21].""Remaining Amount"""; CustLedgEntry[21]."Remaining Amount")
                        {
                            ApplicationArea = Basic, Suite;
                            AutoFormatExpression = CustLedgEntry[21]."Currency Code";
                            AutoFormatType = 1;
            ...
            group("No. of Documents")
            {
                ...
                fixed(Control1904230801)
                {
                    ...
                    group("This Period")
                    {
                        ...
                        field("NoOfDoc[1][21]"; NoOfDoc[1] [21])
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Bills';
                            ToolTip = 'Specifies the number of bills.';
                        }
                    ...
                    group("This Year")
                    {
                        ...
                        field("NoOfDoc[2][21]"; NoOfDoc[2] [21])
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Finance Charge Memos';
                            ToolTip = 'Specifies the amount for finance charge memos.';
                        }
                    ...
                    group("Last Year")
                    {
                        ...
                        field("NoOfDoc[3][21]"; NoOfDoc[3] [21])
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Finance Charge Memos';
                            ToolTip = 'Specifies the number of finance charge memos.';
                        }
                    ...
                    group("Remaining Amt. (LCY)")
                    {
                        ...
                        field("TotalRemainAmountLCY[21]"; TotalRemainAmountLCY[21])
                        {
                            ApplicationArea = Basic, Suite;
                            AutoFormatType = 1;
                            Caption = 'Remaining Amt. (LCY)';
    ...
    var
        CustLedgEntry: array[21] of Record "Cust. Ledger Entry";
        ...
        TotalRemainAmountLCY: array[21] of Decimal;
        NoOfDoc: array[3, 21] of Integer;
