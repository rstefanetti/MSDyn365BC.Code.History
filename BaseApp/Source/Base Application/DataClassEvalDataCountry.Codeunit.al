codeunit 1752 "Data Class. Eval. Data Country"
{
    ...
    begin
        ...
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"BAS Setup");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"BAS Calculation Sheet");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"BAS XML Field ID");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"BAS Business Unit");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"BAS Calc. Sheet Entry");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"BAS Comment Line");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"BAS Setup Name");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"BAS XML Field Setup Name");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"BAS XML Field ID Setup");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"EFT Register");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Address ID");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::County);
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"WHT Business Posting Group");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"WHT Product Posting Group");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"WHT Revenue Types");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"WHT Posting Setup");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"WHT Entry");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Sales Tax Invoice Header");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Sales Tax Invoice Line");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Sales Tax Cr.Memo Header");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Sales Tax Cr.Memo Line");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Purch. Tax Inv. Header");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Purch. Tax Inv. Line");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Purch. Tax Cr. Memo Hdr.");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Purch. Tax Cr. Memo Line");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"Post Dated Check Line");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"GST Purchase Entry");
        DataClassificationEvalData.SetTableFieldsToNormal(DATABASE::"GST Sales Entry");
