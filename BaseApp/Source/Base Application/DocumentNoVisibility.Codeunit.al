codeunit 1400 DocumentNoVisibility
{
    ...
    procedure SalesDocumentNoIsVisible(DocType: Option Quote,"Order",Invoice,"Credit Memo","Blanket Order","Return Order",Reminder,FinChMemo,"Advance Letter"; DocNo: Code[20]): Boolean
    var
