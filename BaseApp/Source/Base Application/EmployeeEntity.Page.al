page 5483 "Employee Entity"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field(middleName; "Second Family Name")
                {
                    ApplicationArea = All;
                    ...
                    trigger OnValidate()
                    begin
                        RegisterFieldSet(FieldNo("Second Family Name"));
                    end;
                }
                field(surname; "First Family Name")
                {
                    ApplicationArea = All;
                    ...
                    trigger OnValidate()
                    begin
                        RegisterFieldSet(FieldNo("First Family Name"));
                    end;
                }
    ...
    begin
        ...
        DisplayName := StrSubstNo('%1 %2', Name, "First Family Name");
    end;
