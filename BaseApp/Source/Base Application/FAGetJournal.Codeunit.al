codeunit 5639 "FA Get Journal"
{
    ...
    procedure JnlName(DeprBookCode: Code[10]; BudgetAsset: Boolean; FAPostingType: Option "Acquisition Cost",Depreciation,"Write-Down",Appreciation,"Custom 1","Custom 2",Disposal,Maintenance,"Salvage Value",,,,Derogatory; var GLIntegration: Boolean; var TemplateName: Code[10]; var BatchName: Code[10])
    var
    ...
    local procedure CalcGLIntegration(BudgetAsset: Boolean; FAPostingType: Option "Acquisition Cost",Depreciation,"Write-Down",Appreciation,"Custom 1","Custom 2",Disposal,Maintenance,"Salvage Value",,,,Derogatory): Boolean
    begin
        if BudgetAsset then
            exit(false);
        with DeprBook do
            case FAPostingType of
                ...
                FAPostingType::Derogatory:
                    exit("G/L Integration - Derogatory");
            end;
    end;
}
