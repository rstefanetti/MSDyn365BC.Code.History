codeunit 5600 "FA Insert Ledger Entry"
{
    ...
    var
        ...
        FAPostingType: Option " ",AcqCost,BookVal,Appreciation,WrDown;
        ReasonMaintenanceCode: Code[20];
    ...
    begin
        ...
        if not CalcGLIntegration(FALedgEntry) then
            ...
            // NAVCZ
            FAInsertGLAcc.SetFAPostingType(FAPostingType);
            // NAVCZ
    ...
    begin
        ...
        // NAVCZ
        // NextMaintenanceEntryNo Correction;
        if MaintenanceLedgEntry.FindLast then
            NextMaintenanceEntryNo := MaintenanceLedgEntry."Entry No.";
        // NAVCZ
    ...
    begin
        // NAVCZ
        FAInsertGLAcc.SetReasonMaintenanceCode(FALedgEntry."Reason Code");
        // NAVCZ
    ...
    begin
        // NAVCZ
        FAInsertGLAcc.SetReasonMaintenanceCode(ReasonMaintenanceCode);
        // NAVCZ
    ...
    begin
        // NAVCZ
        ReasonMaintenanceCode := ReasonMaintenanceCode2;
    end;
