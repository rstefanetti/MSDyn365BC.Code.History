codeunit 5632 "FA Jnl.-Post Line"
{
    ...
    var
        ...
        FAPostingType: Option "Acquisition Cost",Depreciation,"Write-Down",Appreciation,"Custom 1","Custom 2",Disposal,Maintenance,"Salvage Value",,,,Derogatory;
        FAPostingDate: Date;
        Amount2: Decimal;
    ...
    begin
        with FALedgerEntry do begin
            ...
            SetRange(Amount, -SourceFAJournalLine.Amount);
