    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the description associated with the fixed asset posting group.';
                }
            ...
            group("Balancing Account")
            {
                ...
                field("Disposal Expense Account"; "Disposal Expense Account")
                {
                    ApplicationArea = FixedAssets;
                    Caption = 'Disposal Expence Account';
                    ToolTip = 'Specifies the disposal expense account associated with the fixed asset posting group.';
                }
            }
            ...
            group(Prepayment)
            {
                ...
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the purchases prepayment document gains account associated with the fixed asset posting group.';
                }
                field("Purch. PD Losses Acc."; "Purch. PD Losses Acc.")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the purchases prepayment document losses account associated with the fixed asset posting group.';
                }
                field("Purch. PD Charge FCY (FA)"; "Purch. PD Charge FCY (FA)")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the purchases prepayment document charge associated with the fixed asset posting group.';
                }
                field("Purch. PD Charge Conv. (FA)"; "Purch. PD Charge Conv. (FA)")
                {
                    ApplicationArea = FixedAssets;
                    ToolTip = 'Specifies the purchases prepayment document charge conversion associated with the fixed asset posting group.';
                }
            }
        }
        area(factboxes)
