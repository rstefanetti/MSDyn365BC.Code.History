    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Derogatory Account"; "Derogatory Account")
                {
                    ApplicationArea = FixedAssets;
                ...
                field("Derogatory Acc. (Decrease)"; "Derogatory Acc. (Decrease)")
                {
                    ApplicationArea = FixedAssets;
            ...
            group("Balancing Account")
            {
                ...
                field("Derogatory Expense Account"; "Derogatory Expense Account")
                {
                    ApplicationArea = FixedAssets;
                ...
                field("Derog. Bal. Acc. (Decrease)"; "Derog. Bal. Acc. (Decrease)")
                {
                    ApplicationArea = FixedAssets;
            ...
            group(Allocation)
            {
                ...
                field("Allocated Derogatory %"; "Allocated Derogatory %")
                {
                    ApplicationArea = FixedAssets;
                    Caption = 'Derogatory';
