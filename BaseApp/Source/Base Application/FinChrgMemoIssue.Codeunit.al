codeunit 395 "FinChrgMemo-Issue"
{
        ...
        with FinChrgMemoHeader do begin
            ...
            if FinChrgMemoLine.FindSet then
                repeat
                    ...
                    if DtldFinChargeMemoLine.Find('-') then
                        repeat
                            DtldIssFinChargeMemoLine.Init();
    ...
    var
        ...
        DtldIssFinChargeMemoLine: Record "Detailed Iss.Fin.Ch. Memo Line";
    ...
    begin
        with FinChrgMemoHeader do begin
            ...
            // NAVCZ
            GenJnlLine.Validate("Posting Group", "Customer Posting Group");
            // NAVCZ
    ...
    begin
        ...
        // NAVCZ
        DtldIssFinChargeMemoLine.SetRange("Finance Charge Memo No.", IssuedFinChrgMemoHeader."No.");
        DtldIssFinChargeMemoLine.DeleteAll();
        // NAVCZ
    end;
