report 123 "Finance Charge Memo - Test"
{
        ...
        dataitem("Finance Charge Memo Header"; "Finance Charge Memo Header")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                        ...
                        if not "Detailed Interest Rates Entry" then begin
                            ...
                            if VATPostingSetup.Get(Cust."VAT Bus. Posting Group", "VAT Prod. Posting Group") then
                                if VATPostingSetup."VAT %" <> 0 then begin
                                    ...
                                    VATAmountLine.SetCurrencyCode("Finance Charge Memo Header"."Currency Code");
                ...
                dataitem(VATCounter; "Integer")
                {
                    ...
                    column(VATAmountLine__Amount_Including_VAT_EC_; VATAmountLine."Amount Including VAT")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode;
                        AutoFormatType = 1;
                    }
                    ...
                    column(VATAmountLine__VAT_EC_Base__Control56; VATAmountLine."VAT Base")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode;
                        AutoFormatType = 1;
                    }
                    ...
                    column(VATAmountLine__Amount_Including_VAT_EC__Control73; VATAmountLine."Amount Including VAT")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode;
                        AutoFormatType = 1;
                    }
                    column(VATAmountLine__EC_Amount__Control1100002; VATAmountLine."EC Amount")
                    {
                    }
                    ...
                    column(VATAmountLine__VAT_EC_Base__Control52; VATAmountLine."VAT Base")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode;
                        AutoFormatType = 1;
                    }
                    column(VATAmountLine__Amount_Including_VAT_EC__Control78; VATAmountLine."Amount Including VAT")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode;
                        AutoFormatType = 1;
                    }
                    column(VATAmountLine__EC_Amount__Control1100003; VATAmountLine."EC Amount")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode;
                        AutoFormatType = 1;
                    }
                    column(VATAmountLine__EC_Amount__Control1100145; VATAmountLine."EC Amount")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode;
                        AutoFormatType = 1;
                    }
                    column(VATAmountLine__VAT_EC_Base__Control49; VATAmountLine."VAT Base")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode;
                        AutoFormatType = 1;
                    }
                    column(VATAmountLine__Amount_Including_VAT_EC__Control80; VATAmountLine."Amount Including VAT")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode;
                        AutoFormatType = 1;
                    }
                    column(VATAmountLine__VAT_Amount__Control1100004; VATAmountLine."VAT Amount")
                    {
                        AutoFormatExpression = "Finance Charge Memo Line".GetCurrencyCode;
                        AutoFormatType = 1;
                    }
                    ...
                    column(VAT_EC_BaseCaption; VAT_EC_BaseCaptionLbl)
                    {
                    }
                    ...
                    column(VATAmountLine__Amount_Including_VAT_EC__Control73Caption; VATAmountLine__Amount_Including_VAT_EC__Control73CaptionLbl)
                    {
                    }
                    ...
                    column(VATAmountLine__VAT_EC_Base__Control52Caption; VATAmountLine__VAT_EC_Base__Control52CaptionLbl)
                    {
                    }
                    column(VATAmountLine__VAT_EC_Base__Control49Caption; VATAmountLine__VAT_EC_Base__Control49CaptionLbl)
                    {
                    }
    ...
    var
        ...
        VAT_EC_BaseCaptionLbl: Label 'VAT+EC Base';
