    ...
    dataset
    {
        dataitem("Finance Charge Memo Header"; "Finance Charge Memo Header")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                column(FinChgMemoNo; StrSubstNo('%1 %2', FinChgMemoNoCaptionLbl, "Finance Charge Memo Header"."No."))
                {
                }
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(ShowMIR; ShowMIRLines)
                    {
                        ...
                        ToolTip = 'Specifies that information for multiple interest rates is included.';
                    }
                }
            }
        }
