table 15 "G/L Account"
{
    ...
    fields
    {
        ...
        field(12404; "Source Type"; Option)
        {
            Caption = 'Source Type';
        ...
        field(12406; "Source No. Filter"; Code[20])
        {
            ...
            ELSE
            IF ("Source Type Filter" = FILTER(Vendor)) Vendor
            ELSE
            IF ("Source Type Filter" = FILTER("Bank Account")) "Bank Account"
            ELSE
            IF ("Source Type Filter" = FILTER("Fixed Asset")) "Fixed Asset";
        }
        field(12407; "Credit Amount at Date (ACY)"; Decimal)
        {
            CalcFormula = Sum ("G/L Entry"."Add.-Currency Credit Amount" WHERE("G/L Account No." = FIELD("No."),
                                                                               ...
                                                                               "Source Type" = FIELD("Source Type Filter"),
                                                                               "Source No." = FIELD("Source No. Filter")));
            Caption = 'Credit Amount at Date (ACY)';
            FieldClass = FlowField;
        }
        field(12408; "Debit Amount at Date (ACY)"; Decimal)
        {
            CalcFormula = Sum ("G/L Entry"."Add.-Currency Debit Amount" WHERE("G/L Account No." = FIELD("No."),
                                                                              ...
                                                                              "Source Type" = FIELD("Source Type Filter"),
                                                                              "Source No." = FIELD("Source No. Filter")));
            Caption = 'Debit Amount at Date (ACY)';
            FieldClass = FlowField;
        }
        field(12460; "Currency Code"; Code[10])
        {
            Caption = 'Currency Code';
            TableRelation = Currency;
        }
        field(12461; "Balance in Currency"; Decimal)
        {
            AutoFormatType = 1;
            Caption = 'Balance in Currency';
        }
        field(12462; "Adjust Debit Acc."; Code[20])
        {
            Caption = 'Adjust Debit Acc.';
        }
        field(12463; "Adjust Credit Acc."; Code[20])
        {
            Caption = 'Adjust Credit Acc.';
        }
    }
    ...
    [Scope('OnPrem')]
    procedure CalculateAmounts(var BalanceAmounts: array[7] of Decimal)
    var
