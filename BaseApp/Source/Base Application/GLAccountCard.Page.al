    ...
    layout
    {
        area(content)
        {
            ...
            group(Consolidation)
            {
                ...
                field("Balance in Currency"; "Balance in Currency")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the balance of the general ledger account.';
                }
                field("Adjust Debit Acc."; "Adjust Debit Acc.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the adjustment debit account for the general ledger account.';
                }
                field("Adjust Credit Acc."; "Adjust Credit Acc.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the adjustment credit account for the general ledger account.';
                }
            }
            group(Reporting)
            {
