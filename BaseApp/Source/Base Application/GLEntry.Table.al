table 17 "G/L Entry"
{
    ...
    fields
    {
        ...
        field(12400; "Used in Correspondence"; Boolean)
        {
            Caption = 'Used in Correspondence';
            Editable = false;
        }
        field(12490; "Agreement No."; Code[20])
        {
            Caption = 'Agreement No.';
            TableRelation = IF ("Source Type" = CONST(Customer)) "Customer Agreement"."No." WHERE("Customer No." = FIELD("Source No."))
            ELSE
            IF ("Source Type" = CONST(Vendor)) "Vendor Agreement"."No." WHERE("Vendor No." = FIELD("Source No."));
        }
    }
    ...
    keys
    {
        ...
        key(Key13; "Source Type", "Source No.", "Agreement No.", "G/L Account No.", "Global Dimension 1 Code", "Global Dimension 2 Code", "Business Unit Code", "Posting Date")
        {
            SumIndexFields = Amount, "Debit Amount", "Credit Amount", "Additional-Currency Amount", "Add.-Currency Debit Amount", "Add.-Currency Credit Amount";
        }
        key(Key14; "G/L Account No.", "Bal. Account No.", "Bal. Account Type", "Document No.", "Posting Date")
        {
            SumIndexFields = Amount, "Debit Amount", "Credit Amount", "Additional-Currency Amount", "Add.-Currency Debit Amount", "Add.-Currency Credit Amount";
        }
        key(Key15; "Dimension Set ID")
        {
        }
    }
