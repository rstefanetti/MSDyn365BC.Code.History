    ...
    layout
    {
        area(content)
        {
            repeater(Control1500000)
            {
                ...
                field("GST Entry No."; "GST Entry No.")
                {
                ...
                field("Document Line Type"; "Document Line Type")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Document Line Description"; "Document Line Description")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("GST Entry Type"; "GST Entry Type")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the type of the GST entry.';
                    Visible = false;
                }
                field("GST Base"; "GST Base")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Document Line Code"; "Document Line Code")
                {
                    ApplicationArea = Basic, Suite;
