codeunit 11 "Gen. Jnl.-Check Line"
{
            ...
            case "Account Type" of
                ...
                "Account Type"::Customer, "Account Type"::Vendor:
                    begin
                        ...
                        then begin
                            LogTestField(GenJnlLine, FieldNo("Applies-to Doc. Type"), 0);
    ...
    [Scope('OnPrem')]
    procedure CheckDateAllowed(var GenJnlLine1: Record "Gen. Journal Line")
    begin
    ...
    [Scope('OnPrem')]
    procedure CheckCustAgrmt(GenJnlLine2: Record "Gen. Journal Line"; CustNo: Code[20])
    var
        Cust: Record Customer;
    ...
    [Scope('OnPrem')]
    procedure CheckVendAgrmt(GenJnlLine2: Record "Gen. Journal Line"; VendNo: Code[20])
    var
        Vend: Record Vendor;
    ...
    local procedure CheckPrinted(GenJnlLine: Record "Gen. Journal Line")
    var
