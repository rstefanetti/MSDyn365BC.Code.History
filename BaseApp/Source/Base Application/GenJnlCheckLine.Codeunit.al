codeunit 11 "Gen. Jnl.-Check Line"
{
    ...
    local procedure CheckDates(var GenJnlLine: Record "Gen. Journal Line")
    var
    ...
    begin
        ...
        if (GenJnlLine."Operation Occurred Date" < GLSetup."Last Gen. Jour. Printing Date") and (GenJnlLine.Amount <> 0) then
            LogFieldError(GenJnlLine, GenJnlLine.FieldNo("Operation Occurred Date"), StrSubstNo(Text12001, GLSetup."Last Gen. Jour. Printing Date"));
