table 232 "Gen. Journal Batch"
{
    ...
    fields
    {
        ...
        field(21; "Template Type"; Option)
        {
            ...
            OptionCaption = 'General,Sales,Purchases,Cash Receipts,Payments,Assets,Intercompany,Jobs,,,,,Cartera';
            OptionMembers = General,Sales,Purchases,"Cash Receipts",Payments,Assets,Intercompany,Jobs,,,,,Cartera;
        }
