table 81 "Gen. Journal Line"
{
    ...
    fields
    {
        ...
        field(5601; "FA Posting Type"; Option)
        {
            ...
            OptionCaption = ' ,Acquisition Cost,Depreciation,Write-Down,Appreciation,Custom 1,Custom 2,Disposal,Maintenance,,,,,Derogatory';
            OptionMembers = " ","Acquisition Cost",Depreciation,"Write-Down",Appreciation,"Custom 1","Custom 2",Disposal,Maintenance,,,,,Derogatory;
