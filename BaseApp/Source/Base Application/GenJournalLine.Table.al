table 81 "Gen. Journal Line"
{
    ...
    fields
    {
        ...
        field(11636; "EFT Register No."; Integer)
        {
        ...
        field(28023; "Customer/Vendor Bank"; Code[20])
        {
    ...
    begin
        ...
        if "EFT Register No." <> 0 then
            Error(CancelExportRequiredErr, "Journal Template Name", "Journal Batch Name", "Line No.");
    end;
