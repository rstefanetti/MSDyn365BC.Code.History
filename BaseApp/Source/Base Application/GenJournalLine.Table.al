table 81 "Gen. Journal Line"
{
    ...
    keys
    {
        ...
        key(Key6; "Journal Template Name", "Journal Batch Name", "Applies-to Doc. No.", "Reference No.")
        {
        }
    ...
    var
        ...
        Text1090000: Label 'Select Vendor';
        Text1090001: Label 'Insert Vendors Invoicenumber';
        Text1090002: Label 'Our Account No is missing from vendor card';
        Text1090003: Label 'Minimum lenght of Reference No.  is 2 character';
        Text1090004: Label 'Error in Referencenumber';
        Text1090005: Label 'Selec other message type or type new Reference No.';
    ...
    [Scope('OnPrem')]
    procedure CopyDimensionFromAutoAccLine(AutoAccLine: Record "Automatic Acc. Line")
    var
        DimMgt: Codeunit DimensionManagement;
