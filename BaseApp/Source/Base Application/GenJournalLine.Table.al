table 81 "Gen. Journal Line"
{
    ...
    fields
    {
        ...
        field(11200; "Source Posting Date"; Date)
        {
    ...
    keys
    {
        ...
        key(Key5; "Journal Template Name", "Journal Batch Name", "Account Type", "Account No.")
        {
        }
        key(Key6; "Journal Template Name", "Journal Batch Name", "Account Type", "Due Date")
        {
        }
