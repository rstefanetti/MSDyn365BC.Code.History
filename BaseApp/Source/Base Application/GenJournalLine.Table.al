table 81 "Gen. Journal Line"
{
        ...
        field(11; "Bal. Account No."; Code[20])
        {
            ...
            begin
                ...
                if GenJnlTemplate.Type = GenJnlTemplate.Type::Financial then
                    TestField("Bal. Account No.", GenJnlTemplate."Bal. Account No.");
    ...
    begin
        ...
        if "Journal Template Name" <> GenJnlTemplate.Name then
            GenJnlTemplate.Get("Journal Template Name");
    ...
    begin
        ...
        "Journal Template Name" := PurchHeader."Journal Template Name";
        "Enterprise No." := PurchHeader."Enterprise No.";
    ...
    begin
        ...
        "Journal Template Name" := ServiceHeader."Journal Template Name";
        "Enterprise No." := ServiceHeader."Enterprise No.";
    ...
    procedure SetTestReport(NewTestReport: Boolean)
    begin
