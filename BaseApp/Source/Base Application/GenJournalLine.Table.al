table 81 "Gen. Journal Line"
{
    ...
    fields
    {
        ...
        field(15000004; "Recipient Ref. 1"; Code[80])
        {
        ...
        field(15000005; "Recipient Ref. 2"; Code[80])
        {
        ...
        field(15000006; "Recipient Ref. 3"; Code[80])
        {
        ...
        {
            Caption = 'Check';
            OptionCaption = 'No,Send to employer,Send to beneficiary';
            OptionMembers = No,"Send to employer","Send to beneficiary";
        }
        field(15000013; "Recipient Ref. Abroad"; Code[35])
        {
        ...
        field(15000019; "Remittance Warning"; Boolean)
        {
            Caption = 'Remittance Warning';
        }
        field(15000020; "Remittance Warning Text"; Text[100])
        {
            Caption = 'Remittance Warning Text';
        }
        field(15000025; "Waiting Journal Reference"; Integer)
        {
            BlankZero = true;
            ...
            var
                ...
                WaitingJournal: Page "Waiting Journal";
            begin
        ...
        field(15000027; "Remittance Handling Ref."; Text[6])
        {
            Caption = 'Remittance Handling Ref.';
            Editable = false;
        }
        ...
        field(15000040; "Structured Payment"; Boolean)
        {
            Caption = 'Structured Payment';
            Editable = false;
        }
        ...
        field(15000100; Warning; Boolean)
        {
            Caption = 'Warning';
        }
        field(15000101; "Warning text"; Text[100])
        {
    ...
    keys
    {
        ...
        key(Key6; "Journal Template Name", "Journal Batch Name", "Remittance Agreement Code", "Remittance Type", "Remittance Account Code", "Posting Date", "Account No.", Urgent, "Futures Contract No.", "Futures Contract Exch. Rate", "Currency Code", "Currency Factor", "Agreed Exch. Rate", "Agreed With", KID)
        {
        }
        ...
        key(Key10; "Source Code", "Document No.", "Posting Date")
        {
            MaintainSqlIndex = false;
            SumIndexFields = "VAT Amount (LCY)", "Bal. VAT Amount (LCY)";
        }
    ...
    var
        ...
        RemittanceUpdateWarningQst: Label '%1 is usually updated automatically by remittance system.\Are you sure you want to change this?';
    ...
    [Scope('OnPrem')]
    procedure SetStructuredPayment()
    begin
    ...
    begin
        ...
        "Specification (Norges Bank)" := PurchHeader."Specification (Norges Bank)";
