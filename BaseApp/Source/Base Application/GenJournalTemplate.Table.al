table 80 "Gen. Journal Template"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Type';
            OptionCaption = 'General,Sales,Purchases,Cash Receipts,Payments,Assets,Intercompany,Jobs,Post Dated';
            OptionMembers = General,Sales,Purchases,"Cash Receipts",Payments,Assets,Intercompany,Jobs,"Post Dated";
