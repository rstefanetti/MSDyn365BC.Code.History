table 80 "Gen. Journal Template"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Type';
            OptionCaption = 'General,Sales,Purchases,Cash Receipts,Payments,Assets,Intercompany,Jobs,Payroll Accrual,Deposits,Sales Tax';
            OptionMembers = General,Sales,Purchases,"Cash Receipts",Payments,Assets,Intercompany,Jobs,"Payroll Accrual",Deposits,"Sales Tax";
