table 80 "Gen. Journal Template"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Type';
            OptionCaption = 'General,Sales,Purchases,Cash Receipts,Payments,Assets,Intercompany,Jobs,,,,Cash,Bank';
            OptionMembers = General,Sales,Purchases,"Cash Receipts",Payments,Assets,Intercompany,Jobs,,,,Cash,Bank;
