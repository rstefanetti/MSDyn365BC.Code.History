    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Payment Discount Type"; "Payment Discount Type")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies which type of Payment Discount best fits your needs.';
                }
                field("Discount Calculation"; "Discount Calculation")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Autoinvoice Nos."; "Autoinvoice Nos.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number series used to generate autoinvoices for purchases.';
                }
                field("Autocredit Memo Nos."; "Autocredit Memo Nos.")
                {
                    ApplicationArea = Basic, Suite;
