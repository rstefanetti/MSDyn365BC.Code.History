    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Simplified Intrastat Decl."; "Simplified Intrastat Decl.")
                {
                    ApplicationArea = BasicEU;
                    ToolTip = 'Specifies whether to use the simplified declaration for Intrastat reporting.';
                }
                field("Currency Euro"; "Currency Euro")
                {
                    ApplicationArea = BasicEU;
                ...
                field("Jnl. Templ. Name for Applying"; "Jnl. Templ. Name for Applying")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the name of the journal template you want to use for applying customer or vendor ledger entries.';
                }
                field("Jnl. Batch Name for Applying"; "Jnl. Batch Name for Applying")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the name of the journal batch you want to use for applying customer or vendor ledger entries.';
                }
                field("Payment Recon. Template Name"; "Payment Recon. Template Name")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template to use for payment reconciliation.';
                }
            ...
            group(Application)
            {
                ...
                field("Use Workdate for Appl./Unappl."; "Use Workdate for Appl./Unappl.")
                {
                    ApplicationArea = Basic, Suite;
