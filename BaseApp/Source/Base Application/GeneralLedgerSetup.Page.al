    ...
    layout
    {
        area(content)
        {
            ...
            group(Application)
            {
                ...
                field("VAT Tolerance %"; "VAT Tolerance %")
                {
                    ApplicationArea = Basic, Suite;
            ...
            group("Local Functionalities")
            {
                ...
                group("AU Local Functionality")
                {
                    ...
                    field("BAS to be Lodged as a Group"; "BAS to be Lodged as a Group")
                    {
                        ApplicationArea = Basic, Suite;
                    ...
                    field("BAS Group Company"; "BAS Group Company")
                    {
                        ApplicationArea = Basic, Suite;
                    ...
                    field("AMAS Software"; "AMAS Software")
                    {
                        ApplicationArea = Basic, Suite;
                        ...
                        begin
                            ...
                            if "AMAS SoftwareEditable" then
                                if PAGE.RunModal(PAGE::"CodeUnit Selection", AllObj) = ACTION::LookupOK then
                                    "AMAS Software" := AllObj."Object ID";
                        end;
                    }
                    field("Manual Sales WHT Calc."; "Manual Sales WHT Calc.")
                    {
                        ApplicationArea = Basic, Suite;
                    ...
                    field("Post Dated Journal Template"; "Post Dated Journal Template")
                    {
                        ApplicationArea = Basic, Suite;
                        ToolTip = 'Specifies the journal template name for post-dated check journal.';
                    }
                    field("Post Dated Journal Batch"; "Post Dated Journal Batch")
                    {
                        ApplicationArea = Basic, Suite;
                        ToolTip = 'Specifies the journal batch name for post-dated check journal.';
                    }
                    field("GST Report"; "GST Report")
                    {
                        ApplicationArea = Basic, Suite;
