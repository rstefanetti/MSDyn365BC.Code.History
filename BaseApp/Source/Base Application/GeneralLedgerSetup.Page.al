    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Enable Russian Accounting"; "Enable Russian Accounting")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the general ledger setup information allows for accounting regulations.';
                }
                field("Automatic G/L Correspondence"; "Automatic G/L Correspondence")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the general ledger correspondence is automatically set up.';
                }
                field("Red Storno VAT Reinstatement"; "Red Storno VAT Reinstatement")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the general ledger setup information allows for red storno VAT reinstatement.';
                }
                ...
                field("VAT Purch. Ledger No. Series"; "VAT Purch. Ledger No. Series")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number series that you want to use for VAT ledgers for purchase documents.';
                }
                field("VAT Sales Ledger No. Series"; "VAT Sales Ledger No. Series")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number series that you want to use for VAT ledgers for sales documents.';
                }
                field("Contractor Invent. Act Nos."; "Contractor Invent. Act Nos.")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Allow VAT Set. before FA Rel."; "Allow VAT Set. before FA Rel.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the general ledger setup information allows for VAT settlement before fixed assets are released.';
                }
                field("Void Payment as Correction"; "Void Payment as Correction")
                {
                }
            ...
            group(Reporting)
            {
                ...
                field("Short-Term Due Period"; "Short-Term Due Period")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the short-term due period associated with the general ledger setup information.';
                }
                field("Shared Account Schedule"; "Shared Account Schedule")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the shared account schedule associated with the general ledger setup information.';
                }
                field("Analytic Acc. Card Code"; "Analytic Acc. Card Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the analytic account card code associated with the general ledger setup information.';
                }
            }
            group(Application)
            {
            ...
            group("Amount Difference")
            {
                ...
                field("Currency Adjmt with Correction"; "Currency Adjmt with Correction")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the general ledger setup information allows a currency adjustment with correction.';
                }
                field("Summarize Gains/Losses"; "Summarize Gains/Losses")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the general ledger setup information shows summarized gains and losses information.';
                }
            }
            group(Prepayment)
            {
                Caption = 'Prepayment';
                field("Cancel Curr. Prepmt. Adjmt."; "Cancel Curr. Prepmt. Adjmt.")
                {
                    ApplicationArea = Prepayments;
                    ToolTip = 'Specifies if the general ledger setup information allows for the prepayment adjustment to be canceled.';
                }
                field("Cancel Prepmt. Adjmt. in TA"; "Cancel Prepmt. Adjmt. in TA")
                {
                    ApplicationArea = Prepayments;
                    ToolTip = 'Specifies if the general ledger setup information allows for cancellation of a prepayment adjustment in tax accounting.';
                }
            }
            group(Templates)
            {
                Caption = 'Templates';
                field("Bank Payment Order Tmpl. Code"; "Bank Payment Order Tmpl. Code")
                {
                    ApplicationArea = Basic, Suite;
                }
                field("Cash Outgoin Order Tmpl. Code"; "Cash Outgoin Order Tmpl. Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Cash Ingoing Order Tmpl. Code"; "Cash Ingoing Order Tmpl. Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Cash Order KO3 Template Code"; "Cash Order KO3 Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Cash Order KO4 Template Code"; "Cash Order KO4 Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Cash Reg. (Month) Tmpl. Code"; "Cash Reg. (Month) Tmpl. Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("C/V Recon. Act Template Code"; "C/V Recon. Act Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
