    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field(CashVATPrdGrp; "CashVAT Product Posting Group")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Validate loc.VAT Reg. No."; "Validate loc.VAT Reg. No.")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Use Activity Code"; "Use Activity Code")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Use Document Date in Currency"; "Use Document Date in Currency")
                {
                    ApplicationArea = Basic, Suite;
