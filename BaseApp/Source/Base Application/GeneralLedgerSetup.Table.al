table 98 "General Ledger Setup"
{
    ...
    fields
    {
        ...
        field(12402; "VAT Sales Ledger No. Series"; Code[20])
        {
            Caption = 'VAT Sales Ledger No. Series';
            TableRelation = "No. Series";
        }
        field(12412; "Summarize Gains/Losses"; Boolean)
        {
            Caption = 'Summarize Gains/Losses';
        }
        field(12414; "Automatic G/L Correspondence"; Boolean)
        {
            Caption = 'Automatic G/L Correspondence';
        }
        field(12419; "Allow VAT Set. before FA Rel."; Boolean)
        {
            Caption = 'Allow VAT Set. before FA Rel.';
        }
        field(12425; "Cancel Curr. Prepmt. Adjmt."; Boolean)
        {
            Caption = 'Cancel Curr. Prepmt. Adjmt.';
        ...
        field(12426; "Cancel Prepmt. Adjmt. in TA"; Boolean)
        {
            Caption = 'Cancel Prepmt. Adjmt. in TA';
        ...
        field(12430; "Shared Account Schedule"; Code[10])
        {
            Caption = 'Shared Account Schedule';
            TableRelation = "Acc. Schedule Name";
        }
        field(12440; "Analytic Acc. Card Code"; Code[10])
        {
            Caption = 'Analytic Acc. Card Code';
            TableRelation = "Excel Template";
        }
        field(12450; "Bank Payment Order Tmpl. Code"; Code[10])
        {
            Caption = 'Bank Payment Order Tmpl. Code';
            TableRelation = "Excel Template";
        }
        field(12451; "Cash Outgoin Order Tmpl. Code"; Code[10])
        {
            Caption = 'Cash Outgoin Order Tmpl. Code';
            TableRelation = "Excel Template";
        }
        field(12452; "Cash Ingoing Order Tmpl. Code"; Code[10])
        {
            Caption = 'Cash Ingoing Order Tmpl. Code';
            TableRelation = "Excel Template";
        }
        field(12453; "Cash Order KO3 Template Code"; Code[10])
        {
            Caption = 'Cash Order KO3 Template Code';
            TableRelation = "Excel Template";
        }
        field(12454; "Cash Order KO4 Template Code"; Code[10])
        {
            Caption = 'Cash Order KO4 Template Code';
            TableRelation = "Excel Template";
        }
        field(12455; "Cash Reg. (Month) Tmpl. Code"; Code[10])
        {
            Caption = 'Cash Reg. (Month) Tmpl. Code';
            TableRelation = "Excel Template";
        }
        field(12456; "C/V Recon. Act Template Code"; Code[10])
        {
            Caption = 'C/V Recon. Act Template Code';
            TableRelation = "Excel Template";
        }
        field(12489; "Contractor Invent. Act Nos."; Code[20])
        {
            Caption = 'Contractor Invent. Act Nos.';
            TableRelation = "No. Series";
        }
        field(12494; "Void Payment as Correction"; Boolean)
        {
            Caption = 'Void Payment as Correction';
        }
        field(12495; "Short-Term Due Period"; DateFormula)
        {
            Caption = 'Short-Term Due Period';
        }
        field(12496; "Enable Russian Tax Accounting"; Boolean)
        {
            Caption = 'Enable Russian Tax Accounting';
        ...
        field(12497; "Enable Russian Accounting"; Boolean)
        {
            Caption = 'Enable Russian Accounting';
        }
        field(12498; "Currency Adjmt with Correction"; Boolean)
        {
            Caption = 'Currency Adjmt with Correction';
        }
        field(14929; "Red Storno VAT Reinstatement"; Boolean)
        {
            Caption = 'Red Storno VAT Reinstatement';
        }
    }
    ...
    [Scope('OnPrem')]
    procedure CheckPrepmtAdjmtSetup()
    var
