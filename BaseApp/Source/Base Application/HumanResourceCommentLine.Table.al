table 5208 "Human Resource Comment Line"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Table Name';
            OptionCaption = 'Employee,Alternative Address,Employee Qualification,Employee Relative,Employee Absence,Misc. Article Information,Confidential Information,Person,Position,Labor Contract,Element';
            OptionMembers = Employee,"Alternative Address","Employee Qualification","Employee Relative","Employee Absence","Misc. Article Information","Confidential Information",Person,Position,"Labor Contract",Element;
        }
        field(2; "No."; Code[20])
        {
            Caption = 'No.';
