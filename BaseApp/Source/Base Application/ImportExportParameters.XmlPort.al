xmlport 10863 "Import/Export Parameters"
{
    ...
    schema
    {
        textelement(Root)
        {
            tableelement("Payment Class"; "Payment Class")
            {
            ...
            tableelement("Payment Status"; "Payment Status")
            {
            ...
            tableelement("Payment Step"; "Payment Step")
            {
                XmlName = 'PaymentStep';
                SourceTableView = SORTING("Payment Class", Line);
            ...
            tableelement("Payment Step Ledger"; "Payment Step Ledger")
            {
