report 5690 "Index Fixed Assets"
{
    ...
    local procedure InsertGenJnlLine(FANo: Code[20]; IndexAmount: Decimal; PostingType: Option "Acquisition Cost",Depreciation,"Write-Down",Appreciation,"Custom 1","Custom 2",Disposal,Maintenance,"Salvage Value",,,,Derogatory)
    var
    ...
    local procedure InsertFAJnlLine(FANo: Code[20]; IndexAmount: Decimal; PostingType: Option "Acquisition Cost",Depreciation,"Write-Down",Appreciation,"Custom 1","Custom 2",Disposal,Maintenance,"Salvage Value",,,,Derogatory)
    begin
        if IndexAmount = 0 then
            exit;
