    ...
    dataset
    {
        dataitem("Intrastat Jnl. Batch"; "Intrastat Jnl. Batch")
        {
            ...
            dataitem("Intrastat Jnl. Line"; "Intrastat Jnl. Line")
            {
                ...
                column(Quantity2_IntraJnlLine; "Quantity 2")
                {
                }
                ...
                column(Quantity2Caption; FieldCaption("Quantity 2"))
                {
                }
                ...
                column(BusinessIdCode_CompanyInfo; CompanyInfo."Business Identity Code")
                {
                }
                column(RegHomeCity_CompanyInfo; CompanyInfo."Registered Home City")
                {
                }
