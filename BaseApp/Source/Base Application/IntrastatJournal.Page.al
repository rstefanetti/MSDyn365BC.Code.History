    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = BasicEU;
                    ToolTip = 'Specifies the country or region of the vendor''s address.';
                }
                ...
                {
                    ApplicationArea = BasicEU;
                    ToolTip = 'Specifies the unit of measure for the additional quantity in the Intrastat reporting.';
                }
