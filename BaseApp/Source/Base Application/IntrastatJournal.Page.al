    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = BasicEU;
                    ToolTip = 'Specifies the conversion factor of the item on this Intrastat journal line.';
                    Visible = false;
                }
                field("No. of Supplementary Units"; "No. of Supplementary Units")
                {
                    ApplicationArea = BasicEU;
                    ToolTip = 'Specifies the number of supplementary units on the Intrastat journal line.';
                }
        ...
        area(processing)
        {
            ...
            action(CreateFile)
            {
                ...
                begin
                    ...
                    REPORT.Run(REPORT::"Intrastat - Make Disk Tax Auth", true, false, IntrastatJnlBatch);
                end;
            }
            action(Form)
            {
