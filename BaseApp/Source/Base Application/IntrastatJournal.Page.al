    ...
    actions
    {
        ...
        area(processing)
        {
            group("F&unctions")
            {
                Caption = 'F&unctions';
                Image = "Action";
                action(CreateDeclFile)
                {
                    ApplicationArea = BasicEU;
                    Caption = 'Create Intrastat Declaration File';
                    Ellipsis = true;
                    Image = MakeDiskette;
                    Promoted = true;
                    PromotedCategory = Process;
                    PromotedIsBig = true;
                    ToolTip = 'Create an Intrastat declaration file to be sent to the tax authorities. The Intrastat file contains information about receipt and delivery of goods.';
