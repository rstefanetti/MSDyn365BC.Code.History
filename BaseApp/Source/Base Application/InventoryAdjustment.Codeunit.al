codeunit 5895 "Inventory Adjustment"
{
    ...
    begin
        with OrigValueEntry do begin
            ...
            then begin
                ItemLedgEntry2.Get("Item Ledger Entry No.");
                ItemJnlLine."FA No." := ItemLedgEntry2."FA No.";
                ItemJnlLine."Maintenance Code" := ItemLedgEntry2."Maintenance Code";
            end else begin
                ItemJnlLine."FA No." := '';
                ItemJnlLine."Maintenance Code" := '';
            end;
            // NAVCZ
        end;
    end;
