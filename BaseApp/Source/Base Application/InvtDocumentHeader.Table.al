table 5850 "Invt. Document Header"
{
    ...
    trigger OnDelete()
    begin
        DocSignMgt.DeleteDocSign(DATABASE::"Invt. Document Header", "Document Type".AsInteger(), "No.");
    ...
    begin
        ...
        DocSignMgt.SetDefaults(DATABASE::"Invt. Document Header", "Document Type".AsInteger(), "No.");
    end;
