table 339 "Item Application Entry"
{
    ...
    fields
    {
        ...
        field(17200; "Batch Item Ledger Entry No."; Integer)
        {
            Caption = 'Batch Item Ledger Entry No.';
        }
    }
    ...
    keys
    {
        ...
        key(Key7; "Batch Item Ledger Entry No.", "Posting Date", "Item Ledger Entry No.")
        {
            SumIndexFields = Quantity;
        }
        key(Key8; "Inbound Item Entry No.", "Outbound Item Entry No.", "Posting Date")
        {
        }
    }
