            ...
            if not IsHandled then
                ...
                then begin
                    ...
                    then
                        ...
                        TestField("New Location Code", '');
                    if InvtSetup."Automatic Cost Posting" or InvtSetup."Expected Cost Posting to G/L" then begin
                        InvtSetup.TestField("Jnl. Templ. Name Cost Posting");
                        InvtSetup.TestField("Jnl. Batch Name Cost Posting");
                    end;
                end;
