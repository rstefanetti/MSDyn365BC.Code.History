    ...
    begin
        ...
        then begin
            ...
            if NewItemJnlLine."New Bin Code" <> OldItemJnlLine."Bin Code" then begin
                ItemTrackManagement.CheckWhseItemTrkgSetup(
                  NewItemJnlLine."Item No.", NewItemJnlLine."Location Code", SNRequired, LNRequired, CDRequired, false);
                if SNRequired or LNRequired or CDRequired then
                    if ShowError then
