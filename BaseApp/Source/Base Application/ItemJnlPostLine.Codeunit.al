codeunit 22 "Item Jnl.-Post Line"
{
    ...
    begin
        with ItemJnlLine do begin
            ...
            if "WIP Item" then begin
                CapLedgEntry."WIP Item Qty." := "WIP Quantity";
                CapLedgEntry."Subcontractor No." := "Source No.";
                CapLedgEntry."Subcontr. Purch. Order No." := "Subcontr. Purch. Order No.";
                CapLedgEntry."Subcontr. Purch. Order Line" := "Subcontr. Purch. Order Line";
            end;
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            ItemLedgEntry."Prod. Order Comp. Line No." := "Prod. Order Comp. Line No.";
            ItemLedgEntry."Subcontr. Purch. Order No." := "Subcontr. Purch. Order No.";
            ItemLedgEntry."Subcontr. Purch. Order Line" := "Subcontr. Purch. Order Line";
        end;
