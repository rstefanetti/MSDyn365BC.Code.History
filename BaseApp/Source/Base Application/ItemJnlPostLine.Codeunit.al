codeunit 22 "Item Jnl.-Post Line"
{
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            ItemLedgEntry."Customer No." := "Customer No.";
            ItemLedgEntry."Ship-to Address Code" := "Ship-to Address Code";
            ItemLedgEntry."Customer Salesperson Code" := "Customer Salesperson Code";
