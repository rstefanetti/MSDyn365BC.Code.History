codeunit 22 "Item Jnl.-Post Line"
{
                ...
                if FindSet then begin
                    ...
                    repeat
                        PostFlushedConsump(
                          ...
                          OldItemJnlLine."Posting Date", OldItemJnlLine."Document No.", OldItemJnlLine."Gen. Bus. Posting Group");
                    // NAVCZ
                    until Next = 0;
    ...
    local procedure PostFlushedConsump(ProdOrder: Record "Production Order"; ProdOrderLine: Record "Prod. Order Line"; ProdOrderComp: Record "Prod. Order Component"; ActOutputQtyBase: Decimal; PostingDate: Date; DocumentNo: Code[20]; GBPostGrp: Code[20])
    var
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            // NAVCZ
            // "Gen. Bus. Posting Group" := ProdOrder."Gen. Bus. Posting Group";
            "Gen. Bus. Posting Group" := GBPostGrp;
            // NAVCZ
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            // NAVCZ
            ItemLedgEntry."Source No. 2" := "Source No. 2";
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            if "Item Charge No." <> '' then begin
                ValueEntry."Source No. 2" := "Source No. 2";
            ...
            if DisableItemTracking then begin
                ...
                repeat
                    ...
                    CheckItemTrackingInfo(
                      ItemJnlLine2, TempTrackingSpecification, SNInfoRequired, LotInfoRequired, SignFactor, ItemTrackingCode);
    ...
    local procedure CheckItemTrackingInfo(var ItemJnlLine2: Record "Item Journal Line"; var TrackingSpecification: Record "Tracking Specification"; SNInfoRequired: Boolean; LotInfoRequired: Boolean; SignFactor: Decimal; ItemTrackingCode: Record "Item Tracking Code")
    var
