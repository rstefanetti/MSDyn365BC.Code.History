        ...
        area(reporting)
        {
            ...
            group(Inventory)
            {
                ...
                action("Stock Movement")
                {
                    ...
                    ToolTip = 'Print a list of inventory movement details including quantities, opening balances, and closing balances. You can use this report to monitor inventory history and to identify business cycles.';
                }
