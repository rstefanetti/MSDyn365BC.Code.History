table 1300 "Mini Customer Template"
{
    ...
    procedure CreateFieldRefArray(var FieldRefArray: array[24] of FieldRef; RecRef: RecordRef)
    var
        I: Integer;
    begin
        I := 1;
    ...
    local procedure AddToArray(var FieldRefArray: array[25] of FieldRef; var I: Integer; CurrFieldRef: FieldRef)
    begin
