codeunit 361 MoveEntries
{
    ...
    [Scope('OnPrem')]
    procedure MoveCorrespondenceEntries(GLAcc: Record "G/L Account")
    begin
        CorrespondenceEntry.LockTable();
        CorrespondenceEntry.Reset();
        CorrespondenceEntry.SetCurrentKey("Debit Account No.");
        CorrespondenceEntry.SetRange("Debit Account No.", GLAcc."No.");
        CorrespondenceEntry.ModifyAll("Debit Account No.", '');

        CorrespondenceEntry.Reset();
        CorrespondenceEntry.SetCurrentKey("Credit Account No.");
        CorrespondenceEntry.SetRange("Credit Account No.", GLAcc."No.");
        CorrespondenceEntry.ModifyAll("Credit Account No.", '');
    end;
