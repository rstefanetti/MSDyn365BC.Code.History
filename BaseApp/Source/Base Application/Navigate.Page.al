page 344 Navigate
{
            ...
            group(Document)
            {
                ...
                field(CarteraDocNoFilter; CarteraDocNoFilter)
                {
                    ...
                    begin
                        ...
                        ContactNo := '';
                        ExtDocNo := '';
                        CarteraDocNoFilterOnAfterValid;
                    end;
                }
    ...
    begin
        ...
        if NoTaxableEntry.ReadPermission and (CarteraDocNoFilter = '') then begin
            ...
            InsertIntoDocEntry(Rec, DATABASE::"No Taxable Entry", 0, NoTaxableEntry.TableCaption, NoTaxableEntry.Count);
        end;
    end;
    ...
    begin
        ...
        if PostedBillGr.ReadPermission and (CarteraDocNoFilter = '') then begin
            ...
            InsertIntoDocEntry(Rec, DATABASE::"Posted Bill Group", 0, PostedBillGr.TableCaption, PostedBillGr.Count);
        end;
        if ClosedBillGr.ReadPermission and (CarteraDocNoFilter = '') then begin
            ...
            InsertIntoDocEntry(Rec, DATABASE::"Closed Bill Group", 0, ClosedBillGr.TableCaption, ClosedBillGr.Count);
        end;
        if PostedPmtOrd.ReadPermission and (CarteraDocNoFilter = '') then begin
            ...
            InsertIntoDocEntry(Rec, DATABASE::"Posted Payment Order", 0, PostedPmtOrd.TableCaption, PostedPmtOrd.Count);
        end;
        if ClosedPmtOrd.ReadPermission and (CarteraDocNoFilter = '') then begin
            ...
            InsertIntoDocEntry(Rec, DATABASE::"Closed Payment Order", 0, ClosedPmtOrd.TableCaption, ClosedPmtOrd.Count);
        end;
    end;
    ...
    begin
        ...
        OnBeforeNavigateShowRecords(
          ...
          SOSalesHeader, SISalesHeader, SCMSalesHeader, SROSalesHeader);
        if IsHandled then
            exit;
    ...
    begin
        if CarteraDoc.ReadPermission then begin
            ...
            InsertIntoDocEntry(Rec, DATABASE::"Cartera Doc.", 0, CarteraDoc.TableCaption, CarteraDoc.Count);
        end;
        if PostedCarteraDoc.ReadPermission then begin
            ...
            InsertIntoDocEntry(Rec, DATABASE::"Posted Cartera Doc.", 0, PostedCarteraDoc.TableCaption, PostedCarteraDoc.Count);
        end;
        if ClosedCarteraDoc.ReadPermission then begin
            ...
            InsertIntoDocEntry(Rec, DATABASE::"Closed Cartera Doc.", 0, ClosedCarteraDoc.TableCaption, ClosedCarteraDoc.Count);
        end;
    end;
