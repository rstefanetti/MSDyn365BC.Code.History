codeunit 2310 "O365 Sales Invoice Mgmt"
{
    ...
    var
        ...
        SetupTaxLbl: Label 'Set up tax';
        TaxNotificationIdTok: Label '6733addd-c3d5-47ce-852a-f66385af5af2', Comment = '{LOCKED}';
    ...
    [Scope('OnPrem')]
    procedure IsCountryCanada(): Boolean
    var
        CompanyInformation: Record "Company Information";
    begin
    ...
    [Scope('OnPrem')]
    procedure NotifyTaxSetupNeeded(SalesHeader: Record "Sales Header")
    var
        TaxArea: Record "Tax Area";
        O365TaxSettingsManagement: Codeunit "O365 Tax Settings Management";
        TaxSetupNeededNotification: Notification;
        TaxAreaRecordId: RecordID;
    begin
    ...
    [Scope('OnPrem')]
    procedure RecallTaxNotificationIfTaxSetup(TaxAreaCode: Code[20])
    var
        O365TaxSettingsManagement: Codeunit "O365 Tax Settings Management";
        TaxSetupNotification: Notification;
    begin
    ...
    [Scope('OnPrem')]
    procedure OpenTaxSettingsCard(SenderNotification: Notification)
    var
        TaxArea: Record "Tax Area";
    begin
