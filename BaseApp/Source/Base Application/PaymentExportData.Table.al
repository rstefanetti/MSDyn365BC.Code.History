table 1226 "Payment Export Data"
{
    ...
    begin
        if PaymentHistoryLine.Get(GenJnlLine."Bal. Account No.", GenJnlLine."Document No.", GenJnlLine."Line No.") then begin
            "Recipient Name" := PaymentHistoryLine."Account Holder Name";
            "Recipient Address" := PaymentHistoryLine."Account Holder Address";
            "Recipient City" := PaymentHistoryLine."Account Holder City";
            "Recipient Post Code" := PaymentHistoryLine."Account Holder Post Code";
            "Recipient Country/Region Code" := PaymentHistoryLine."Acc. Hold. Country/Region Code";
