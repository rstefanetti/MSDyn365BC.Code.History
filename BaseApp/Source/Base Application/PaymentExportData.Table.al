table 1226 "Payment Export Data"
{
    ...
    fields
    {
        ...
        field(12440; "Payment Purpose"; Text[250])
        {
            Caption = 'Payment Purpose';
        }
        field(12441; "Sender Name"; Text[100])
        {
            Caption = 'Sender Name';
        }
        field(12442; "Creation Date"; Date)
        {
            Caption = 'Creation Date';
        }
        field(12443; "Creation Time"; Text[30])
        {
            Caption = 'Creation Time';
        }
        field(12444; "Starting Date"; Date)
        {
            Caption = 'Starting Date';
        }
        field(12445; "Ending Date"; Date)
        {
            Caption = 'Ending Date';
        }
        field(12446; "Payment Code"; Text[20])
        {
