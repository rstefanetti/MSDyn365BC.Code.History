table 1226 "Payment Export Data"
{
    ...
    procedure SetVendorAsRecipient(var Vendor: Record Vendor; var VendorBankAccount: Record "Vendor Bank Account"; SEPAFormat: Option pain,CBI,AMC)
    begin
    ...
    procedure SetBankAsSenderBank(BankAccount: Record "Bank Account"; SEPAFormat: Option pain,CBI,AMC)
    begin
        BankAccount.TestField(IBAN);
        if not (SEPAFormat = SEPAFormat::CBI) then
            "Sender Bank BIC" := BankAccount."SWIFT Code";
