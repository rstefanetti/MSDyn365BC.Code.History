    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field("Statistical Code"; "Statistical Code")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Sales Cr. Memo Type"; "Sales Cr. Memo Type")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Purch. Invoice Type"; "Purch. Invoice Type")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the purchase invoice type.';
                    Visible = false;
                }
                field("Purch. Cr. Memo Type"; "Purch. Cr. Memo Type")
                {
                    ApplicationArea = Basic, Suite;
