            ...
            group("&Payments")
            {
                ...
                action("Print Remi&ttance Advice")
                {
                    ...
                    begin
                        ...
                        ReportSelections.PrintWithGUIYesNoVendor(
                            ReportSelections.Usage::"V.Remittance", GenJnlLine, true, FieldNo("Account No."));
                    end;
                }
                ...
                action("Void Check")
                {
                    ...
                    begin
                        ...
                        if ConfirmManagement.GetResponseOrDefault(StrSubstNo(VoidCheckQst, "Document No."), true) then
