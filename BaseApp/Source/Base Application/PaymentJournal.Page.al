    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field("Initial Document No."; "Initial Document No.")
                {
                    ToolTip = 'Specifies the initial document number associated with the general journal line.';
                    Visible = false;
                }
