table 17433 "Payroll Period AE"
{
    Caption = 'Payroll Period AE';
    ...
    keys
    {
        ...
        {
            Clustered = true;
            SumIndexFields = "Salary Amount", "Average Days", "Planned Work Days", "Actual Work Days";
        }
        key(Key2; "Document No.", "Line No.", "Period Code")
        {
            SumIndexFields = "Average Days";
        }
    }
