        ...
        area(content)
        {
            ...
            group("Invoice Details")
            {
                ...
                field("Agreement No."; "Agreement No.")
                {
                    ApplicationArea = Basic, Suite;
                    Editable = false;
                    ToolTip = 'Specifies the agreement number associated with this sales invoice header.';
                }
            ...
            group("Shipping and Billing")
            {
                ...
                group("Ship-to")
                {
                    ...
                    field("KPP Code"; "KPP Code")
                    {
                        ApplicationArea = Basic, Suite;
                        Editable = false;
                        ToolTip = 'Specifies the code of the company registration associated with this sales invoice header.';
                    }
        ...
        area(navigation)
        {
            group("&Invoice")
            {
                ...
                action(Shipments)
                {
                    ...
                    Caption = 'Shipments';
                    Image = Shipment;
                    ToolTip = 'View a list of related posted sales shipments.';
