page 5745 "Posted Transfer Receipt"
{
    ...
    actions
    {
        ...
        area(reporting)
        {
            action("Transfer Receipt TORG-13")
            {
                ...
                RunObject = Report "Transfer Receipt TORG-13";
                ToolTip = 'View posted receipts for items that are transferred within the organization.';
            }
        }
    }
