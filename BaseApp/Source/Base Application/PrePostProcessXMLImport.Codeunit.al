codeunit 1262 "Pre & Post Process XML Import"
{
    ...
    begin
        ...
        CheckBankAccNo(DataExch, BankAccount, IBANPathFilter, BankAccIDPathFilter, CurrCodePathFilter);
    end;
    ...
    local procedure CheckBankAccNo(DataExch: Record "Data Exch."; BankAccount: Record "Bank Account"; IBANPathFilter: Text; BankAccIDPathFilter: Text; CurrCodePathFilter: Text)
    var
        DataExchFieldDetails: Query "Data Exch. Field Details";
        FileHasIBAN: Boolean;
