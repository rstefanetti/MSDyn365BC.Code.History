table 11000000 "Proposal Line"
{
    ...
    fields
    {
        ...
        field(101; "Account Holder Address"; Text[100])
        {
            ...
            var
                ...
                FaxNo: Text[30];
            begin
                PostCodeMgt.FindStreetNameFromAddress("Account Holder Address", Address2, "Account Holder Post Code", "Account Holder City",
    ...
    begin
        ...
        if not HeaderDimSetID then begin
            ...
            "Dimension Set ID" :=
              DimManagement.GetDefaultDimID(TableID, No, '', "Shortcut Dimension 1 Code", "Shortcut Dimension 2 Code", 0, 0);
        end else
