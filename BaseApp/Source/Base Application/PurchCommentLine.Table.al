table 43 "Purch. Comment Line"
{
    ...
    fields
    {
        field(1; "Document Type"; Option)
        {
            ...
            OptionCaption = 'Quote,Order,Invoice,Credit Memo,Blanket Order,Return Order,Receipt,Posted Invoice,Posted Credit Memo,Posted Return Shipment,,,,,,,,,,,,Advance Letter';
            OptionMembers = Quote,"Order",Invoice,"Credit Memo","Blanket Order","Return Order",Receipt,"Posted Invoice","Posted Credit Memo","Posted Return Shipment",,,,,,,,,,,,"Advance Letter";
        }
        field(2; "No."; Code[20])
        {
            Caption = 'No.';
