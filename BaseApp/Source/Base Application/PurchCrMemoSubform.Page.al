    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the WHT Business Posting Group that is assigned from the Purchase Header Table and is used for all the WHT calculations.';
                    Visible = false;
                }
                field("WHT Product Posting Group"; "WHT Product Posting Group")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the WHT Product Posting Group that is assigned from the Product Entity selected in Purchase Line.';
                    Visible = false;
                }
