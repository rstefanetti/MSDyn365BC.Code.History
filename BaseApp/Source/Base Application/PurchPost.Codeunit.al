codeunit 90 "Purch.-Post"
{
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            OnPostItemJnlLineOnBeforeItemJnlPostLineRunWithCheck(ItemJnlLine, PurchLine, DropShipOrder, PurchHeader, WhseReceive);
    ...
    begin
        ...
        if PrepmtDiff then begin
            ...
            AmtDiffMgt.UpdatePDDocPostingNo(
              PurchHeader."Posting No. Series", PurchHeader."Posting No.", InvEntry."Entry No.", 1,
              PurchHeader."Document Type".AsInteger() - 2);
        end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnPostItemJnlLineOnBeforeItemJnlPostLineRunWithCheck(var ItemJnlLine: Record "Item Journal Line"; var PurchaseLine: Record "Purchase Line"; DropShipOrder: Boolean; PurchaseHeader: Record "Purchase Header"; WhseReceive: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnPostPurchLineOnAfterCreatePostedDeferralScheduleFromPurchDoc(var PurchInvLine: Record "Purch. Inv. Line"; PurchInvHeader: Record "Purch. Inv. Header"; PurchLine: Record "Purchase Line"; ItemLedgShptEntryNo: Integer; WhseShip: Boolean; WhseReceive: Boolean; CommitIsSupressed: Boolean)
    begin
    end;
