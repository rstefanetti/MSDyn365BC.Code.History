...
{
    DefaultLayout = RDLC;
    RDLCLayout = './PurchTaxCrMemo.rdlc';
    Caption = 'Purch. - Tax Cr. Memo';

    dataset
    {
        dataitem("Purch. Tax Cr. Memo Hdr."; "Purch. Tax Cr. Memo Hdr.")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(VATCounter; "Integer")
                    {
                        ...
                        column(VATAmountLineInvoiceDisAmt; VATAmountLine."Invoice Discount Amount")
                        {
                            AutoFormatExpression = "Purch. Tax Cr. Memo Hdr."."Currency Code";
                            AutoFormatType = 1;
                        }
            ...
            begin
                ...
                FormatAddr.PurchTaxCrMemoPayTo(VendAddr, "Purch. Tax Cr. Memo Hdr.");
                ...
                FormatAddr.PurchTaxCrMemoShipTo(ShipToAddr, "Purch. Tax Cr. Memo Hdr.");
    ...
    var
        ...
        Text004: Label 'COPY';
        Text005: Label 'Purchase - Tax Credit Memo %1';
