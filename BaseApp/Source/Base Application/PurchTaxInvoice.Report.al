...
{
    DefaultLayout = RDLC;
    RDLCLayout = './PurchTaxInvoice.rdlc';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(VATCounter; "Integer")
                    {
                        ...
                        column(InvDiscBaseAmt_VATAmountLine; VATAmountLine."Inv. Disc. Base Amount")
                        {
                            AutoFormatExpression = "Purch. Tax Inv. Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATRealized_VATAmountLine; VATAmountLine."VAT Realized")
                        {
                            AutoFormatExpression = "Purch. Tax Inv. Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(AmountPaid_VATAmountLine; VATAmountLine."Amount Paid")
                        {
                            AutoFormatExpression = "Purch. Tax Inv. Header"."Currency Code";
                            AutoFormatType = 1;
                        }
