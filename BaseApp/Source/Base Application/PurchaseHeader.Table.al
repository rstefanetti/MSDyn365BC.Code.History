    ...
    begin
        ...
        if not IsHandled then begin
            if "Journal Template Name" = '' then begin
                ...
                then
                    GenJournalTemplate.Get(PurchSetup."Journal Templ. Purch. Invoice")
                else
                    GenJournalTemplate.Get(PurchSetup."Journal Templ. Purch. Cr. Memo");
            ...
            case "Document Type" of
                ...
                "Document Type"::Invoice:
                    begin
                        if ("No. Series" <> '') and
                           (PurchSetup."Invoice Nos." = GenJournalTemplate."Posting No. Series")
                        then
                ...
                "Document Type"::"Credit Memo":
                    begin
                        if ("No. Series" <> '') and
                           (PurchSetup."Credit Memo Nos." = GenJournalTemplate."Posting No. Series")
                        then
                            "Posting No. Series" := "No. Series"
                        else
                            NoSeriesMgt.SetDefaultSeries("Posting No. Series", GenJournalTemplate."Posting No. Series");
    ...
    begin
        ...
        if not IsHandled then begin
            ...
            if ("Document Type" <> "Document Type"::"Credit Memo") and
               ("Document Type" <> "Document Type"::"Return Order")
            then begin
                PurchSetup.TestField("Journal Templ. Purch. Invoice");
                if "Journal Template Name" = '' then
                    GenJournalTemplate.Get(PurchSetup."Journal Templ. Purch. Invoice")
                else
                    GenJournalTemplate.Get("Journal Template Name");
            end else begin
                PurchSetup.TestField("Journal Templ. Purch. Cr. Memo");
                if "Journal Template Name" = '' then
                    GenJournalTemplate.Get(PurchSetup."Journal Templ. Purch. Cr. Memo")
                else
                    GenJournalTemplate.Get("Journal Template Name");
