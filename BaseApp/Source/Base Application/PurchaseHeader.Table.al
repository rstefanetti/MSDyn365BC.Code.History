table 38 "Purchase Header"
{
        ...
        field(90; "Buy-from Country/Region Code"; Code[10])
        {
            ...
            begin
                ...
                if ("Buy-from Country/Region Code" <> xRec."Buy-from Country/Region Code") and (xRec."Buy-from Country/Region Code" <> '') then
                    Validate("VAT Country/Region Code", "Buy-from Country/Region Code");
                // NAVCZ
            end;
        }
        ...
        field(95; "Order Address Code"; Code[10])
        {
            ...
            begin
                if "Order Address Code" <> '' then begin
                    ...
                    Validate("VAT Country/Region Code", OrderAddr."Country/Region Code"); // NAVCZ
            ...
            begin
                with PurchHeader do begin
                    ...
                    if "Prepayment Type" = "Prepayment Type"::Advance then begin
                        ...
                        if NoSeriesMgt.LookupSeries(PurchSetup."Advance Invoice Nos.", "Prepayment No. Series") then
            ...
            begin
                with PurchHeader do begin
                    ...
                    if "Prepayment Type" = "Prepayment Type"::Advance then begin
                        ...
                        if NoSeriesMgt.LookupSeries(PurchSetup."Advance Credit Memo Nos.", "Prepmt. Cr. Memo No.") then
        ...
        field(11760; "VAT Date"; Date)
        {
            ...
            begin
                ...
                if "VAT Date" <> xRec."VAT Date" then
                    UpdatePurchLinesByFieldNo(FieldNo("VAT Date"), CurrFieldNo <> 0);
                PurchSetup.Get;
        ...
        field(31001; "Advance Letter No. Series"; Code[20])
        {
            ...
            begin
                with PurchHeader do begin
                    ...
                    if NoSeriesMgt.LookupSeries(PurchSetup."Advance Letter Nos.", "Advance Letter No. Series") then
            ...
            begin
                if "Advance Letter No. Series" <> '' then begin
                    PurchSetup.Get;
                    PurchSetup.TestField("Advance Letter Nos.");
                    NoSeriesMgt.TestSeries(PurchSetup."Advance Letter Nos.", "Advance Letter No. Series");
                end;
    ...
    begin
        ...
        if VendLedgEntry.FindFirst then begin
            if VendLedgEntry."Amount to Apply" = 0 then begin
                VendLedgEntry.TestField(Prepayment, false);  // NAVCZ
    ...
    var
        TempLinkedEntries: Record "Vendor Ledger Entry" temporary;
        LetterHeader: Record "Purch. Advance Letter Header";
        LetterLine: Record "Purch. Advance Letter Line";
    ...
    begin
        ...
        PurchSetup.Get;
        if "Prepayment Type" = "Prepayment Type"::Advance then begin
            NoSeriesMgt.SetDefaultSeries("Advance Letter No. Series", PurchSetup."Advance Letter Nos.");
            NoSeriesMgt.SetDefaultSeries("Prepayment No. Series", PurchSetup."Advance Invoice Nos.");
            NoSeriesMgt.SetDefaultSeries("Prepmt. Cr. Memo No. Series", PurchSetup."Advance Credit Memo Nos.");
        end else begin
            NoSeriesMgt.SetDefaultSeries("Prepayment No. Series", PurchSetup."Posted Prepmt. Inv. Nos.");
            NoSeriesMgt.SetDefaultSeries("Prepmt. Cr. Memo No. Series", PurchSetup."Posted Prepmt. Cr. Memo Nos.");
        end;
    ...
    begin
        ...
        if not ("Document Type" in ["Document Type"::Invoice, "Document Type"::Order]) then
            FieldError("Document Type");
        AdvLetterLineRelation.SetRange(Type, AdvLetterLineRelation.Type::Purchase);
    ...
    begin
        ...
        if AdvLetterLineRelation.FindSet then
            ...
            PurchAdvanceLetterHeader.ModifyAll("Order No.", '');
        end;
    end;
    ...
    begin
        ...
        if not TempPurchaseLine.FindFirst then begin
            ...
            if not TempPurchaseLine.Mark then begin
                TempPurchaseLine.SetRange("Job Task No.", PurchaseLine."Job Task No.");
    ...
    begin
        ...
        TempPurchaseLine."Job Task No." := PurchaseLine."Job Task No.";
    ...
    local procedure FindPostedDocumentWithSameExternalDocNo(var VendorLedgerEntry: Record "Vendor Ledger Entry"; ExternalDocumentNo: Code[35]): Boolean
    var
    ...
    begin
        ...
        GetVend("Pay-to Vendor No.");
        CheckPossible :=
          not Vend."Disable Uncertainty Check" and
          UncPayerMgt.IsVATRegNoExportPossible("VAT Registration No.", "Pay-to Country/Region Code");
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitNoSeries(var PurchHeader: Record "Purchase Header")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeInitRecord(var PurchaseHeader: Record "Purchase Header"; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeUpdateAllLineDim(var PurchaseHeader: Record "Purchase Header"; NewParentDimSetID: Integer; OldParentDimSetID: Integer; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnRecreatePurchLinesOnBeforeInsertPurchLine(var PurchaseLine: Record "Purchase Line"; var TempPurchaseLine: Record "Purchase Line" temporary)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnUpdatePurchLinesByFieldNoOnBeforeValidateFields(var PurchaseLine: Record "Purchase Line"; xPurchaseLine: Record "Purchase Line")
    begin
    end;
