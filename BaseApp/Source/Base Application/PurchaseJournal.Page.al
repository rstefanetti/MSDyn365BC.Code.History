    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                {
                    ToolTip = 'Specifies the vendor VAT invoice number associated with the general journal line.';
                    Visible = false;
                }
                field("Vendor VAT Invoice Date"; "Vendor VAT Invoice Date")
                {
                    ToolTip = 'Specifies the vendor VAT invoice date associated with the general journal line.';
                    Visible = false;
                }
                field("Vendor VAT Invoice Rcvd Date"; "Vendor VAT Invoice Rcvd Date")
                {
                    ToolTip = 'Specifies the vendor VAT invoice received date associated with the general journal line.';
                    Visible = false;
                }
