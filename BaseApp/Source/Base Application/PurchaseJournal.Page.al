    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field("ESR/ISR Coding Line"; "ESR/ISR Coding Line")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies that if you work with a document reader, the entire coding line of the ESR document can be imported into this field.';
                }
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies that when creating an ESR invoice, the reference number of the vendor invoice is entered in this field.';
                }
