table 39 "Purchase Line"
{
    ...
    fields
    {
        ...
        field(5; Type; Option)
        {
            ...
            begin
                ...
                if "Prod. Order No." <> '' then
                    Error(Text1130001, FieldCaption(Type), "Prod. Order No.");
        ...
        field(6; "No."; Code[20])
        {
            ...
            begin
                ...
                if "Prod. Order No." <> '' then
                    Error(Text1130001, FieldCaption("No."), "Prod. Order No.");
        ...
        field(5402; "Variant Code"; Code[10])
        {
            ...
            begin
                ...
                TestStatusOpen;
                if "Prod. Order No." <> '' then
                    Error(Text1130001, FieldCaption("Variant Code"), "Prod. Order No.");
    ...
    var
        ...
        Text1130001: Label 'You cannot change %1 because the order line is associated with production order %2.';
