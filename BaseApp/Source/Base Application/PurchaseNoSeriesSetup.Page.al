page 1402 "Purchase No. Series Setup"
{
    ...
    var
        ...
        AdvLetterNosVisible: Boolean;

    procedure SetFieldsVisibility(DocType: Option Quote,"Order",Invoice,"Credit Memo","Blanket Order","Return Order","Advance Letter")
    begin
        ...
        AdvLetterNosVisible := (DocType = DocType::"Advance Letter"); // NAVCZ
    end;
}
