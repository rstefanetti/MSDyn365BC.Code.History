report 408 "Purchase - Receipt"
{
    ...
    begin
        ...
        RecRef.GetTable("Purch. Rcpt. Header");
        CHReportManagement.PrepareHeader(RecRef, REPORT::"Purchase - Receipt", HeaderLabel, HeaderTxt);
    end;
    ...
    begin
        RecRef.GetTable("Purch. Rcpt. Header");
        CHReportManagement.PrepareFooter(RecRef, REPORT::"Purchase - Receipt", FooterLabel, FooterTxt);
    end;
