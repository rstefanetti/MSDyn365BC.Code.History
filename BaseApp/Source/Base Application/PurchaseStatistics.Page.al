page 161 "Purchase Statistics"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group(Vendor)
            {
                ...
                field(TotalAmount1ACY; TotalAmount1ACY)
                {
                    ApplicationArea = Basic, Suite;
                    AutoFormatExpression = "Currency Code";
                    AutoFormatType = 1;
                    Caption = 'Total excl. VAT (ACY)';
                    Editable = false;
                    ToolTip = 'Specifies the total amount in your additional reporting currency.';
                ...
                field(VATAmountACY; VATAmountACY)
                {
                    ApplicationArea = Basic, Suite;
                    AutoFormatExpression = "Currency Code";
                    AutoFormatType = 1;
                    ...
                    Editable = false;
                    ToolTip = 'Specifies the amount in your additional reporting currency.';
                }
                field(TotalAmount2ACY; TotalAmount2ACY)
                {
                    ApplicationArea = Basic, Suite;
                    AutoFormatExpression = "Currency Code";
                    AutoFormatType = 1;
                    Caption = 'Total Incl. VAT (ACY)';
                    Editable = false;
                    ToolTip = 'Specifies the total amount in your additional reporting currency.';
                }
            }
    ...
    protected var
        ...
        TotalAmount1ACY: Decimal;
        TotalAmount2ACY: Decimal;
