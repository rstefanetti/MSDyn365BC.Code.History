codeunit 393 "Reminder-Issue"
{
        ...
        with ReminderHeader do begin
            ...
            if ReminderLine.FindSet then
                repeat
                    ...
                    // NAVCZ
                    DtldReminderLine.SetRange("Reminder No.", ReminderLine."Reminder No.");
                    DtldReminderLine.SetRange("Reminder Line No.", ReminderLine."Line No.");
                    if DtldReminderLine.Find('-') then
                        repeat
                            DtldIssuedReminderLine.Init;
    ...
    var
        ...
        DtldReminderLine2: Record "Detailed Reminder Line";
        DtldIssuedReminderLine: Record "Detailed Issued Reminder Line";
    ...
    begin
        with ReminderHeader do begin
            ...
            if GenJnlLine."Account Type" = GenJnlLine."Account Type"::Customer then begin
                ...
                GenJnlLine."Specific Symbol" := "Specific Symbol";
                GenJnlLine."Variable Symbol" := "Variable Symbol";
                GenJnlLine."Constant Symbol" := "Constant Symbol";
                GenJnlLine."Transit No." := "Transit No.";
    ...
    begin
        ...
        // NAVCZ
        DtldIssuedReminderLine.SetRange("Issued Reminder No.", IssuedReminderHeader."No.");
        DtldIssuedReminderLine.DeleteAll;
        // NAVCZ
    end;
    ...
    begin
        // NAVCZ
        PostSalesDelete.IsDocumentDeletionAllowed(PostingDate);
    end;
