    ...
    begin
        ...
        case ReportUsage2 of
            ...
            "Report Selection Usage Sales"::"UnPosted Invoice":
                Rec.SetRange(Usage, "Report Selection Usage"::USI);
            "Report Selection Usage Sales"::"UnPosted Credit Memo":
                Rec.SetRange(Usage, "Report Selection Usage"::USCM);
            "Report Selection Usage Sales"::"UnPosted Corr. Invoice":
                Rec.SetRange(Usage, "Report Selection Usage"::UCSD);
            "Report Selection Usage Sales"::"Corr. Invoice":
                Rec.SetRange(Usage, "Report Selection Usage"::CSI);
            "Report Selection Usage Sales"::"Corr. Credit Memo":
                Rec.SetRange(Usage, "Report Selection Usage"::CSCM);
        end;
