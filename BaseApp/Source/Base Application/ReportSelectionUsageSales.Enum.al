enum 306 "Report Selection Usage Sales"
{
    ...
    value(19; "UnPosted Invoice") { Caption = 'UnPosted Invoice'; }
    value(20; "UnPosted Credit Memo") { Caption = 'UnPosted Credit Memo'; }
    value(21; "UnPosted Corr. Invoice") { Caption = 'UnPosted Corr. Invoice'; }
    value(22; "Corr. Invoice") { Caption = 'Corr. Invoice'; }
    value(23; "Corr. Credit Memo") { Caption = 'Corr. Credit Memo'; }
}
