page 498 Reservation
{
    ...
    var
        ...
        Text12406: Label 'Do you want to reserve specific serial, lot and custom declaration numbers?';
        Text12407: Label ', %1 %2 %3';
        [InDataSet]
    ...
    begin
        CurrentItemDocLine.TestField("Document Date");

        ItemDocLine := CurrentItemDocLine;
        ReservEntry."Source Type" := DATABASE::"Item Document Line";
        ReservEntry."Source Subtype" := ItemDocLine."Document Type";
        ReservEntry."Source ID" := ItemDocLine."Document No.";
        ReservEntry."Source Batch Name" := '';
        ReservEntry."Source Ref. No." := ItemDocLine."Line No.";
    ...
    begin
        ...
        case FromReservSummEntry."Entry No." of
            ...
            12450, 12451:
                begin // Item Document Line
                    FilterReservEntry.SetRange("Source Type", DATABASE::"Item Document Line");
                    FilterReservEntry.SetRange("Source Subtype", FromReservSummEntry."Entry No." - 12450);
                end;
        end;
        ...
        if ReservEntry.TrackingExists then begin
            ...
            FilterReservEntry.SetRange("CD No.", ReservEntry."CD No.");
        end;
    ...
    begin
        case FromReservSummEntry."Entry No." of
            ...
            12450, 12451: // Item Document Line
                exit((FilterReservEntry."Source Type" = DATABASE::"Item Document Line") and
                  (FilterReservEntry."Source Subtype" = FromReservSummEntry."Entry No." - 12450));
        end;
            ...
            1:
                begin // Item Ledger Entry
                    ...
                    case ReservEntry2."Source Type" of
                        ...
                        DATABASE::"Item Document Line":
                            begin
                                AvailableItemLedgEntries.SetItemDocLine(ItemDocLine, ReservEntry2);
                                if (Location."Bin Mandatory") or (Location."Require Pick") then
                                    AvailableItemLedgEntries.SetTotalAvailQty(
                                      "Total Available Quantity" +
                                      CreatePick.CheckOutBound(
            ...
            11, 12, 13, 14, 15, 16:
                begin // Purchase Line
                    ...
                    case ReservEntry2."Source Type" of
                        ...
                        DATABASE::"Item Document Line":
                            begin
                                AvailablePurchLines.SetItemDocLine(ItemDocLine, ReservEntry2);
                                AvailablePurchLines.RunModal;
                            end;
                    end;
                end;
            21:
                begin // Requisition Line
                    ...
                    case ReservEntry2."Source Type" of
                        ...
                        DATABASE::"Item Document Line":
                            begin
                                AvailableReqLines.SetItemDocLine(ItemDocLine, ReservEntry2);
                                AvailableReqLines.RunModal;
                            end;
                    end;
                end;
            31, 32, 33, 34, 35, 36:
                begin // Sales Line
                    ...
                    case ReservEntry2."Source Type" of
                        ...
                        DATABASE::"Item Document Line":
                            begin
                                AvailableSalesLines.SetItemDocLine(ItemDocLine, ReservEntry2);
                                AvailableSalesLines.RunModal;
                            end;
                    end;
                end;
            61, 62, 63, 64:
                begin
                    ...
                    case ReservEntry2."Source Type" of
                        ...
                        DATABASE::"Item Document Line":
                            begin
                                AvailableProdOrderLines.SetItemDocLine(ItemDocLine, ReservEntry2);
                                AvailableProdOrderLines.RunModal;
                            end;
                    end;
                end;
            71, 72, 73, 74:
                begin
                    ...
                    case ReservEntry2."Source Type" of
                        ...
                        DATABASE::"Item Document Line":
                            begin
                                AvailableProdOrderComps.SetItemDocLine(ItemDocLine, ReservEntry2);
                                AvailableProdOrderComps.RunModal;
                            end;
                    end;
                end;
            91:
                begin
                    ...
                    case ReservEntry2."Source Type" of
                        ...
                        DATABASE::"Item Document Line":
                            begin
                                AvailablePlanningComponents.SetItemDocLine(ItemDocLine, ReservEntry2);
                                AvailablePlanningComponents.RunModal;
                            end;
                    end;
                end;
            101, 102:
                begin
                    ...
                    case ReservEntry2."Source Type" of
                        ...
                        DATABASE::"Item Document Line":
                            begin
                                AvailableTransLines.SetItemDocLine(ItemDocLine, ReservEntry2);
                                AvailableTransLines.RunModal;
                            end;
                    end;
                end;
            110:
                begin // Service Line
                    ...
                    case ReservEntry2."Source Type" of
                        ...
                        DATABASE::"Item Document Line":
                            begin
                                AvailableServiceLines.SetItemDocLine(ItemDocLine, ReservEntry2);
                                AvailableServiceLines.RunModal;
                            end;
                    end;
                end;
            ...
            12450, 12451:
                begin
                    ...
                    case ReservEntry2."Source Type" of
                        DATABASE::"Sales Line":
                            begin
                                AvailableItemDocLines.SetSalesLine(SalesLine, ReservEntry2);
                                AvailableItemDocLines.RunModal;
                            end;
                        DATABASE::"Requisition Line":
                            begin
                                AvailableItemDocLines.SetReqLine(ReqLine, ReservEntry2);
                                AvailableItemDocLines.RunModal;
                            end;
                        DATABASE::"Purchase Line":
                            begin
                                AvailableItemDocLines.SetPurchLine(PurchLine, ReservEntry2);
                                AvailableItemDocLines.RunModal;
                            end;
                        DATABASE::"Prod. Order Line":
                            begin
                                AvailableItemDocLines.SetProdOrderLine(ProdOrderLine, ReservEntry2);
                                AvailableItemDocLines.RunModal;
                            end;
                        DATABASE::"Prod. Order Component":
                            begin
                                AvailableItemDocLines.SetProdOrderComponent(ProdOrderComp, ReservEntry2);
                                AvailableItemDocLines.RunModal;
                            end;
                        DATABASE::"Planning Component":
                            begin
                                AvailableItemDocLines.SetPlanningComponent(PlanningComponent, ReservEntry2);
                                AvailableItemDocLines.RunModal;
                            end;
                        DATABASE::"Transfer Line":
                            begin
                                AvailableItemDocLines.SetTransferLine(TransLine, ReservEntry2, ReservEntry."Source Subtype");
                                AvailableItemDocLines.RunModal;
                            end;
                        DATABASE::"Service Invoice Line":
                            begin
                                AvailableItemDocLines.SetServiceInvLine(ServiceLine, ReservEntry2);
                                AvailableItemDocLines.RunModal;
                            end;
                        DATABASE::"Item Document Line":
                            begin
                                AvailableItemDocLines.SetItemDocLine(ItemDocLine, ReservEntry2);
                                AvailableItemDocLines.RunModal;
                            end;
                    end;
                end;
            ...
            repeat
                ...
                if ReservEntry.TrackingExists then
                    LotSNMatch := (ReservEntry3."Serial No." = ReservEntry."Serial No.") and
                                  ...
                                  (ReservEntry3."CD No." = ReservEntry."CD No.")
                else
                    LotSNMatch := true;
            ...
            repeat
                ...
                if (ReservEntry3."Source Type" = ReservEntry."Source Type") and
                   ...
                   (((ReservEntry3."Serial No." = ReservEntry."Serial No.") and
                     (ReservEntry3."Lot No." = ReservEntry."Lot No.") and
                     (ReservEntry3."CD No." = ReservEntry."CD No.") and
    ...
    begin
        ...
        if TempTrackingSpecification.Find('-') then begin
            if not Confirm(StrSubstNo(Text12406, true)) then
                exit;
            repeat
            ...
            if PAGE.RunModal(PAGE::"Item Tracking List", TempReservEntry) = ACTION::LookupOK then begin
                ...
                ReservEntry."CD No." := TempReservEntry."CD No.";
                OnGetSerialLotNoOnAfterSetTrackingFields(ReservEntry, TempReservEntry);
                CaptionText += StrSubstNo(Text12407, ReservEntry."Serial No.", ReservEntry."Lot No.", ReservEntry."CD No.");
    ...
    begin
        case ReservEntry."Source Type" of
            ...
            DATABASE::"Item Document Line":
                QtyPerUOM := GetQtyPerUomFromItemDocLine;
        end;
    ...
    local procedure GetQtyPerUomFromItemDocLine(): Decimal
    begin
        ItemDocLine.Find;
        if ReservEntry."Source Subtype" in [1, 2] then begin // Outbound
            ItemDocLine.CalcFields("Reserved Quantity Outbnd.", "Reserved Qty. Outbnd. (Base)");
            QtyReserved := ItemDocLine."Reserved Quantity Outbnd.";
            QtyReservedBase := ItemDocLine."Reserved Qty. Outbnd. (Base)";
            QtyToReserve := ItemDocLine.Quantity;
            QtyToReserveBase := ItemDocLine."Quantity (Base)";
        end else begin // Inbound
            ItemDocLine.CalcFields("Reserved Quantity Inbnd.", "Reserved Qty. Inbnd. (Base)");
            QtyReserved := ItemDocLine."Reserved Quantity Inbnd.";
            QtyReservedBase := ItemDocLine."Reserved Qty. Inbnd. (Base)";
            QtyToReserve := ItemDocLine.Quantity;
            QtyToReserveBase := ItemDocLine."Quantity (Base)";
        end;
        exit(ItemDocLine."Qty. per Unit of Measure");
    end;
