codeunit 99000845 "Reservation Management"
{
        ...
        with CalcReservEntry do begin
            ...
            if Location."Require Pick" then begin
                ...
                foreach SpecialBin in SpecialBins do
                    QtyOnSpecialBins +=
                        WhseAvailMgt.CalcQtyOnBin("Location Code", SpecialBin, "Item No.", "Variant Code", "Lot No.", "Serial No.", "CD No.");
            end;
    ...
    begin
        ...
        QtyThisLineBase := MinAbs(QtyThisLineBase, MaxReservQtyBasePerLotOrSerial) * Sign(QtyThisLineBase);
    end;
