report 6641 "Return Order"
{
    ...
    var
        ...
        PurchLineLineAmt_Redundant: Decimal;
        PurchLineInvDiscAmt_Redundant: Decimal;
    ...
    begin
        ...
        CHReportManagement.PrepareHeader(RecRef, REPORT::"Return Order", HeaderLabel, HeaderTxt);
    end;
