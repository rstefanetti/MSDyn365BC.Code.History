table 179 "Reversal Entry"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Entry Type';
            OptionCaption = ' ,G/L Account,Customer,Vendor,Bank Account,Fixed Asset,Maintenance,VAT,Employee,,WHT';
            OptionMembers = " ","G/L Account",Customer,Vendor,"Bank Account","Fixed Asset",Maintenance,VAT,Employee,,WHT;
        }
