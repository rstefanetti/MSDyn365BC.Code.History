codeunit 1223 "SEPA CT-Check Line"
{
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            if IsNorgeExport then begin
                GenJnlLineRegRepCode.SetFilterForGenJournalLine(GenJnlLine);
                if GenJnlLineRegRepCode.Count > 10 then
                    InsertPaymentFileError(ALotOfRegRepCodesNotAllowedErr);
            end;
        end;
