xmlport 1010 "SEPA DD pain.008.001.02"
{
    ...
    begin
        ...
        // SEPA Direct Debit N58 format
        DirectDebitCollection.Get("Direct Debit Collection Entry".GetRangeMin("Direct Debit Collection No."));
        if DirectDebitCollection."Direct Debit Format" = DirectDebitCollection."Direct Debit Format"::N58 then
            MessageID := 'FSDD' + MessageID;
