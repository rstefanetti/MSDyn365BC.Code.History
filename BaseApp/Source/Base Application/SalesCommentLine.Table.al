table 44 "Sales Comment Line"
{
    ...
    fields
    {
        field(1; "Document Type"; Option)
        {
            ...
            OptionCaption = 'Quote,Order,Invoice,Credit Memo,Blanket Order,Return Order,Shipment,Posted Invoice,Posted Credit Memo,Posted Return Receipt,,,,,,,,,,,,Advance Letter';
            OptionMembers = Quote,"Order",Invoice,"Credit Memo","Blanket Order","Return Order",Shipment,"Posted Invoice","Posted Credit Memo","Posted Return Receipt",,,,,,,,,,,,"Advance Letter";
        }
        field(2; "No."; Code[20])
        {
            Caption = 'No.';
