table 44 "Sales Comment Line"
{
    ...
    fields
    {
        field(1; "Document Type"; Option)
        {
            ...
            OptionCaption = 'Quote,Order,Invoice,Credit Memo,Blanket Order,Return Order,Shipment,Posted Invoice,Posted Credit Memo,Posted Return Receipt,Agreement';
            OptionMembers = Quote,"Order",Invoice,"Credit Memo","Blanket Order","Return Order",Shipment,"Posted Invoice","Posted Credit Memo","Posted Return Receipt",Agreement;
        }
        field(2; "No."; Code[20])
        {
            Caption = 'No.';
