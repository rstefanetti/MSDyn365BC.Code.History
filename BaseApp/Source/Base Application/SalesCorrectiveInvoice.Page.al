...
{
    Caption = 'Sales Corrective Invoice';
    PageType = Document;
    ...
    layout
    {
        area(content)
        {
            ...
            group(Invoicing)
            {
                ...
                field("External Document Text"; "External Document Text")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the external document text associated with the sales header.';
                }
            ...
            group(Shipping)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the act signed by name associated with the sales header.';
                }
                field("Act Signed by Position"; "Act Signed by Position")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the act signed by the position associated with the sales header.';
                }
