report 202 "Sales Document - Test"
{
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                column(Currency_Control1100007; Currency)
                {
                }
                ...
                column(Currency_Control1100014; Currency)
                {
                }
                ...
                column(Currency_Control1100016; Currency)
                {
                }
                ...
                column(Currency_CodeCaption_Control1100008; Currency_CodeCaption_Control1100008Lbl)
                {
                }
                ...
                column(Currency_CodeCaption_Control1100015; Currency_CodeCaption_Control1100015Lbl)
                {
                }
                ...
                column(Currency_CodeCaption_Control1100017; Currency_CodeCaption_Control1100017Lbl)
                {
                }
                ...
                dataitem(CopyLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(SalesLine__Pmt__Disc__Given_Amount_; SalesLine."Pmt. Discount Amount")
                        {
                        }
                        column(SumPmtDiscGivenAmount; SumPmtDiscGivenAmount)
                        {
                        }
                        ...
                        column(Pmt__Disc__Given_Amount; -TempSalesLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                        }
                        column(Prices_Including_VAT; "Sales Header"."Prices Including VAT")
                        {
                        }
                        ...
                        column(TempSalesLine__Line_Amount____TempSalesLine__Inv__Discount_Amount____TempSalesLine__Pmt__Disc__Given_Amount_; TempSalesLine."Line Amount" - TempSalesLine."Inv. Discount Amount" - TempSalesLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(TempSalesLine__Line_Amount____TempSalesLine__Inv__Discount_Amount____TempSalesLine__Pmt__Disc__Given_Amount____VATAmount; TempSalesLine."Line Amount" - TempSalesLine."Inv. Discount Amount" - TempSalesLine."Pmt. Discount Amount" + VATAmount)
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(Pmt__Disc__Given_AmountCaption; Pmt__Disc__Given_AmountCaptionLbl)
                        {
                        }
                        ...
                        dataitem(DimensionLoop2; "Integer")
                        {
                            ...
                            begin
                                ...
                                SumPmtDiscGivenAmount := SumPmtDiscGivenAmount + TempSalesLine."Pmt. Discount Amount";
                            end;
                    ...
                    dataitem(VATCounter; "Integer")
                    {
                        ...
                        column(VATAmountLine__Invoice_Discount_Amount____VATAmountLine__Pmt__Disc__Given_Amount_; VATAmountLine."Invoice Discount Amount" + VATAmountLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmountLine__VAT_EC_Base__Control151; VATAmountLine."VAT Base")
                        {
                            AutoFormatExpression = "Sales Line"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmountLine__Invoice_Discount_Amount____VATAmountLine__Pmt__Disc__Given_Amount__Control173; VATAmountLine."Invoice Discount Amount" + VATAmountLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmountLine__EC_Amount__Control1100010; VATAmountLine."EC Amount")
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmountLine__VAT_EC_Base__Control176; VATAmountLine."VAT Base")
                        {
                            AutoFormatExpression = "Sales Line"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(VATAmountLine__Invoice_Discount_Amount____VATAmountLine__Pmt__Disc__Given_Amount__Control177; VATAmountLine."Invoice Discount Amount" + VATAmountLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmountLine__EC_Amount__Control1100011; VATAmountLine."EC Amount")
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmountLine__VAT_EC_Base__Control182; VATAmountLine."VAT Base")
                        {
                            AutoFormatExpression = "Sales Line"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(VATAmountLine__Invoice_Discount_Amount____VATAmountLine__Pmt__Disc__Given_Amount__Control183; VATAmountLine."Invoice Discount Amount" + VATAmountLine."Pmt. Discount Amount")
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATAmountLine__EC_Amount__Control1100012; VATAmountLine."EC Amount")
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VAT___EC_BaseCaption; VAT___EC_BaseCaptionLbl)
                        {
                        }
                        ...
                        column(Inv__and_Pmt__DiscountsCaption; Inv__and_Pmt__DiscountsCaptionLbl)
                        {
                        }
    ...
    var
        ...
        Currency_CodeCaption_Control1100008Lbl: Label 'Currency Code';
        ...
        Currency_CodeCaption_Control1100015Lbl: Label 'Currency Code';
        ...
        Currency_CodeCaption_Control1100017Lbl: Label 'Currency Code';
        ...
        Pmt__Disc__Given_AmountCaptionLbl: Label 'Pmt. Disc. Given Amount';
        ...
        VAT___EC_BaseCaptionLbl: Label 'VAT + EC Base';
        VATAmountLine__VAT___CaptionLbl: Label 'VAT %';
        VAT_Amount_SpecificationCaptionLbl: Label 'VAT Amount Specification';
        VATAmountLine__VAT_Identifier_CaptionLbl: Label 'VAT Identifier';
        Inv__and_Pmt__DiscountsCaptionLbl: Label 'Inv. and Pmt. Discounts';
