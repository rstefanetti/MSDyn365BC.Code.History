report 202 "Sales Document - Test"
{
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(PageCounter; "Integer")
            {
                ...
                dataitem(CopyLoop; "Integer")
                {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(FreeTypeExist_; FreeTypeExist)
                        {
                        }
                        column(TotalExclVATText_Control1130012; TotalExclVATText)
                        {
                        }
                        column(VATAmountLine_VATAmountText_Control1130013; VATAmountLine.VATAmountText)
                        {
                        }
                        column(TotalInclVATText_Control1130014; TotalInclVATText)
                        {
                        }
                        column(Text12101; Text12101Lbl)
                        {
                        }
                        column(VATAmount_Control1130016; VATAmount)
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(Text12101_Control1130017; Text12101Lbl)
                        {
                        }
                        ...
                        column(TotalExclVATText_Control1130000; TotalExclVATText)
                        {
                        }
                        column(VATAmountLine_VATAmountText_Control1130001; VATAmountLine.VATAmountText)
                        {
                        }
                        column(Text12101_Control1130002; Text12101Lbl)
                        {
                        }
                        column(VATAmount_Control1130003; VATAmount)
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(TotalInclVATText_Control1130005; TotalInclVATText)
                        {
                        }
                        column(VATAmount_Control1130004; VATAmount)
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(TotalInclVATText_Control1130006; TotalInclVATText)
                        {
                        }
                        column(VATAmountLine_VATAmountText_Control1130007; VATAmountLine.VATAmountText)
                        {
                        }
                        column(Text12101_Control1130008; Text12101Lbl)
                        {
                        }
                        column(VATAmount_Control1130009; VATAmount)
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        column(TotalExclVATText_Control1130010; TotalExclVATText)
                        {
                        }
                        column(VATAmount_Control1130011; VATAmount)
                        {
                            AutoFormatExpression = "Sales Header"."Currency Code";
                            AutoFormatType = 1;
                        }
                        ...
                        column(VATExemptionCheck_; VATExemptionCheck)
                        {
                        }
                        ...
                        column(VATExemption__VAT_Exempt__No__Caption; VATExemption__VAT_Exempt__No__CaptionLbl)
                        {
                        }
                        column(VATExemption__VAT_Exempt__Date_Caption; VATExemption__VAT_Exempt__Date_CaptionLbl)
                        {
                        }
                        column(SalesLineHidden; Format(SalesLineHidden, 0, 2))
                        {
                        }
                                    ...
                                    if "Document Type" in ["Document Type"::Order, "Document Type"::Invoice, "Document Type"::"Credit Memo"] then
                                        if VATPostingSetup.IsEUService("VAT Bus. Posting Group", "VAT Prod. Posting Group") then begin
                                            ...
                                            if "Transport Method" = '' then
                                                AddError(
                                                  StrSubstNo(
                                             Text12110, FieldCaption("Transport Method")));
                                            if "Sales Header"."Payment Method Code" = '' then
                                                AddError(
                                                  StrSubstNo(
                                             Text12110, "Sales Header".FieldCaption("Payment Method Code")));
                                        end;
                    ...
                    dataitem(VATCounterLCY; "Integer")
                    {
                        ...
                        begin
                            if (not GLSetup."Print VAT specification in LCY") or
                              ...
                              (PaymentMethod.Get("Sales Header"."Payment Method Code") and
            ...
            begin
                ...
                if Invoice then begin
                    ...
                    InclInVATReportValidation.ValidateSalesHeader("Sales Header", InclInVATReportErrorLogTemp);
    ...
    var
        ...
        Text12101Lbl: Label 'FREE INVOICE';
        ...
        VATExemption__VAT_Exempt__No__CaptionLbl: Label 'Customer VAT Exemption No.';
        VATExemption__VAT_Exempt__Date_CaptionLbl: Label 'Customer VAT Exemption Date';
