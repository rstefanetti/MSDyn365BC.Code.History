table 36 "Sales Header"
{
    ...
    fields
    {
        ...
        field(7; "Bill-to Address"; Text[100])
        {
            ...
            begin
                ...
                PostCodeMgt.FindStreetNameFromAddress(
                  "Bill-to Address", "Bill-to Address 2", "Bill-to Post Code", "Bill-to City",
                  "Bill-to Country/Region Code", PhoneNo, FaxNo);
            end;
        }
        ...
        field(15; "Ship-to Address"; Text[100])
        {
            ...
            begin
                PostCodeMgt.FindStreetNameFromAddress(
                  "Ship-to Address", "Ship-to Address 2", "Ship-to Post Code", "Ship-to City",
                  "Ship-to Country/Region Code", PhoneNo, FaxNo);
            end;
        }
        ...
        field(81; "Sell-to Address"; Text[100])
        {
            ...
            trigger OnValidate()
            begin
                FindStreetNameFromSellToAddress();
    ...
    local procedure FindStreetNameFromSellToAddress()
    var
        PhoneNo: Text[30];
        FaxNo: Text[30];
        IsHandled: Boolean;
    begin
        IsHandled := false;
        OnBeforeFindStreetNameFromSellToAddress(Rec, IsHandled);
        if IsHandled then
            exit;

        PostCodeMgt.FindStreetNameFromAddress(
      "Sell-to Address", "Sell-to Address 2", "Sell-to Post Code", "Sell-to City",
      "Sell-to Country/Region Code", PhoneNo, FaxNo);
    end;
