table 36 "Sales Header"
{
                ...
                if (xRec."Agreement No." <> "Agreement No.") then begin
                    if ("Agreement No." <> '') then begin
                        ...
                        if Confirmed then begin
                            ...
                            CustomerAgreement.CheckBlockedCustOnDocs(Cust, "Document Type", false, false);
                            ...
                            if "Posting Date" <> 0D then begin
                                ...
                                if CustomerAgreement."Expire Date" < "Posting Date" then
                                ...
                                if CustomerAgreement."Expire Date" < "Document Date" then
    ...
    begin
        ...
        DocSignMgt.SetDefaults(DATABASE::"Sales Header", "Document Type", "No.");
    ...
    begin
        OnBeforeOpenSalesOrderStatistics(Rec);
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCheckSellToCust(var SalesHeader: Record "Sales Header"; xSalesHeader: Record "Sales Header"; Customer: Record Customer)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCheckCreditMaxBeforeInsert(var SalesHeader: Record "Sales Header"; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeOpenSalesOrderStatistics(var SalesHeader: Record "Sales Header")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeUpdateShipToAddress(var SalesHeader: Record "Sales Header"; var IsHandled: Boolean)
    begin
    end;
