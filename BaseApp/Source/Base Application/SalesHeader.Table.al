table 36 "Sales Header"
{
    ...
    fields
    {
        ...
        field(11700; "Bank Account Code"; Code[20])
        {
            ...
            TableRelation = IF ("Document Type" = FILTER(Quote | Order | Invoice | "Blanket Order")) "Bank Account" WHERE("Account Type" = CONST("Bank Account"))
            ELSE
            ...
            begin
                ...
                then
                    if BankAcc.Get("Bank Account Code") then
                        UpdateBankInfoFromRecord(BankAcc)
                    else begin
                        CompanyInfo.Get();
                    ...
                    if "Bank Account Code" <> '' then begin
                        ...
                        UpdateBankInfoFromRecord(CustBankAcc);
                    end else
                        UpdateBankInfo('', '', '', '', '', '', '');
            end;
        }
        ...
        field(11730; "Cash Desk Code"; Code[20])
        {
            ...
            begin
                if BankAcc2.Get("Cash Desk Code") then;
                if PAGE.RunModal(PAGE::"Cash Desk List", BankAcc2) = ACTION::LookupOK then
                    Validate("Cash Desk Code", BankAcc2."No.");
            end;
            ...
            begin
                ...
                if "Cash Desk Code" <> '' then begin
                    TestField("Bal. Account No.", '');
                    BankAcc2.Get("Cash Desk Code");
                    BankAcc2.TestField(Blocked, false);
                    TestField("Currency Code", BankAcc2."Currency Code");
                end else
        ...
        field(11760; "VAT Date"; Date)
        {
            ...
            begin
                ...
                if "VAT Date" <> xRec."VAT Date" then
                    UpdateSalesLinesByFieldNo(FieldNo("VAT Date"), false);
            end;
        }
            ...
            begin
                case "Document Type" of
                    ...
                    "Document Type"::"Return Order":
                        begin
                            SalesSetup.Get();
                            "Postponed VAT" := SalesSetup."Credit Memo Confirmation" and
        ...
        field(31001; "Advance Letter No. Series"; Code[20])
        {
            ...
            begin
                with SalesHeader do begin
                    ...
                    if NoSeriesMgt.LookupSeries(SalesSetup."Advance Letter Nos.", "Advance Letter No. Series") then
                        Validate("Advance Letter No. Series");
                    Rec := SalesHeader;
                end;
            end;
            ...
            trigger OnValidate()
            begin
                if "Advance Letter No. Series" <> '' then begin
                    SalesSetup.Get();
                    SalesSetup.TestField("Advance Letter Nos.");
                    NoSeriesMgt.TestSeries(SalesSetup."Advance Letter Nos.", "Advance Letter No. Series");
                end;
        ...
        {
            CalcFormula = Exist("Advance Letter Line Relation" WHERE(Type = CONST(Sale),
                                                                      "Document Type" = FIELD("Document Type"),
                                                                      "Document No." = FIELD("No.")));
    ...
    begin
        ...
        Validate("Posting Desc. Code", SalesSetup."Posting Desc. Code"); // NAVCZ
                ...
                "Document Type"::"Return Order":
                    begin
                        ...
                        if ReceivingNoSeries then
                            "Return Receipt No. Series" := NoSeriesLink."Receiving No. Series"
                        else
                            // NAVCZ
    ...
    begin
        if IsCreditDocType then begin
            if "Prepayment Type" = "Prepayment Type"::Advance then
                PostingNos := SalesSetup."Advance Credit Memo Nos." // NAVCZ
            else
                PostingNos := SalesSetup."Posted Prepmt. Cr. Memo Nos.";
        end else
            if "Prepayment Type" = "Prepayment Type"::Advance then
                PostingNos := SalesSetup."Advance Invoice Nos." // NAVCZ
            else
                ...
                if not IsHandled then
                    case ChangedFieldNo of
                        ...
                        FieldNo("Prepayment Type"):
                            if SalesLine."No." <> '' then
                                SalesLine.Validate("Prepayment %", SalesLine."Prepayment %");
                        FieldNo("Physical Transfer"):
                            if (SalesLine.Type = SalesLine.Type::Item) and (SalesLine."No." <> '') then
                                SalesLine."Physical Transfer" := "Physical Transfer";
                        // NAVCZ
                        else
    ...
    begin
        ...
        Validate("Language Code", SellToCustTemplate."Language Code"); // NAVCZ
        if "Bill-to Customer No." = '' then
    ...
    begin
        ...
        if ContactBusinessRelationFound then begin
            ...
            if "Document Type" = "Document Type"::Quote then begin
                ...
                "Tax Registration No." := SearchContact."Tax Registration No.";
                // NAVCZ
    ...
    begin
        ...
        if IsCreditDocType then begin
            ...
            Validate("VAT Country/Region Code", "Sell-to Country/Region Code"); // NAVCZ
        end;
    ...
    begin
        ...
        if "Prepayment Type" = "Prepayment Type"::Advance then begin
            NoSeriesMgt.SetDefaultSeries("Advance Letter No. Series", SalesSetup."Advance Letter Nos.");
            NoSeriesMgt.SetDefaultSeries("Prepayment No. Series", SalesSetup."Advance Invoice Nos.");
            NoSeriesMgt.SetDefaultSeries("Prepmt. Cr. Memo No. Series", SalesSetup."Advance Credit Memo Nos.");
        end else begin
            NoSeriesMgt.SetDefaultSeries("Prepayment No. Series", SalesSetup."Posted Prepmt. Inv. Nos.");
            NoSeriesMgt.SetDefaultSeries("Prepmt. Cr. Memo No. Series", SalesSetup."Posted Prepmt. Cr. Memo Nos.");
        end;
    ...
    begin
        // NAVCZ
        UpdatePrepmtType;
        UpdateSalesLinesByFieldNo(FieldNo("Prepayment Type"), false);
    end;
    ...
    [Scope('OnPrem')]
    procedure UpdateBankInfoFromRecord(Variant: Variant)
    var
        BankAcc2: Record "Bank Account";
        CustBankAcc2: Record "Customer Bank Account";
        ...
        case RecRef.Number of
            DATABASE::"Bank Account":
                begin
                    ...
                    UpdateBankInfo(
                      BankAcc2."No.",
                      BankAcc2."Bank Account No.",
                      BankAcc2."Bank Branch No.",
                      BankAcc2.Name,
                      BankAcc2."Transit No.",
                      BankAcc2.IBAN,
                      BankAcc2."SWIFT Code");
            ...
            DATABASE::"Customer Bank Account":
                begin
                    CustBankAcc2 := Variant;
                    UpdateBankInfo(
                      CustBankAcc2.Code,
                      CustBankAcc2."Bank Account No.",
                      CustBankAcc2."Bank Branch No.",
                      CustBankAcc2.Name,
                      CustBankAcc2."Transit No.",
                      CustBankAcc2.IBAN,
                      CustBankAcc2."SWIFT Code");
                end;
            DATABASE::"Responsibility Center":
                begin
                    RespCenter2 := Variant;
                    UpdateBankInfo(
                      RespCenter2."Bank Account Code",
                      RespCenter2."Bank Account No.",
                      RespCenter2."Bank Branch No.",
                      RespCenter2."Bank Name",
                      RespCenter2."Transit No.",
                      RespCenter2.IBAN,
                      RespCenter2."SWIFT Code");
                end;
            DATABASE::"Company Information":
                begin
                    CompanyInfo := Variant;
                    UpdateBankInfo(
                      CompanyInfo."Default Bank Account Code",
    ...
    begin
        ...
        if "Currency Factor" <> xRec."Currency Factor" then begin
            if (xRec."Currency Factor" = "VAT Currency Factor") or HideValidationDialog then begin
    ...
    var
        AdvLetterLineRelation: Record "Advance Letter Line Relation";
    ...
    begin
        ...
        AdvLetterLineRelation.SetRange("Document Type", "Document Type");
        AdvLetterLineRelation.SetRange("Document No.", "No.");

        if AdvLetterLineRelation.FindSet(false, false) then begin
            repeat
                if SalesAdvLetterHeader.Get(AdvLetterLineRelation."Letter No.") then
                    SalesAdvLetterHeader.Mark(true);
            until AdvLetterLineRelation.Next = 0;
        end;

        SalesAdvLetterHeader.MarkedOnly(true);
        PAGE.Run(0, SalesAdvLetterHeader);
    end;

    [Scope('OnPrem')]
    procedure GetPostingLineImage(var TempSalesLine: Record "Sales Line" temporary; QtyType: Option General,Invoicing,Shipping,Remaining; IncludeRounding: Boolean)
    var
    ...
    begin
        ...
        if SalesLine.FindSet then
            repeat
                TempOldSalesLine := SalesLine;
                TempOldSalesLine.Insert();
                if QtyType = QtyType::Remaining then begin
                    TempOldSalesLine."Qty. to Ship" := TempOldSalesLine."Outstanding Quantity";
                    TempOldSalesLine."Qty. to Ship (Base)" := TempOldSalesLine."Outstanding Qty. (Base)";
                    TempOldSalesLine."Qty. to Invoice" := TempOldSalesLine.MaxQtyToInvoice;
                    TempOldSalesLine."Qty. to Invoice (Base)" := TempOldSalesLine.MaxQtyToInvoiceBase;
                    TempOldSalesLine.Modify();
                end;
            until SalesLine.Next = 0;
        ...
        SalesPost.SetNoRounding(not IncludeRounding);
        SalesPost.GetSalesLinesTemp(TempSalesHeader, TempSalesLine, TempOldSalesLine, QtyType);
    end;
    ...
    begin
        ...
        if AdvLetterLineRelation.FindSet then
            ...
            SalesAdvanceLetterHeader.SetCurrentKey("Order No.");
            SalesAdvanceLetterHeader.SetRange("Order No.", "No.");
            SalesAdvanceLetterHeader.ModifyAll("Order No.", '');
        end;
    end;
    ...
    begin
        ...
        // NAVCZ
        "Registration No." := SellToCustomer."Registration No.";
        "Tax Registration No." := SellToCustomer."Tax Registration No.";
        // NAVCZ
    ...
    begin
        ...
        "Industry Code" := BillToCustomer."Industry Code";
        "Registration No." := BillToCustomer."Registration No.";
        "Tax Registration No." := BillToCustomer."Tax Registration No.";
        // NAVCZ
    ...
    begin
        ...
        // NAVCZ
        "Bank Account Code" := SourceSalesHeader."Bank Account Code";
        "Bank Name" := SourceSalesHeader."Bank Name";
        "Bank Account No." := SourceSalesHeader."Bank Account No.";
        "Bank Branch No." := SourceSalesHeader."Bank Branch No.";
        IBAN := SourceSalesHeader.IBAN;
        "SWIFT Code" := SourceSalesHeader."SWIFT Code";
        Validate("Posting Desc. Code", SourceSalesHeader."Posting Desc. Code");
        // NAVCZ
    ...
    begin
        ...
        if CustBankAcc.SetCurrentKey("Customer No.", Priority) then
            CustBankAcc.SetFilter(Priority, '%1..', 1);
        if not CustBankAcc.FindFirst then
            CustBankAcc.SetRange(Priority);
        if not CustBankAcc.FindFirst then
            CustBankAcc.Init();

        exit(CustBankAcc.Code);
    end;

    local procedure ValidateShipmentMethodCode(ShipmentMethodCode: Code[10])
    begin
        // NAVCZ
