report 206 "Sales - Invoice"
{
    ...
    [IntegrationEvent(false, false)]
    [Scope('OnPrem')]
    procedure OnGetDocumentReferenceText(SalesInvoiceHeader: Record "Sales Invoice Header"; var DocumentReference: Text; var DocumentReferenceText: Text; var Handled: Boolean)
    begin
    end;
