report 206 "Sales - Invoice"
{
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CompanyInfoEnterpriseNo; CompanyInfo.GetRegistrationNumber)
                    {
                    }
                    ...
                    column(NoText; "Sales Invoice Header".GetCustomerVATRegistrationNumber)
                    {
                    }
                    ...
                    column(ShipmentDateText; ShipmentDateText)
                    {
                    }
                    column(CompanyInfoPhoneNoCaption; CompanyInfoPhoneNoCaptionLbl)
                    {
                    }
                    column(CompanyInfoEnterpriseNoCptn; CompanyInfo.GetRegistrationNumberLbl)
                    {
                    }
    ...
    begin
        with SalesInvoiceHeader do begin
            ...
            VATNoText := FormatDocument.SetText("VAT Registration No." <> '', GetCustomerVATRegistrationNumberLbl);
        end;
    end;
    ...
    begin
        ...
        VATEntry.SetRange("Posting Date", "Sales Invoice Header"."Posting Date");
