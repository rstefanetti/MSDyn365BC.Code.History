report 206 "Sales - Invoice"
{
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(ElectronicInvoicing; SalesSetup."Electronic Invoicing")
            {
            }
            column(LocalLegalStatementCaption; SalesSetup.GetLegalStatement)
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(Comment; "Integer")
                    {
                        ...
                        trigger OnPreDataItem()
                        begin
                            if not SalesSetup."Electronic Invoicing" then
                                CurrReport.Break();
                        end;
                    }
                }
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(AlwaysShowVATSum; AlwShowVATSum)
                    {
                        ApplicationArea = Basic, Suite;
