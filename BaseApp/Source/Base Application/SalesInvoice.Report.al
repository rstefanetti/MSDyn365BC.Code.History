report 206 "Sales - Invoice"
{
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(SalesLineType; Format(Type))
                        {
                        }
                        column(SalesLineTypeInt; Format(Type, 0, 2))
                        {
                        }
    ...
    begin
        ...
        CHReportManagement.PrepareHeader(RecRef, REPORT::"Sales - Invoice", HeaderLabel, HeaderTxt);
    end;
    ...
    begin
        RecRef.GetTable("Sales Invoice Header");
        CHReportManagement.PrepareFooter(RecRef, REPORT::"Sales - Invoice", FooterLabel, FooterTxt);
