table 37 "Sales Line"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Type';
            OptionCaption = ' ,G/L Account,Item,Resource,Fixed Asset,Charge (Item),Title,Begin-Total,End-Total,New Page';
            OptionMembers = " ","G/L Account",Item,Resource,"Fixed Asset","Charge (Item)",Title,"Begin-Total","End-Total","New Page";
