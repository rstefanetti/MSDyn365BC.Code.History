table 37 "Sales Line"
{
    ...
    fields
    {
                        ...
                        begin
                            ...
                            if ("No." <> '') and (not DescriptionIsNo) and (Description <> '') then begin
                                ...
                                if Item.FindFirst then
                                    Confirmed := EnvInfoProxy.IsInvoicing
                                else begin
                                ...
                                if EnvInfoProxy.IsInvoicing or Confirmed then
                                    Validate("No.", Item."No.");
                                exit;
                            end;
                            ...
                            if Item.TryGetItemNoOpenCard(
                                 ReturnValue, Description, DefaultCreate, not GetHideValidationDialog, not EnvInfoProxy.IsInvoicing)
                            then
                                case ReturnValue of
                                    '':
                                        begin
        ...
        field(17; "Qty. to Invoice"; Decimal)
        {
            ...
            begin
                ...
                CheckPartialOnSNTracking(xRec."Qty. to Invoice (Base)", "Qty. to Invoice (Base)"); // NAVCZ
            end;
        }
        field(18; "Qty. to Ship"; Decimal)
        {
            ...
            begin
                ...
                CheckPartialOnSNTracking(xRec."Qty. to Ship (Base)", "Qty. to Ship (Base)"); // NAVCZ
            end;
        }
        ...
        field(110; "Prepmt. Line Amount"; Decimal)
        {
            ...
            begin
                ...
                // NAVCZ
                GetSalesHeader;
                if "Adjust Prepmt. Relation" then begin
                    if "Prepmt. Line Amount" + Currency."Amount Rounding Precision" < "Prepmt. Amt. Inv." then
        ...
        field(11763; "VAT Correction"; Boolean)
        {
            ...
            trigger OnValidate()
            begin
                if not "VAT Correction" then begin
                    "VAT Difference" := 0;
                    "VAT Difference (LCY)" := 0;
                end;
            end;
        ...
        field(31002; "Adv.Letter Linked Inv. Amount"; Decimal)
        {
            AutoFormatExpression = "Currency Code";
            AutoFormatType = 1;
        ...
        field(31003; "Adv.Letter Linked Ded. Amount"; Decimal)
        {
            AutoFormatExpression = "Currency Code";
            AutoFormatType = 1;
        ...
        field(31004; "Adv.Letter Link.Amt. to Deduct"; Decimal)
        {
            AutoFormatExpression = "Currency Code";
            AutoFormatType = 1;
        ...
        field(31005; "Has Letter Line Relation"; Boolean)
        {
        ...
        field(31007; "Prepmt. Amt. Requested"; Decimal)
        {
            CalcFormula = Sum ("Advance Letter Line Relation"."Requested Amount" WHERE(Type = CONST(Sale),
                                                                                       "Document No." = FIELD("Document No."),
                                                                                       "Document Line No." = FIELD("Line No.")));
            Caption = 'Prepmt. Amt. Requested';
            FieldClass = FlowField;
        }
        ...
        field(31009; "Adv.Letter Linked Amount"; Decimal)
        {
        ...
        field(31060; "Physical Transfer"; Boolean)
        {
            ...
            trigger OnValidate()
            begin
                if "Physical Transfer" then begin
                    TestField(Type, Type::Item);
    ...
    var
        ...
        Text26585: Label 'cannot be changed while there is a related %1=%2 in %3=%4';
    ...
    begin
        ItemCharge.Get("No.");
        ItemCharge.TestField("Purchase Only", false); // NAVCZ
    ...
    begin
        ...
        if true then begin // NAVCZ
            ...
            // NAVCZ
            if "Adjust Prepmt. Relation" and not IsServiceCharge then begin
                if "Prepmt. Line Amount" + Currency."Amount Rounding Precision" < "Prepmt. Amt. Inv." then
                    FieldError("Prepmt. Line Amount", StrSubstNo(Text044, "Prepmt. Amt. Inv."));
            end else
                // NAVCZ
            ...
            if FindSet then
                repeat
                    if not ZeroAmountLine(QtyType) then begin
                        ...
                        if VATAmountLine.Modified or VATAmountLine."Modified (LCY)" then begin // NAVCZ
                            ...
                            if QtyType = QtyType::General then
                                ...
                                if VATAmountLine.CalcLineAmount = 0 then begin
                                    ...
                                    VATDifferenceLCY :=
                                      ...
                                      VATAmountLine."VAT Difference (LCY)" * (LineAmountToInvoice - InvDiscAmount) / VATAmountLine.CalcLineAmount;
                                end;
                                if LineAmountToInvoice = 0 then begin
                                    ...
                                    "VAT Difference (LCY)" := Round(VATDifferenceLCY, Currency."Amount Rounding Precision");
                                end;
                                // NAVCZ
                            end;
                            if QtyType = QtyType::General then
                            ...
                            if QtyType = QtyType::Invoicing then
                                "VAT Correction" := VATAmountLine."Modified (LCY)";
                            // NAVCZ
                            Modify;
    ...
    begin
            ...
            if FindSet then
                repeat
                    if not ZeroAmountLine(QtyType) then begin
                        ...
                        case QtyType of
                            QtyType::General:
                                begin
                                    ...
                                    VATAmountLine."VAT Difference (LCY)" += "VAT Difference (LCY)"; // NAVCZ
                        ...
                        VATCorrection := VATCorrection and "VAT Correction"; // NAVCZ
        ...
        // NAVCZ
        VATAmountLine.UpdateLinesWithVATCorrection(
          Currency, SalesHeader."Prices Including VAT", SalesSetup."Allow VAT Difference", VATCorrection);

        if SalesSetup."Allow VAT Difference" and (SalesHeader."Currency Code" <> '') and not VATAmountLine.IsEmpty then
            UpdateLinesLCY(SalesHeader, TempSalesLine, QtyType, VATCorrection, VATAmountLine);
        // NAVCZ
    ...
    begin
        // NAVCZ
        if ((Quantity - "Quantity Invoiced") <> 0) and (("Prepmt. Amt. Inv." - "Prepmt Amt Deducted") > 0) then begin
            GetSalesHeader;
            if SalesHeader."Prepayment Type" = SalesHeader."Prepayment Type"::Advance then begin
                GrossAmount := Round("Unit Price" * Quantity, Currency."Amount Rounding Precision");
                "Prepmt Amt to Deduct" :=
                  Round(
                    Round(
                      Round(
                        (GrossAmount -
                         Round(GrossAmount * "Line Discount %" / 100, Currency."Amount Rounding Precision")) *
                        "Prepayment %" / 100, Currency."Amount Rounding Precision") - "Prepmt Amt Deducted") *
                    "Qty. to Invoice" / (Quantity - "Quantity Invoiced"), Currency."Amount Rounding Precision");

                MaxAmount := Round((GrossAmount -
                                    Round(GrossAmount * "Line Discount %" / 100, Currency."Amount Rounding Precision")) *
                    "Qty. to Invoice" / Quantity, Currency."Amount Rounding Precision");
                if MaxAmount < "Prepmt Amt to Deduct" then
                    "Prepmt Amt to Deduct" := MaxAmount;
                if "Prepmt Amt to Deduct" > ("Prepmt. Amt. Inv." - "Prepmt Amt Deducted") then
    ...
    begin
        ...
        with SalesLine do begin
            ...
            if SalesHeader."Currency Code" <> '' then begin
                ...
                VATCoefficientRounded.RoundSalesLine(SalesLine, SalesHeader);
            end;

            IncrAmount(TotalSalesLineLCY, SalesLine);
            Increment(TotalSalesLineLCY."Unit Cost (LCY)", Round(SalesLineQty * "Unit Cost (LCY)"));
        end;
    end;

    local procedure IncrAmount(var TotalSalesLine: Record "Sales Line"; SalesLine: Record "Sales Line")
    begin
        // NAVCZ
        with SalesLine do begin
    ...
    local procedure UpdateLinesLCY(SalesHeader: Record "Sales Header"; var TempSalesLine: Record "Sales Line" temporary; QtyType: Option General,Invoicing,Shipping; VATCorrection: Boolean; var VATAmountLine: Record "VAT Amount Line")
    var
    ...
    begin
        ...
        TempSalesLine2.Copy(TempSalesLine, true);
        ...
        if TempSalesLine.FindSet then begin
            repeat
                case QtyType of
                    QtyType::General:
                        QtyFactor := TempSalesLine.Quantity;
                    QtyType::Invoicing:
                        QtyFactor := TempSalesLine."Qty. to Invoice";
                    QtyType::Shipping:
                        QtyFactor := TempSalesLine."Qty. to Ship";
                end;
                DivideAmount(SalesHeader, TempSalesLine, QtyType, QtyFactor, VATAmountLine, TempVATAmountLineRemainder);
                RoundAmount(QtyFactor, SalesHeader, TempSalesLine);

                VATAmountLine."Amount Including VAT (LCY)" += TempSalesLine."Amount Including VAT";
                VATAmountLine."VAT Base (LCY)" += TempSalesLine.Amount;
                VATAmountLine."VAT Amount (LCY)" := VATAmountLine."Amount Including VAT (LCY)" - VATAmountLine."VAT Base (LCY)";
                VATAmountLine."Calculated VAT Amount (LCY)" := VATAmountLine."VAT Amount (LCY)";
                VATAmountLine."VAT Amount (LCY)" += VATAmountLine."VAT Difference (LCY)";

                if not VATCorrection then begin
            ...
            VATAmountLine."VAT Base (LCY)" := Round(
                VATAmountLine."VAT Base (LCY)", Currency."Amount Rounding Precision");
            VATAmountLine."Calculated VAT Amount (LCY)" := Round(
                VATAmountLine."Calculated VAT Amount (LCY)", Currency."Amount Rounding Precision");
            VATAmountLine."VAT Amount (LCY)" := VATAmountLine.RoundVAT(
                Round(VATAmountLine."VAT Amount (LCY)", Currency."Amount Rounding Precision"));
            VATAmountLine.Modify;
        end;
    end;
    ...
    begin
        // NAVCZ
        if (PrevQty <> NewQty) and (Type = Type::Item) then begin
            if Item.Get("No.") then
    ...
    local procedure xSetGPPGfromSKU()
    var
        GenPostingSetup: Record "General Posting Setup";
        Item: Record Item;
    begin
    ...
    begin
        ...
        if "Document Type" in ["Document Type"::Order, "Document Type"::Invoice] then begin
            ...
            LineRelation.SetRange("Document Type", "Document Type");
                ...
                if LetterLine.Get(LineRelation."Letter No.", LineRelation."Letter Line No.") then
                    FieldError(Type,
                      StrSubstNo(Text26585,
                        LetterLine.FieldCaption("Line No."), LetterLine."Line No.",
                        LetterLine.FieldCaption("Letter No."), LetterLine."Letter No."));
            end;
        end;
    end;
    ...
    begin
        ...
        if not "System-Created Entry" and
           ("Document Type" in ["Document Type"::Order, "Document Type"::Invoice]) and
           HasTypeToFillMandatoryFields or IsServiceCharge
        then
            // NAVCZ
    ...
    local procedure CheckIndivisibleUnit()
    var
        Item: Record Item;
    begin
        // NAVCZ
        ...
        if IsIndivisibleUnit("No.", "Unit of Measure Code") then
            if Quantity <> Round(Quantity, 1) then
                FieldError(Quantity, MustBeIntegralNumberErr);

        GetItem(Item);
        if IsIndivisibleUnit(Item."No.", Item."Base Unit of Measure") then
            if "Quantity (Base)" <> Round("Quantity (Base)", 1) then
                FieldError("Quantity (Base)", MustBeIntegralNumberErr);
    end;

    local procedure IsIndivisibleUnit(ItemNo: Code[20]; UOMCode: Code[10]): Boolean
    var
    ...
    [Scope('OnPrem')]
    procedure CancelAdvanceLetterRelations()
    var
    ...
    local procedure IsCalcVATAmountLinesHandled(SalesHeader: Record "Sales Header"; var SalesLine: Record "Sales Line"; var VATAmountLine: Record "VAT Amount Line") IsHandled: Boolean
    begin
        IsHandled := false;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCalcVATAmountLines(SalesHeader: Record "Sales Header"; var SalesLine: Record "Sales Line"; var VATAmountLine: Record "VAT Amount Line"; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeGetSalesHeader(var SalesLine: Record "Sales Line"; var SalesHeader: Record "Sales Header"; var IsHanded: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeGetUnitCost(SalesLine: Record "Sales Line"; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnUpdateAmountOnBeforeCheckCreditLimit(var SalesLine: Record "Sales Line"; var IsHandled: Boolean)
    begin
    end;
