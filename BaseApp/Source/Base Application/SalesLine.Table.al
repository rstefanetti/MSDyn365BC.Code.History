table 37 "Sales Line"
{
    ...
    keys
    {
        ...
        key(Key6; "Document Type", "Bill-to Customer No.", "Shortcut Dimension 1 Code", "Shortcut Dimension 2 Code", "Currency Code", "Agreement No.")
        {
            Enabled = false;
        ...
        key(Key8; "Document Type", "Document No.", "Location Code")
        {
            ...
            SumIndexFields = Amount, "Amount Including VAT", "Outstanding Amount", "Shipped Not Invoiced", "Outstanding Amount (LCY)", "Shipped Not Invoiced (LCY)", "Amount (LCY)", "Amount Including VAT (LCY)";
        }
