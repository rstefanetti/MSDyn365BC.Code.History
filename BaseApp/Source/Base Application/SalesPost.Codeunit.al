codeunit 80 "Sales-Post"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCreateCarteraBills(SalesHeader: Record "Sales Header"; CustLedgerEntry: Record "Cust. Ledger Entry"; var TotalSalesLine: Record "Sales Line")
    begin
    end;
