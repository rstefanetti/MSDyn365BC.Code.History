codeunit 80 "Sales-Post"
{
    ...
    begin
        with SalesHeader do begin
            ...
            if GLSetup."Enable Russian Accounting" then
                DocSignMgt.CheckDocSignatures(DATABASE::"Sales Header", "Document Type", "No.");
            ...
            OnCheckAndUpdateOnAfterCalcInvDiscount(SalesHeader);
    ...
    begin
        ...
        with ItemJnlLine do begin
            ...
            OnPostItemJnlLineOnAfterPrepareItemJnlLine(ItemJnlLine, SalesLine, SalesHeader);
    ...
    begin
        ...
        with SalesHeader do begin
            ...
            then begin
                ...
                DocSignMgt.DeleteDocSign(DATABASE::"Sales Header", "Document Type", "No.");
                ...
                repeat
                    ...
                    if Item."Item Tracking Code" <> '' then begin
                        ...
                        ItemTrackingManagement.GetItemTrackingSetup(
                            ItemTrackingCode, CDTrackingSetup, ItemJnlLine."Entry Type"::Sale, Inbound, ItemTrackingSetup);
    ...
    begin
        IsHandled := false;
        OnBeforeUpdateSalesHeader(CustLedgerEntry, SalesInvHeader, SalesCrMemoHeader, GenJnlLineDocType, IsHandled);
        if IsHandled then
            exit;
    ...
    local procedure CopyUpdateCorrDoc(var SalesHeader: Record "Sales Header"; CustLedgerEntry: Record "Cust. Ledger Entry"; DetailedCVLedgEntryBuffer: Record "Detailed CV Ledg. Entry Buffer"; var PrepmtDiffManagement: Codeunit PrepmtDiffManagement; DocType: Option; PrepmtAdjmt: Boolean)
    var
        SalesLine: Record "Sales Line";
    ...
    begin
        ...
        Currency.Get(CurrencyCode);
        repeat
            if (SalesLine.Type > 0) and (SalesLine."No." <> '') then begin
        ...
        with TempSalesLine do begin
            ...
            if FindSet() then
                repeat
                    ...
                    if WhseHandlingRequired(TempSalesLine) or SetDefaultQtyBlank then begin
                        if "Document Type" = "Document Type"::"Return Order" then begin
                            "Return Qty. to Receive" := 0;
                            "Return Qty. to Receive (Base)" := 0;
                        end else begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCheckAndUpdateOnAfterCalcInvDiscount(SalesHeader: Record "Sales Header");
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnPostItemJnlLineOnAfterPrepareItemJnlLine(var ItemJournalLine: Record "Item Journal Line"; SalesLine: Record "Sales Line"; SalesHeader: Record "Sales Header")
    begin
    end;
