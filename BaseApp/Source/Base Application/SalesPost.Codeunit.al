codeunit 80 "Sales-Post"
{
    ...
    begin
        with SalesHeader do begin
            ...
            if Invoice and ("Operation Occurred Date" < GLSetup."Last Gen. Jour. Printing Date") then
                FieldError("Operation Occurred Date", StrSubstNo(Text1130007Err, GLSetup."Last Gen. Jour. Printing Date"));
    ...
    begin
        ...
        with SalesHeader do begin
            ...
            PaymentLines.SetRange(Type, "Document Type");
                ...
                repeat
                    ...
                    if "Prepmt Amt to Deduct" <> 0 then begin
                        ...
                        if TempLineFound then begin
                            ...
                            TempPrepmtSalesLine.Validate("No.", VATPostingSetup."Sales Prepayments Account");
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            "Applies-to Occurrence No." := SalesHeader."Applies-to Occurrence No.";
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            if PaymentMethod."Free Type" = PaymentMethod."Free Type"::"Only VAT Amt." then begin
                Amount := TotalSalesLine2."Amount Including VAT" - TotalSalesLine2.Amount;
                "Amount (LCY)" := TotalSalesLineLCY2."Amount Including VAT" - TotalSalesLineLCY2.Amount;
            end else begin
                Amount := TotalSalesLine2."Amount Including VAT" + TotalRemainPmtDiscPossible;
        ...
        with SalesHeader do begin
            ...
            if PaymentTermsLine.Find('-') then
                ...
                if "Payment Terms Code" <> '' then
                    Error(Text1130003Err, FieldCaption("Payment Terms Code"), "Payment Terms Code");
        end;
    end;
    ...
    begin
        with GenJnlLine do begin
            ...
            "Tax Representative Type" :=
              ConvertSalesTaxRepresentativeTypeToGenJnlLine(SalesHeader."Tax Representative Type");
