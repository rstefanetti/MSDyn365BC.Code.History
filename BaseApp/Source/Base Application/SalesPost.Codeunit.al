codeunit 80 "Sales-Post"
{
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            SetAmountsForBalancingEntry(CustLedgEntry, TotalSalesLine2, TotalSalesLineLCY2, GenJnlLine, SalesHeader);
    ...
    local procedure SetAmountsForBalancingEntry(CustLedgEntry: Record "Cust. Ledger Entry"; TotalSalesLine2: Record "Sales Line"; TotalSalesLineLCY2: Record "Sales Line"; var GenJnlLine: Record "Gen. Journal Line"; SalesHeader: Record "Sales Header")
    var
        CurrExchRate: Record "Currency Exchange Rate";
        IsHandled: Boolean;
    begin
        ...
        GenJnlLine."Original Pmt. Disc. Possible" := TotalSalesLine2."Pmt. Discount Amount";
        GenJnlLine."Org. Pmt. Disc. Possible (LCY)" :=
            CurrExchRate.ExchangeAmtFCYToLCY(
                UseDate, SalesHeader."Currency Code", TotalSalesLine2."Pmt. Discount Amount", SalesHeader."Currency Factor");
    end;
