codeunit 80 "Sales-Post"
{
            ...
            if FindSet then begin
                ...
                repeat
                    ...
                    if Item."Item Tracking Code" <> '' then begin
                        ...
                        CheckSalesLine := not SNRequired and not LotRequired and not CDRequired;
    ...
    begin
        if SalesLine.AsmToOrderExists(AsmHeader) then begin
            ...
            OnPostATOOnBeforePostedATOLinkInsert(PostedATOLink, AsmHeader);
    ...
    begin
        ...
        if PrepaymentAdjustment then begin
            ...
            AmtDiffMgt.UpdatePDDocPostingNo(
              SalesHeader."Posting No. Series", SalesHeader."Posting No.", InvEntry."Entry No.", 0, SalesHeader."Document Type" - 2);
        end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforePostUpdateOrderLine(SalesHeader: Record "Sales Header"; var TempSalesLineGlobal: Record "Sales Line" temporary; CommitIsSuppressed: Boolean; SalesSetup: Record "Sales & Receivables Setup")
    begin
    end;
