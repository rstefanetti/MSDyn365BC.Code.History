codeunit 80 "Sales-Post"
{
    ...
    begin
        with SalesHeader do begin
            ...
            if GenJnlCheckLine.IsDateNotAllowed("Posting Date", SetupRecID, "Journal Template Name") then
    ...
    begin
        ...
        with TempICGenJnlLine do begin
            ...
            Validate(Amount);
            "Journal Template Name" := SalesHeader."Journal Template Name";
    ...
    begin
        ...
        with GenJnlLine do begin
            ...
            "Original Pmt. Disc. Possible" := -TotalSalesLine2."Pmt. Discount Amount";
            "Org. Pmt. Disc. Possible (LCY)" :=
              CurrExchRate.ExchangeAmtFCYToLCY(
                UseDate, SalesHeader."Currency Code", -TotalSalesLine2."Pmt. Discount Amount", SalesHeader."Currency Factor");
    ...
    begin
        with GenJnlLine do begin
            ...
            CopyFromSalesHeader(SalesHeader);
            BillToCust.Get("Bill-to/Pay-to No.");
            "Country/Region Code" := BillToCust."Country/Region Code";

            CopyFromInvoicePostBuffer(InvoicePostBuffer);
            "Journal Template Name" := InvoicePostBuffer."Journal Template Name";
            "Original Pmt. Disc. Possible" := TotalSalesLine."Pmt. Discount Amount";
            "Org. Pmt. Disc. Possible (LCY)" :=
              CurrExchRate.ExchangeAmtFCYToLCY(
                UseDate, SalesHeader."Currency Code", TotalSalesLine."Pmt. Discount Amount", SalesHeader."Currency Factor");
