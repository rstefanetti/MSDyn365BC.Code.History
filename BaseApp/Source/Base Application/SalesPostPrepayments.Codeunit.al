codeunit 442 "Sales-Post Prepayments"
{
        ...
        with SalesHeader do begin
            ...
            repeat
                ...
                case DocumentType of
                    DocumentType::Invoice:
                        begin
                            InsertSalesInvLine(SalesInvHeader, LineNo, TempPrepmtInvLineBuffer, "No.");
    ...
    local procedure InsertSalesInvLine(SalesInvHeader: Record "Sales Invoice Header"; LineNo: Integer; PrepmtInvLineBuffer: Record "Prepayment Inv. Line Buffer"; SalesHeaderNo: Code[20])
    var
        SalesInvLine: Record "Sales Invoice Line";
    ...
    begin
        with PrepmtInvLineBuffer do begin
            ...
            if IsFullGST then begin
                ...
                SalesLine2.Reset;
                SalesLine2.SetFilter("Document No.", SalesHeaderNo);
