    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Default Cancel Reason Code"; "Default Cancel Reason Code")
                {
                    ApplicationArea = Basic, Suite;
            ...
            {
                Caption = 'WHT/GST';
                field("Print WHT on Credit Memo"; "Print WHT on Credit Memo")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if we want WHT certificates to be printed.';
                }
                field("Print Dialog"; "Print Dialog")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if we do not want to use the default printer during printing of reports.';
                }
                field("Payment Discount Reason Code"; "Payment Discount Reason Code")
                {
                    ApplicationArea = Basic, Suite;
