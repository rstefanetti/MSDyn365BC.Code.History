    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Calc. VAT per Line"; "Calc. VAT per Line")
                {
                    ApplicationArea = Basic, Suite;
            ...
            group(Dimensions)
            {
                ...
                field("Customer Agreement Dim. Code"; "Customer Agreement Dim. Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the customer agreement dimension code associated with the sales and receivables setup information.';
                }
                field("Synch. Agreement Dimension"; "Synch. Agreement Dimension")
                {
                    ApplicationArea = Basic, Suite;
            ...
            group("Number Series")
            {
                ...
                field("Customer Agreement Nos."; "Customer Agreement Nos.")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Posted Corr. Invoice Nos."; "Posted Corr. Invoice Nos.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number series from which numbers are assigned to new records.';
                }
                field("Posted Corr. Credit Memo Nos."; "Posted Corr. Credit Memo Nos.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number series from which numbers are assigned to new records.';
                }
            ...
            group(Application)
            {
                ...
                field("Check Application Date"; "Check Application Date")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the date is used to apply customer payments.';
                }
                field("Check Application Period"; "Check Application Period")
                {
                    ApplicationArea = Basic, Suite;
            ...
            group(Other)
            {
                ...
                field("Transfer Posting Description"; "Transfer Posting Description")
                {
                    ApplicationArea = Basic, Suite;
            ...
            {
                Caption = 'Templates';
                field("Job Ticket Template Code"; "Job Ticket Template Code")
                {
                    ApplicationArea = Basic, Suite;
                }
                field("Bill of Lading Template Code"; "Bill of Lading Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Factura Template Code"; "Factura Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("TORG-12 Template Code"; "TORG-12 Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Proforma Template Code"; "Proforma Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Corr. Factura Template Code"; "Corr. Factura Template Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
                field("Sales Shipment M-15 Templ.Code"; "Sales Shipment M-15 Templ.Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the journal template that is used for the process in question. ';
                }
