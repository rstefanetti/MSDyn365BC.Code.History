    ...
    layout
    {
        area(content)
        {
            ...
            group("Number Series")
            {
                ...
                field("Journal Templ. Sales Invoice"; "Journal Templ. Sales Invoice")
                {
                ...
                field("Journal Templ. Sales Cr. Memo"; "Journal Templ. Sales Cr. Memo")
                {
                    ApplicationArea = BasicBE;
