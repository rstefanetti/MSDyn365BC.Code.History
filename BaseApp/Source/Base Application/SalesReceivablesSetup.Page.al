    ...
    layout
    {
        area(content)
        {
            ...
            group(Documents)
            {
                ...
                field("Use KID on Fin. Charge Memo"; "Use KID on Fin. Charge Memo")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if you want to print Kunde ID (KID) numbers on the Finance Charge Memo.';
                }
                field("Use KID on Reminder"; "Use KID on Reminder")
                {
                    ApplicationArea = Basic, Suite;
            ...
            group("E-Invoice")
            {
                ...
                group("Output Paths")
                {
                    ...
                    field("E-Invoice Sales Invoice Path"; "E-Invoice Sales Invoice Path")
                    {
                        ApplicationArea = Basic, Suite;
                    ...
                    field("E-Invoice Sales Cr. Memo Path"; "E-Invoice Sales Cr. Memo Path")
                    {
                        ApplicationArea = Basic, Suite;
                    ...
                    field("E-Invoice Reminder Path"; "E-Invoice Reminder Path")
                    {
                        ApplicationArea = Basic, Suite;
                    ...
                    field("E-Invoice Fin. Charge Path"; "E-Invoice Fin. Charge Path")
                    {
                        ApplicationArea = Basic, Suite;
