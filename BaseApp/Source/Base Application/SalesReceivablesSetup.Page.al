    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Fattura PA Electronic Format"; "Fattura PA Electronic Format")
                {
                    ApplicationArea = Basic, Suite;
            ...
            group("Number Series")
            {
                ...
                field("VAT Exemption Nos."; "VAT Exemption Nos.")
                {
                    ApplicationArea = Basic, Suite;
