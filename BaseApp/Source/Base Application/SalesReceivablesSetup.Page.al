    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Posting Date Check on Posting"; "Posting Date Check on Posting")
                {
                    ApplicationArea = Basic, Suite;
