page 160 "Sales Statistics"
{
        ...
        area(content)
        {
            ...
            group("Prepayment (Deduct)")
            {
                ...
                field("TempTotVATAmountLinePrep.""VAT Base"""; TempTotVATAmountLinePrep."VAT Base")
                {
                    ...
                    Caption = 'VAT Base';
                    Editable = false;
                    ToolTip = 'Specifies vat base of purchase order';
                }
            ...
            group("Invoicing (Final)")
            {
                ...
                field("TotalSalesLine.""Amount Including VAT"" - ""Adv.Letter Link.Amt. to Deduct"""; TotalSalesLine."Amount Including VAT" - "Adv.Letter Link.Amt. to Deduct")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Amount Including VAT';
                    Editable = false;
            ...
            then begin
                ...
                if "Prices Including VAT" then
                    if GLSetup."Round VAT Coeff." then begin
                        ...
                        TotalSalesLineLCY.Amount := TotalSalesLineLCY."Line Amount" - TotalSalesLineLCY.Amount;
                    end else
                        TotalSalesLineLCY.Amount :=
                          Round(
                            (TotalSalesLineLCY."Line Amount" - TempVATAmountLine."Invoice Discount Amount") /
    ...
    begin
        ...
        CurrPage.SubForm.PAGE.SetCurrencyFactor("Currency Factor"); // NAVCZ
    end;
