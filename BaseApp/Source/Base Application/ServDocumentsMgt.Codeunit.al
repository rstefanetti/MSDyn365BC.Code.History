        ...
        with ServHeader do begin
            ...
            if Invoice then begin
                ...
                ServPostingJnlsMgt.PostCustomerEntry(
                  ...
                  GenJnlLineDocType, GenJnlLineDocNo, GenJnlLineExtDocNo, "Customer Posting Group"); // NAVCZ
    ...
    begin
        with ServHeader do begin
            ...
            if ("Variable Symbol" = '') and (not BankAccount.IsEmpty) then begin
                ...
                ServInvHeader."Variable Symbol" := VariableSymbol;
    ...
    begin
        with ServHeader do begin
            ...
            if ("Variable Symbol" = '') and (not BankAccount.IsEmpty) then begin
                ...
                ServCrMemoHeader."Variable Symbol" := VariableSymbol;
                ServPostingJnlsMgt.SetVariableSymbol(VariableSymbol);
            end;
            // NAVCZ
