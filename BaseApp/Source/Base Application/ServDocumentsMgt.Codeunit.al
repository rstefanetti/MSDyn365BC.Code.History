codeunit 5988 "Serv-Documents Mgt."
{
    ...
    begin
        with ServHeader do begin
            ...
            if Invoice then begin
                ...
                PaymentTermsLine.SetRange("Sales/Purchase", PaymentTermsLine."Sales/Purchase"::Service);
                ...
                if PaymentTermsLine.Find('-') then
                    repeat
                        ...
                        if "Document Type" in ["Document Type"::Order, "Document Type"::Invoice] then begin
                            ...
                            PostedPayments.Code := ServInvHeader."No.";
                        end else begin
                            PostedPayments.Type := PostedPayments.Type::"Credit Memo";
                            PostedPayments.Code := ServCrMemoHeader."No.";
                        end;
    ...
    begin
        with ServHeader do begin
            ...
            then begin
                ...
                ServShptHeader."Shipment Method Code" := "Shipment Method Code";
                ServShptHeader."Shipping Agent Code" := "Shipping Agent Code";
    ...
    begin
        ...
        PaymentTermsLine.SetRange(Type, ServHeader."Document Type");
                ...
                with ServLine do begin
                    ...
                    if "Document Type" in ["Document Type"::Order, "Document Type"::Invoice, "Document Type"::"Credit Memo"] then
                        if VATPostingSetup.IsEUService("VAT Bus. Posting Group", "VAT Prod. Posting Group") then begin
                            ...
                            ServHeader.TestField("Transport Method");
    ...
    [Scope('OnPrem')]
    procedure FinalizeDeletePmtTermLines()
    begin
        PaymentTermsLine.Reset;
        PaymentTermsLine.SetRange("Sales/Purchase", PaymentTermsLine."Sales/Purchase"::Service);
        PaymentTermsLine.SetRange(Type, ServHeader."Document Type");
