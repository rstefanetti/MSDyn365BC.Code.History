table 5995 "Service Cr.Memo Line"
{
    ...
    begin
        // NAVCZ
        IncrAmount(TotalServCrMemoLine, ServCrMemoHeader);
        if ServCrMemoHeader."Currency Code" <> '' then begin
            NoVAT := Amount = "Amount Including VAT";
            "Amount Including VAT" :=
              Round(
                CurrExchRate.ExchangeAmtFCYToLCY(
                  ServCrMemoHeader."Posting Date", ServCrMemoHeader."Currency Code",
                  TotalServCrMemoLine."Amount Including VAT", ServCrMemoHeader."Currency Factor")) -
              TotalServCrMemoLineLCY."Amount Including VAT";
            if NoVAT then
                ...
                Amount :=
                  Round(
                    CurrExchRate.ExchangeAmtFCYToLCY(
                      ServCrMemoHeader."Posting Date", ServCrMemoHeader."Currency Code",
                      TotalServCrMemoLine.Amount, ServCrMemoHeader."Currency Factor")) -
                  TotalServCrMemoLineLCY.Amount;
            "Line Amount" :=
              Round(
                CurrExchRate.ExchangeAmtFCYToLCY(
                  ServCrMemoHeader."Posting Date", ServCrMemoHeader."Currency Code",
                  TotalServCrMemoLine."Line Amount", ServCrMemoHeader."Currency Factor")) -
              TotalServCrMemoLineLCY."Line Amount";
            "Line Discount Amount" :=
              Round(
                CurrExchRate.ExchangeAmtFCYToLCY(
                  ServCrMemoHeader."Posting Date", ServCrMemoHeader."Currency Code",
                  TotalServCrMemoLine."Line Discount Amount", ServCrMemoHeader."Currency Factor")) -
              TotalServCrMemoLineLCY."Line Discount Amount";
            "Inv. Discount Amount" :=
              Round(
                CurrExchRate.ExchangeAmtFCYToLCY(
                  ServCrMemoHeader."Posting Date", ServCrMemoHeader."Currency Code",
                  TotalServCrMemoLine."Inv. Discount Amount", ServCrMemoHeader."Currency Factor")) -
              TotalServCrMemoLineLCY."Inv. Discount Amount";
            "VAT Difference" :=
              Round(
                CurrExchRate.ExchangeAmtFCYToLCY(
                  ServCrMemoHeader."Posting Date", ServCrMemoHeader."Currency Code",
    ...
    begin
        // NAVCZ
        if ServCrMemoHeader."Prices Including VAT" or
           ("VAT Calculation Type" <> "VAT Calculation Type"::"Full VAT")
        then
            Increment(TotalServCrMemoLine."Line Amount", "Line Amount");

        Increment(TotalServCrMemoLine.Amount, Amount);
        Increment(TotalServCrMemoLine."VAT Base Amount", "VAT Base Amount");
        Increment(TotalServCrMemoLine."VAT Difference", "VAT Difference");
        Increment(TotalServCrMemoLine."VAT Difference (LCY)", "VAT Difference (LCY)");
        Increment(TotalServCrMemoLine."Amount Including VAT", "Amount Including VAT");
        Increment(TotalServCrMemoLine."Line Discount Amount", "Line Discount Amount");
