table 5993 "Service Invoice Line"
{
    ...
    var
        ...
        TotalServInvLine: Record "Service Invoice Line";
        TotalServInvLineLCY: Record "Service Invoice Line";
    ...
    begin
        // NAVCZ
        IncrAmount(TotalServInvLine, ServInvHeader);
        if ServInvHeader."Currency Code" <> '' then begin
            NoVAT := Amount = "Amount Including VAT";
            "Amount Including VAT" :=
              Round(
                CurrExchRate.ExchangeAmtFCYToLCY(
                  ServInvHeader."Posting Date", ServInvHeader."Currency Code",
                  TotalServInvLine."Amount Including VAT", ServInvHeader."Currency Factor")) -
              TotalServInvLineLCY."Amount Including VAT";
            if NoVAT then
                ...
                Amount :=
                  Round(
                    CurrExchRate.ExchangeAmtFCYToLCY(
                      ServInvHeader."Posting Date", ServInvHeader."Currency Code",
                      TotalServInvLine.Amount, ServInvHeader."Currency Factor")) -
                  TotalServInvLineLCY.Amount;
            "Line Amount" :=
              Round(
                CurrExchRate.ExchangeAmtFCYToLCY(
                  ServInvHeader."Posting Date", ServInvHeader."Currency Code",
                  TotalServInvLine."Line Amount", ServInvHeader."Currency Factor")) -
              TotalServInvLineLCY."Line Amount";
            "Line Discount Amount" :=
              Round(
                CurrExchRate.ExchangeAmtFCYToLCY(
                  ServInvHeader."Posting Date", ServInvHeader."Currency Code",
                  TotalServInvLine."Line Discount Amount", ServInvHeader."Currency Factor")) -
              TotalServInvLineLCY."Line Discount Amount";
            "Inv. Discount Amount" :=
              Round(
                CurrExchRate.ExchangeAmtFCYToLCY(
                  ServInvHeader."Posting Date", ServInvHeader."Currency Code",
                  TotalServInvLine."Inv. Discount Amount", ServInvHeader."Currency Factor")) -
              TotalServInvLineLCY."Inv. Discount Amount";
            "VAT Difference" :=
              Round(
                CurrExchRate.ExchangeAmtFCYToLCY(
                  ServInvHeader."Posting Date", ServInvHeader."Currency Code",
    ...
    begin
        // NAVCZ
        if ServInvHeader."Prices Including VAT" or
           ("VAT Calculation Type" <> "VAT Calculation Type"::"Full VAT")
        then
            Increment(TotalServInvLine."Line Amount", "Line Amount");

        Increment(TotalServInvLine.Amount, Amount);
        Increment(TotalServInvLine."VAT Base Amount", "VAT Base Amount");
        Increment(TotalServInvLine."VAT Difference", "VAT Difference");
        Increment(TotalServInvLine."VAT Difference (LCY)", "VAT Difference (LCY)");
        Increment(TotalServInvLine."Amount Including VAT", "Amount Including VAT");
        Increment(TotalServInvLine."Line Discount Amount", "Line Discount Amount");
