table 5902 "Service Line"
{
    ...
    begin
        ...
        if QtyToReserveBase <> 0 then begin
            ...
            if ReplaceServItemAction then begin
                ...
                ReservMgt.SetSerialLotNo(ReservationEntry."Serial No.", ReservationEntry."Lot No.", ReservationEntry."CD No.");
            end;
        ...
        if TempTrackingSpecification.FindFirst then begin
            ...
            with ServiceLine do begin
                CreateReservEntry.CreateReservEntryFor(DATABASE::"Service Line", "Document Type", "Document No.",
                  ...
                  TempTrackingSpecification."Serial No.", TempTrackingSpecification."Lot No.", TempTrackingSpecification."CD No.");
    ...
    begin
        ...
        VATAmountLine.UpdateLines(
          ...
          ServHeader."Tax Area Code", ServHeader."Tax Liable", ServHeader."Posting Date", false);
