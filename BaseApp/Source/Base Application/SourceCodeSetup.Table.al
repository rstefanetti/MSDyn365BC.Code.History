table 242 "Source Code Setup"
{
    ...
    fields
    {
        ...
        field(8; "Close Income Statement"; Code[10])
        {
            ...
            begin
                // NAVCZ
                if "Close Income Statement" = '' then
                    exit;
                if "Close Income Statement" = "Close Balance Sheet" then
                    FieldError(
                      ...
                      StrSubstNo(
                        ...
                        "Close Balance Sheet"));
                if "Close Income Statement" = "Open Balance Sheet" then
                    FieldError(
                      "Close Income Statement",
                      StrSubstNo(
                        Text1220000,
        ...
        field(11764; "Close Balance Sheet"; Code[10])
        {
            ...
            trigger OnValidate()
            begin
                if "Close Balance Sheet" = '' then
                    exit;
                if "Close Balance Sheet" = "Close Income Statement" then
                    FieldError(
                      "Close Balance Sheet",
                      StrSubstNo(
                        Text1220000,
                        FieldCaption("Close Income Statement"),
                        "Close Income Statement"));
                if "Close Balance Sheet" = "Open Balance Sheet" then
                    FieldError(
                      "Close Balance Sheet",
                      StrSubstNo(
                        Text1220000,
        ...
        field(11765; "Open Balance Sheet"; Code[10])
        {
            ...
            trigger OnValidate()
            begin
                if "Open Balance Sheet" = '' then
                    exit;
                if "Open Balance Sheet" = "Close Income Statement" then
                    FieldError(
                      "Open Balance Sheet",
                      StrSubstNo(
                        Text1220000,
                        FieldCaption("Close Income Statement"),
                        "Close Income Statement"));
                if "Open Balance Sheet" = "Close Balance Sheet" then
                    FieldError(
                      "Open Balance Sheet",
                      StrSubstNo(
                        Text1220000,
