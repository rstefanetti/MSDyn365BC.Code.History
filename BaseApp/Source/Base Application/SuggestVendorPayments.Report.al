report 393 "Suggest Vendor Payments"
{
    ...
    begin
        ...
        if SummarizePerVend then
            SetTempPaymentBufferSummarized(TempPayableVendorLedgerEntry, PayableVendLedgEntry);
    ...
    begin
        with TempPayableVendorLedgerEntrySum do begin
            SetRange(Priority, TempPayableVendorLedgerEntry.Priority);
            SetRange("Vendor No.", TempPayableVendorLedgerEntry."Vendor No.");
            SetRange("Currency Code", TempPayableVendorLedgerEntry."Currency Code");
            SetRange(Positive, TempPayableVendorLedgerEntry.Positive);
            SetRange(Future, TempPayableVendorLedgerEntry.Future);
        end;
    end;
