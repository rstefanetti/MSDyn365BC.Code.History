    ...
    begin
        with GenJnlLine do begin
            ...
            if EFTPayment then begin
                "EFT Payment" := true;
                "External Document No." := GetExternalDocumentNo(TempPaymentBuffer."Vendor Ledg. Entry No.");
                if Vend2.Get(TempPaymentBuffer."Vendor No.") then begin
                    "EFT Bank Account No." := Vend2."EFT Bank Account No.";
                    Validate("Customer/Vendor Bank", Vend2."EFT Bank Account No.");
                end;
            end;
