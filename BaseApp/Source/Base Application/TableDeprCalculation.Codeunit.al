codeunit 5618 "Table Depr. Calculation"
{
    ...
    begin
        ...
        if DeprType <> DeprType::Normal then
            DeprTableBufferTmp."Period Depreciation %" := 0;
    ...
    begin
        ...
        if DeprType = DeprType::Custom1 then
            DeprTableBufferTmp."Period Depreciation %" := DeprTableLine."Anticipated %";
        if DeprType = DeprType::Custom2 then
            DeprTableBufferTmp."Period Depreciation %" := DeprTableLine."Accelerated/Reduced %";
