table 5740 "Transfer Header"
{
    ...
    fields
    {
        ...
        field(5; "Transfer-from Address"; Text[100])
        {
            ...
            begin
                PostCodeCheck.ValidateAddress(
                  CurrFieldNo, DATABASE::"Transfer Header", GetPosition, 6,
        ...
        field(14; "Transfer-to Address"; Text[100])
        {
            ...
            begin
                PostCodeCheck.ValidateAddress(
                  CurrFieldNo, DATABASE::"Transfer Header", GetPosition, 7,
    ...
    begin
        ...
        PostCodeCheck.DeleteAllAddressID(DATABASE::"Transfer Header", GetPosition);
    end;
