table 5740 "Transfer Header"
{
    ...
    fields
    {
        ...
        field(5; "Transfer-from Address"; Text[100])
        {
            ...
            begin
                PostCodeMgt.FindStreetNameFromAddress(
                  "Transfer-from Address", "Transfer-from Address 2", "Transfer-from Post Code",
                  "Transfer-from City", "Trsf.-from Country/Region Code", PhoneNo, FaxNo);
            end;
        }
        ...
        field(14; "Transfer-to Address"; Text[100])
        {
            ...
            begin
                PostCodeMgt.FindStreetNameFromAddress(
                  "Transfer-to Address", "Transfer-to Address 2", "Transfer-to Post Code", "Transfer-to City",
                  "Trsf.-to Country/Region Code", PhoneNo, FaxNo);
            end;
        }
