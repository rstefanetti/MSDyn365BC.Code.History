codeunit 5705 "TransferOrder-Post Receipt"
{
    ...
    begin
        ...
        if TransHeader."Transport Reason Code" <> '' then begin
            ...
            if TransportReasonCode."Posted Rcpt. Nos." <> '' then
                TransRcptHeader."No. Series" := TransportReasonCode."Posted Rcpt. Nos.";
        end else
        ...
        TransRcptHeader."Transport Reason Code" := TransHeader."Transport Reason Code";
