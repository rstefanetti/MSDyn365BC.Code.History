table 254 "VAT Entry"
{
    ...
    keys
    {
        ...
        key(Key2; Type, Closed, "VAT Bus. Posting Group", "VAT Prod. Posting Group", "Posting Date", "EU 3-Party Trade")
        {
        ...
        key(Key5; Type, "Country/Region Code", "VAT Registration No.", "VAT Bus. Posting Group", "VAT Prod. Posting Group", "Posting Date", "EU Service", "EU 3-Party Trade")
        {
