table 254 "VAT Entry"
{
    ...
    fields
    {
        ...
        field(11626; "BAS Doc. No."; Code[11])
        {
            Caption = 'BAS Doc. No.';
            TableRelation = "BAS Calculation Sheet".A1;
        }
        field(11627; "BAS Version"; Integer)
        {
            Caption = 'BAS Version';
            TableRelation = "BAS Calculation Sheet"."BAS Version" WHERE(A1 = FIELD("BAS Doc. No."));
        }
        field(11628; "Consol. BAS Doc. No."; Code[11])
        {
            Caption = 'Consol. BAS Doc. No.';
        }
        field(11629; "Consol. Version No."; Integer)
        {
            Caption = 'Consol. Version No.';
        }
        field(28070; "Currency Code"; Code[10])
        {
        ...
        field(28077; "Settlement Adjustment"; Boolean)
        {
            Caption = 'Settlement Adjustment';
            Editable = false;
        }
        field(28078; "Sett. Payment Entry No."; Integer)
        {
            Caption = 'Sett. Payment Entry No.';
            Editable = false;
        }
    }
    ...
    keys
    {
        ...
        key(Key9; "BAS Doc. No.", "BAS Version")
        {
        }
        key(Key10; Type, Closed, "BAS Adjustment", "VAT Bus. Posting Group", "VAT Prod. Posting Group", "Posting Date", "BAS Doc. No.")
        {
            SumIndexFields = Amount, Base, "Unrealized Amount", "Unrealized Base";
        }
        key(Key11; "Document Type", Type, "Currency Code", "Posting Date", Closed)
        {
        }
        key(Key12; "Bill-to/Pay-to No.")
        {
            SumIndexFields = Amount, Base, "Unrealized Amount", "Unrealized Base";
        }
        key(Key13; "Sett. Payment Entry No.")
        {
            SumIndexFields = Amount, Base;
        }
    ...
    [Scope('OnPrem')]
    procedure GetCustUnrealizedVATPart(SettledAmount: Decimal; Paid: Decimal; Full: Decimal; TotalUnrealVATAmountFirst: Decimal; TotalUnrealVATAmountLast: Decimal; CustLedgEntry: Record "Cust. Ledger Entry"; GenJnlLine: Record "Gen. Journal Line"; WHTAmount: Decimal): Decimal
    var
        UnrealizedVATType: Option " ",Percentage,First,Last,"First (Fully Paid)","Last (Fully Paid)";
        DiscPercent: Decimal;
        WHTDiscount: Decimal;
