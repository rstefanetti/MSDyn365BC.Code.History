table 254 "VAT Entry"
{
    ...
    keys
    {
        ...
        key(Key4; Type, Closed, "Tax Jurisdiction Code", "Use Tax", "Posting Date")
        {
            SumIndexFields = Base, Amount, "Unrealized Amount", "Unrealized Base", "Remaining Unrealized Amount";
        }
        key(Key5; Type, "Country/Region Code", "VAT Registration No.", "VAT Bus. Posting Group", "VAT Prod. Posting Group", "Posting Date")
        {
        ...
        key(Key8; "Tax Jurisdiction Code", "Tax Group Used", "Tax Type", "Use Tax", "Posting Date")
        {
        }
        ...
        key(Key10; Type, "Bill-to/Pay-to No.", "Country/Region Code", "EU 3-Party Trade", "Posting Date")
        {
        }
        key(Key11; "Country/Region Code", "VAT Registration No.", "EU 3-Party Trade", Year, "Month/Quarter")
        {
        }
        key(Key12; Type, Closed, "VAT Bus. Posting Group", "VAT Prod. Posting Group", "Tax Jurisdiction Code", "Use Tax", "Posting Date")
        {
        ...
        key(Key13; "Posting Date", Type, Closed, "VAT Bus. Posting Group", "VAT Prod. Posting Group", Reversed)
        {
            SumIndexFields = Base, Amount, "Unrealized Amount", "Unrealized Base", "Additional-Currency Base", "Additional-Currency Amount", "Add.-Currency Unrealized Amt.", "Add.-Currency Unrealized Base", "Remaining Unrealized Amount";
        }
        key(Key14; "Document Date")
        {
        }
    }
