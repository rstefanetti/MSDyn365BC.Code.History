...
{
    DefaultLayout = RDLC;
    RDLCLayout = './VATEntryExceptionReport.rdlc';
    ...
    dataset
    {
        dataitem("VAT Entry"; "VAT Entry")
        {
            ...
            RequestFilterFields = "Posting Date", Type, "VAT Bus. Posting Group", "VAT Prod. Posting Group";
                ...
                if CheckVATCalculationTypes then
                    if "VAT Calculation Type".AsInteger() <> SetupVATCalculationType then begin
                        AddErrorText(
                          ...
                          Text1041002 + Format(SetupVATCalculationType));
                        PrintErrorLine := true;
                    end;
                ...
                if CheckVATRate then begin
                    ...
                    if Base <> 0 then begin
                        ...
                        then begin
                            AddErrorText(
                              ErrorText,
                              TempVATPostingSetup.FieldCaption("VAT %") + Text1041002 +
                              Format(Round(CalculatedVATRate, 0.00001)) +
                              Text1041003 + Format(TempVATPostingSetup."VAT %"));
                            PrintErrorLine := true;
                        end;
                    end else
                        if Amount <> 0 then begin
                            AddErrorText(
                              ErrorText,
                              FieldName(Base) + Text1041004 +
                              FieldName(Amount) + Text1041005);
                            PrintErrorLine := true;
                        end;
                end;
    ...
    var
        ...
        Text1041000: Label 'No checking selected.';
        Text1041001: Label 'Setup ';
        Text1041002: Label ' is ';
        Text1041003: Label ' compared to setup ';
        Text1041004: Label ' is 0 and ';
        Text1041005: Label ' is <> 0';
