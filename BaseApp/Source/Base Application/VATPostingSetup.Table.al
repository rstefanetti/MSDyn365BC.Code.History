table 325 "VAT Posting Setup"
{
    ...
    fields
    {
        ...
        field(5; "Unrealized VAT Type"; Option)
        {
            ...
            OptionCaption = ' ,Percentage,First,Last,First (Fully Paid),Last (Fully Paid),Cash Basis';
            OptionMembers = " ",Percentage,First,Last,"First (Fully Paid)","Last (Fully Paid)","Cash Basis";
