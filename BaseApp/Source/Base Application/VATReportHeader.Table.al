table 740 "VAT Report Header"
{
    ...
    fields
    {
        ...
        field(11601; "BAS Version No."; Integer)
        {
            Caption = 'BAS Version No.';
            TableRelation = "BAS Calculation Sheet"."BAS Version";
    ...
    begin
        ...
        case "VAT Report Config. Code" of
            ...
            "VAT Report Config. Code"::"BAS Report":
                begin
                    VATReportSetup.TestField("BAS Report No. Series");
    ...
    begin
        case "VAT Report Config. Code" of
            "VAT Report Config. Code"::"EC Sales List",
            "VAT Report Config. Code"::"VAT Return",
            "VAT Report Config. Code"::"BAS Report":
                begin
