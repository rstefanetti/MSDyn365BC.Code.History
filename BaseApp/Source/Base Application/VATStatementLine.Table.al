table 256 "VAT Statement Line"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Type';
            OptionCaption = 'Account Totaling,VAT Entry Totaling,Row Totaling,Description,EC Entry Totaling';
            OptionMembers = "Account Totaling","VAT Entry Totaling","Row Totaling",Description,"EC Entry Totaling";
        ...
        {
            Caption = 'Amount Type';
            OptionCaption = ' ,Amount,Base,Unrealized Amount,Unrealized Base,Amount+Base';
            OptionMembers = " ",Amount,Base,"Unrealized Amount","Unrealized Base","Amount+Base";
        }
