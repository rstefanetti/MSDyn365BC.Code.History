table 256 "VAT Statement Line"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Type';
            OptionCaption = 'Account Totaling,VAT Entry Totaling,Row Totaling,Description,,,,,,,,Periodic VAT Settl.';
            OptionMembers = "Account Totaling","VAT Entry Totaling","Row Totaling",Description,,,,,,,,"Periodic VAT Settl.";
