codeunit 227 "VendEntry-Apply Posted Entries"
{
    ...
    begin
        ...
        with DtldVendLedgEntry do begin
            // NAVCZ
            if "Applied Vend. Ledger Entry No." <> "Vendor Ledger Entry No." then
                Get(FindLastApplEntry("Applied Vend. Ledger Entry No."));
            // NAVCZ
        ...
        if DtldVendLedgEntry.Find('-') then
            repeat
                ...
                if DtldVendLedgEntry."Transaction No." <> 0 then begin
                    ...
                    if not VendLedgEntry2.Prepayment and
                       (VendLedgEntry2."Prepayment Type" = VendLedgEntry2."Prepayment Type"::Advance)
                    then
                        VendLedgEntry2.FieldError("Prepayment Type");
    ...
    begin
        ...
        // NAVCZ
        ApplyingVendLedgEntry."Amount to Apply" := ApplyingVendLedgEntry."Amount to Apply" + LinkedNotUsedAmt;
        // NAVCZ
