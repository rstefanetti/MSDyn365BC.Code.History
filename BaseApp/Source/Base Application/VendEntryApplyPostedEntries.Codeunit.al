codeunit 227 "VendEntry-Apply Posted Entries"
{
    ...
    var
        ...
        Text12100: Label 'You cannot unapply %1 No. %2 because the VAT settlement has been calculated and posted.';
    ...
    begin
        ...
        if DtldVendLedgEntry.Find('-') then
            repeat
                if CheckVATSettlement(DtldVendLedgEntry."Vendor Ledger Entry No.", DtldVendLedgEntry."Posting Date") then
                    Error(Text12100, VendLedgEntry."Document Type", VendLedgEntry."Document No.");
    ...
    begin
        VendLedgEntry.Get(VendLedgEntryNo);
        VATEntry.Reset();
        VATEntry.SetRange("Document Type", VendLedgEntry."Document Type");
