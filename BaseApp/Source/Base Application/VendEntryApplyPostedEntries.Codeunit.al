codeunit 227 "VendEntry-Apply Posted Entries"
{
    ...
    var
        ...
        Text11302: Label 'When using workdate for applying/unapplying, the workdate must not be before the latest posting date %1 on the entries to apply.';
        GLSetup: Record "General Ledger Setup";
    ...
    procedure Apply(VendLedgEntry: Record "Vendor Ledger Entry"; DocumentNo: Code[20]; ApplicationDate: Date; JnlTemplateName: Code[10]; JnlBatchName: Code[10]): Boolean
    var
    ...
    begin
        ...
        with VendLedgEntry do begin
            ...
            VendPostApplyVendLedgEntry(VendLedgEntry, DocumentNo, ApplicationDate, JnlTemplateName, JnlBatchName);
            exit(true);
        end;
    end;
    ...
    local procedure VendPostApplyVendLedgEntry(VendLedgEntry: Record "Vendor Ledger Entry"; DocumentNo: Code[20]; ApplicationDate: Date; JnlTemplateName: Code[10]; JnlBatchName: Code[10])
    var
    ...
    procedure PreviewApply(VendorLedgerEntry: Record "Vendor Ledger Entry"; DocumentNo: Code[20]; ApplicationDate: Date; JournalTemplateName: Code[10]; JournalBatchName: Code[10])
    var
        GenJnlPostPreview: Codeunit "Gen. Jnl.-Post Preview";
    ...
    begin
        ...
        VendEntryApplyPostedEntries.SetApplyContext(ApplicationDate, DocumentNo, JournalTemplateName, JournalBatchName);
