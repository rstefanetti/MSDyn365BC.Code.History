    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the calculated total of WHT Amount for this vendor for a particular transaction.';
                }
                field("WHT Amount (LCY)"; "WHT Amount (LCY)")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the calculated total of WHT Amount (LCY) for this vendor for a particular transaction.';
                }
