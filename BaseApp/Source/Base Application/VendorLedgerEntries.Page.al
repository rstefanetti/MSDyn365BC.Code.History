page 29 "Vendor Ledger Entries"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    Editable = false;
                    ToolTip = 'Specifies the vendor VAT invoice number associated with the vendor ledger entry.';
                    Visible = false;
                }
                field("Vendor VAT Invoice Date"; "Vendor VAT Invoice Date")
                {
                    Editable = false;
                    ToolTip = 'Specifies the vendor VAT invoice date associated with the vendor ledger entry.';
                    Visible = false;
                }
                field("Vendor VAT Invoice Rcvd Date"; "Vendor VAT Invoice Rcvd Date")
                {
                    Editable = false;
                    ToolTip = 'Specifies the vendor VAT invoice received date associated with the vendor ledger entry.';
                    Visible = false;
                }
                field("Agreement No."; "Agreement No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the agreement number associated with the vendor ledger entry.';
                }
    ...
    actions
    {
        area(navigation)
        {
            group("Ent&ry")
            {
                ...
                action("Posted Prepayment Invoice")
                {
                    ApplicationArea = Prepayments;
                    Caption = 'Posted Prepayment Invoice';
    ...
    [Scope('OnPrem')]
    procedure ChangeVendVATInvoice()
    var
        VendLedgEntry: Record "Vendor Ledger Entry";
