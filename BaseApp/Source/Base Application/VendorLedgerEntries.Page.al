    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the Kunde ID (KID) associated with the vendor ledger entry.';
                }
                ...
                field("Remittance ID"; "Remittance ID")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies a unique ID for the remittance.';
                }
