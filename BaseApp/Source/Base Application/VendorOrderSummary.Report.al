report 307 "Vendor - Order Summary"
{
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            {
                DataItemLink = "Pay-to Vendor No." = FIELD("No."), "Shortcut Dimension 1 Code" = FIELD("Global Dimension 1 Filter"), "Shortcut Dimension 2 Code" = FIELD("Global Dimension 2 Filter"), "Currency Code" = FIELD("Currency Filter"), "Agreement No." = FIELD("Agreement Filter");
