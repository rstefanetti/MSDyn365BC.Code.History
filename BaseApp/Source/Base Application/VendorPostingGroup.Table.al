table 93 "Vendor Posting Group"
{
    ...
    fields
    {
        ...
        field(12400; "Prepayment Account"; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                GLAccountCategoryMgt.CheckGLAccount("Prepayment Account", false, false, 0, '');
            end;
        }
        field(12401; "KPP Code Mandatory"; Boolean)
        {
            Caption = 'KPP Code Mandatory';
        }
        field(12402; "Skip Posting"; Boolean)
        {
            Caption = 'Skip Posting';
        }
        field(12403; "VAT Invoice Mandatory"; Boolean)
        {
            Caption = 'VAT Invoice Mandatory';
        }
    }
    ...
    [Scope('OnPrem')]
    procedure GetPrepaymentAccount(Prepayment: Boolean): Code[20]
    begin
