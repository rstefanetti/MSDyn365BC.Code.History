...
{
    DefaultLayout = RDLC;
    RDLCLayout = './WHTCertificate.rdlc';
    ...
    dataset
    {
        dataitem("WHT Entry"; "WHT Entry")
        {
            ...
            column(WHT_Entry__WHT_Entry___WHT_Report_Line_No_; "WHT Report Line No")
            {
            }
    ...
    var
        ...
        Text1500001: Label 'Please enter Bill-to/Pay-to Vendor No. and Original Document No. ';
