codeunit 7302 "WMS Management"
{
    ...
    begin
        ...
        with WhseJnlLine do begin
            ...
            if ItemTrackingCode.Get(Item."Item Tracking Code") then begin
                ...
                if ("CD No." <> '') and
                   ("From Bin Code" <> '') and
                   ItemTrackingCode."CD Specific Tracking" and
                   ("From Bin Code" <> Location."Adjustment Bin Code") and
                   (((Location."Adjustment Bin Code" <> '') and
                     ("Entry Type" = "Entry Type"::Movement)) or
                    (("Entry Type" <> "Entry Type"::Movement) or
                ...
                then
                    CheckCDNo(
                      "Item No.", "Variant Code", "Location Code", "From Bin Code",
                      "Unit of Measure Code", "CD No.", CalcReservEntryQuantity(WhseJnlLine));
            end;
            ...
            then begin
                ...
                if IsReclass then
                    if ("New Lot No." <> "Lot No.") and
                       ...
                       ("New CD No." <> "CD No.") and
                       (("CD No." <> xTrackingSpecification."CD No.") or
                        ("New CD No." <> xTrackingSpecification."New CD No.")) or
            ...
            if FindSet then
                repeat
                    if not TempWhseActivLine.Get("Activity Type", "No.", "Line No.") then begin
                        ...
                        WhseActivLine3.SetTrackingFilter("Serial No.", "Lot No.", "CD No.");
    ...
    begin
        ItemTrackingMgt.CheckWhseItemTrkgSetup(
          ItemJnlLine."Item No.", ItemJnlLine."Location Code", WhseSNRequired, WhseLNRequired, WhseCDRequired, false);
    ...
    begin
        with WhseJnlLine do begin
            ...
            ReservEntry.SetTrackingFilter("Serial No.", "Lot No.", "CD No.");
