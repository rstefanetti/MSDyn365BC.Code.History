    ...
    layout
    {
        area(content)
        {
            repeater(Control1210000)
            {
                ...
                field("OKEI Scaling"; "OKEI Scaling")
                {
                ...
                field("Column Link No."; "Column Link No.")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Excel Mapping Type"; "Excel Mapping Type")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Template Data"; "Template Data")
                {
                    ApplicationArea = Basic, Suite;
                }
            }
