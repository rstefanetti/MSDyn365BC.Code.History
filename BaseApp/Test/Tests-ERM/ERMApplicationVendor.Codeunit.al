codeunit 134011 "ERM Application Vendor"
{
    ...
    begin
        ...
        asserterror VendEntryApplyPostedEntries.Apply(
            VendLedgerEntry, DocNo, WorkDate, DummyGenJournalLine."Journal Template Name", DummyGenJournalLine."Journal Batch Name");
