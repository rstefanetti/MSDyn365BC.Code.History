codeunit 134001 "ERM Apply Purchase/Payables"
{
    ...
    begin
        ...
        asserterror VendorLedgerEntry2.TestField("Remaining Amount", 0);
        ...
        // [THEN] Second payment line in "FCY1" is not applied to second invoice in "FCY2"
        asserterror VerifyPaymentWithDetailedEntries(
