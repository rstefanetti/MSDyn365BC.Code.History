codeunit 134387 "ERM Sales Documents III"
{
    ...
    var
        ...
        WrongErrorReturnedErr: Label 'Wrong error returned: %1.';
    ...
    begin
        ...
        LibrarySales.CreateSalesHeader(SalesHeader, SalesHeader."Document Type"::Order, LibrarySales.CreateCustomerNo());
        LibrarySales.CreateSalesLine(SalesLine, SalesHeader, SalesLine.Type::Item, LibraryInventory.CreateItemNo(), 1);
        LibrarySales.CreateSalesCommentLine(SalesCommentLine, SalesHeader."Document Type"::Order, SalesHeader."No.", SalesLine."Line No.");
