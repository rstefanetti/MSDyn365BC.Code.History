codeunit 134016 "ERM Vendor Pmt Tol With Wrning"
{
    ...
    begin
        ...
        CreateGenJournalLinesDifferentAmount(GenJournalLine, GenJournalLine."Document Type"::"Credit Memo", VendorNo, CrMemoAmounts);
        LibraryERM.PostGeneralJnlLine(GenJournalLine);
        ...
        UpdateMaxPaymentToleranceOnVendorLedgerEntry(VendorNo, GenJournalLine."Document Type"::"Credit Memo", MaxTolAmounts);
        ...
        CreateDocumentLine(
            GenJournalLine, GenJournalLine."Document Type"::Refund, VendorNo, -TotalCrMemoAmount + TotalTolAmount / 2,
        ...
        ExpectedPmtTolAmounts.Add(0);
        VerifyPmtToleranceOnClosedVendorLedgerEntry(VendorNo, GenJournalLine."Document Type"::"Credit Memo", ExpectedPmtTolAmounts);
    end;
    ...
    begin
        ...
        FillListWithDecimalValues(
            ...
            -LibraryRandom.RandDecInRange(100, 200, 2), -LibraryRandom.RandDecInRange(100, 200, 2));
        CreateGenJournalLinesDifferentAmount(GenJournalLine, GenJournalLine."Document Type"::Invoice, VendorNo, InvAmounts);
        LibraryERM.PostGeneralJnlLine(GenJournalLine);
        ...
        FillListWithDecimalValues(
            MaxTolAmounts, TotalTolAmount, -LibraryRandom.RandDecInRange(5, 10, 2), -LibraryRandom.RandDecInRange(5, 10, 2), 0, 0);
        UpdateMaxPaymentToleranceOnVendorLedgerEntry(VendorNo, GenJournalLine."Document Type"::Invoice, MaxTolAmounts);
        ...
        CreateDocumentLine(
            GenJournalLine, GenJournalLine."Document Type"::Payment, VendorNo, -TotalInvAmount + TotalTolAmount / 2,
            '', LibraryRandom.RandDateFromInRange(GenJournalLine."Due Date", 10, 20));
        ...
        ExpectedPmtTolAmounts.Add(0);
        ExpectedPmtTolAmounts.Add(0);
        VerifyPmtToleranceOnClosedVendorLedgerEntry(VendorNo, GenJournalLine."Document Type"::Invoice, ExpectedPmtTolAmounts);
    end;
    ...
    local procedure CreateGenJournalLinesDifferentAmount(var GenJournalLine: Record "Gen. Journal Line"; DocumentType: Option; VendorNo: Code[20]; Amounts: List of [Decimal])
    var
        GenJournalBatch: Record "Gen. Journal Batch";
    ...
    begin
        ...
        for i := 1 to Amounts.Count() do
            LibraryJournals.CreateGenJournalLine(
                ...
                GenJournalLine."Account Type"::Vendor, VendorNo, GenJournalLine."Account Type"::"G/L Account", BalGLAccountNo, Amounts.Get(i));
    end;
    ...
    local procedure UpdateMaxPaymentToleranceOnVendorLedgerEntry(VendorNo: Code[20]; DocumentType: Option; MaxPmtTolAmounts: List of [Decimal])
    var
        VendorLedgerEntry: Record "Vendor Ledger Entry";
    ...
    local procedure VerifyPmtToleranceOnClosedVendorLedgerEntry(VendorNo: Code[20]; DocumentType: Option; ExpectedPmtTolerances: List of [Decimal])
    var
        VendorLedgerEntry: Record "Vendor Ledger Entry";
