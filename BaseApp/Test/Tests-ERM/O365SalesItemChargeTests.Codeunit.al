codeunit 135301 "O365 Sales Item Charge Tests"
{
    ...
    begin
        ...
        SalesHeaderInvoice.Validate("VAT Bus. Posting Group", '');
        SalesHeaderInvoice.Modify();

        LibrarySales.CreateSalesLine(
          SalesLineInvoice, SalesHeaderInvoice, SalesLineInvoice.Type::"Charge (Item)", LibraryInventory.CreateItemChargeNoWithoutVAT(), 1);
