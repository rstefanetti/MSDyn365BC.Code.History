codeunit 139155 "PEPPOL Management Tests"
{
    ...
    begin
        ...
        Assert.AreEqual(DocumentTools.GetEInvoicePEPPOLPaymentID(DummySalesHeader), PaymentID, '');
    ...
    begin
        ...
        Assert.AreEqual('UNCL5305', TaxCategorySchemeID, '');
    ...
    begin
        ...
        Assert.AreEqual(GeneralLedgerSetup."LCY Code", TaxCurrencyID, '');
        Assert.AreEqual(GeneralLedgerSetup."LCY Code", TaxTotalCurrencyID, '');
    end;
    ...
    begin
        ...
        Assert.AreEqual('UNCL5305', schemeID, '');
    ...
    begin
        ...
        Assert.AreEqual('UNCL5305', ItemSchemeID, '');
