codeunit 136145 "Service Contracts II"
{
    ...
    local procedure CreateServiceContractWithLine(var ServiceContractHeader: Record "Service Contract Header"; var ServiceContractLine: Record "Service Contract Line"; StartingDate: Date; ExpirationDate: Date; InvoicePeriod: Option; IsPrepaid: Boolean)
    var
