codeunit 134450 "ERM Fixed Assets Journal"
{
    ...
    [Test]
    [HandlerFunctions('AcquireFANotificationHandler,RecallNotificationHandler,FixedAssetGLJournalPageHandler')]
    [Scope('OnPrem')]
    ...
    begin
        ...
        // [WHEN] Run Fixed Asset Acquire wizard for Vendor
        RunFAAcquire(FixedAsset."No.", Vendor."No.", CurrencyExchangeRate."Currency Code", true);
    ...
    begin
        RunFAAcquire(FANo, BalAccountNo, '', false);
    end;

    local procedure RunFAAcquire(FANo: Code[20]; BalAccountNo: Code[20]; CurrencyCode: Code[20]; OpenFAGLJournal: Boolean)
    var
        TempGenJournalLine: Record "Gen. Journal Line" temporary;
        FixedAssetAcquisitionWizard: TestPage "Fixed Asset Acquisition Wizard";
    begin
