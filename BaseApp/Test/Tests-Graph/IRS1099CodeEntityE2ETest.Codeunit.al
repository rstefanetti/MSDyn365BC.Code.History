codeunit 135519 "IRS 1099 Code Entity E2E Test"
{
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL(IRS1099FormBox.Id, PAGE::"IRS 1099 Form-Box Entity", ServiceNameTxt);
    ...
    begin
        ...
        if IRS1099FormBox.Description = '' then
            IRS1099FormBox.Description := LibraryUtility.GenerateGUID;
        if IsNullGuid(Format(IRS1099FormBox.Id)) then
