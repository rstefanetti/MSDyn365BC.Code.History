codeunit 147310 "ERM Apply Unapply"
{
    ...
    begin
        ...
        VerifyPaymentGLEntryCount(
          GenJournalLine."Document No.", GetCustomerBillsAccount(CustomerNo), 2);
    end;
    ...
    begin
        ...
        // [THEN] Payment G/L Entry for rounding is posted to Bills Account
        VerifyPaymentGLEntryCount(
          GenJournalLine."Document No.", GetVendorBillsAccount(VendorNo), 2);
    end;
    ...
    local procedure UnapplySalesViaPage(CustomerNo: Code[20]; DocumentType: Option; DocumentNo: Code[20])
    var
        CustLedgerEntry: Record "Cust. Ledger Entry";
    ...
    local procedure UnapplyPurchaseViaPage(VendorNo: Code[20]; DocumentType: Option; DocumentNo: Code[20])
    var
        VendorLedgerEntry: Record "Vendor Ledger Entry";
