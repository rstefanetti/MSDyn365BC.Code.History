codeunit 144056 "ERM FA Professional Tax"
{
    ...
    begin
        ...
        VerifyProfessionalTaxFieldOnFACard(FADepreciationBook."FA No.", ProfessionalTax, FixedAsset.FieldCaption("Professional Tax"));
    end;
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure FixedAssetProfessionalTaxRequestPageHandler(var FixedAssetProfessionalTax: TestRequestPage "Fixed Asset-Professional Tax")
    var
