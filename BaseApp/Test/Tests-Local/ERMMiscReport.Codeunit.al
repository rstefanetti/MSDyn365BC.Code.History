codeunit 142060 "ERM Misc. Report"
{
    ...
    var
        CompanyInformation: Record "Company Information";
    begin
        // Verify Purchase Order Report (1322) with Print Company and without Log Interaction option.
        CompanyInformation.Get();
    ...
    var
        CompanyInformation: Record "Company Information";
    begin
        // Verify Purchase Order Report (1322) without Print Company and with Log Interaction option.
    ...
    var
        CompanyInformation: Record "Company Information";
    begin
        // Verify Purchase Order Report (1322) with Print Company and Log Interaction option.
        CompanyInformation.Get();
    ...
    local procedure VerifyPurchaseDocument(Item: Record Item; DocumentNo: Text[20]; CompanyName: Text[100]; BuyfromVendorName: Text[100]; NoPurchHeader: Text[50]; DescriptionPurchInvLine: Text[50]; UnitofMeasurePurchInvLine: Text[50]; ItemNoCapLbl: Text[50]; CompNameCaption: Text[50]; VendNameCaption: Text[50])
    var
