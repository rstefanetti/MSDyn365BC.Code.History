codeunit 142053 "ERM Sales/Purchase Document"
{
    ...
    [Test]
    [Scope('OnPrem')]
    procedure ImportElectronicInvoiceOnPurchaseOrderApplicationArea()
    var
        PurchaseOrderPage: TestPage "Purchase Order";
    begin
        // [FEATURE] [Purchases] [Order] [UI]
        // [SCENARIO 338888] "Import Electronic Invoice" action is enabled on Purchase Order page in SaaS
        Initialize;
        ...
        PurchaseOrderPage.OpenNew();

        // [THEN] "Import Electronic Invoice" is enabled
        Assert.IsTrue(PurchaseOrderPage."Import Electronic Invoice".Enabled(), '');
    ...
    begin
        ...
        VerifyTaxAmountOnICOutboxJnlLine(PurchaseLine."IC Partner Code", PurchInvHeader."Amount Including VAT");
    end;
