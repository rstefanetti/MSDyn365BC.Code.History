codeunit 147330 "Edit Posted Documents ES"
{
    ...
    begin
        ...
        // [GIVEN] Opened "Posted Sales Cr. Memo - Update" page. A user with "D365 Sales Doc, Post" permission set.
        // [GIVEN] New values are set for editable fields.
        EnqueValuesForEditableFieldsPostedSalesCreditMemo(SalesCrMemoHeader);
        PostedDocNo := CreateAndPostSalesCreditMemo();
        LibraryLowerPermissions.SetSalesDocsPost();
    ...
    [ModalPageHandler]
    [Scope('OnPrem')]
    procedure PostedSalesCrMemoUpdateInvDetailsOKModalPageHandler(var PostedSalesCrMemoUpdate: TestPage "Posted Sales Cr. Memo - Update")
    begin
    ...
    [ModalPageHandler]
    [Scope('OnPrem')]
    procedure PostedSalesCrMemoUpdateInvDetailsCancelModalPageHandler(var PostedSalesCrMemoUpdate: TestPage "Posted Sales Cr. Memo - Update")
    begin
        PostedSalesCrMemoUpdate."Special Scheme Code".SetValue(LibraryVariableStorage.DequeueText());
        PostedSalesCrMemoUpdate."Cr. Memo Type".SetValue(LibraryVariableStorage.DequeueText());
        PostedSalesCrMemoUpdate."Correction Type".SetValue(LibraryVariableStorage.DequeueText());
    ...
    [ModalPageHandler]
    [Scope('OnPrem')]
    procedure PostedSalesCrMemoUpdateOperationDescrOKModalPageHandler(var PostedSalesCrMemoUpdate: TestPage "Posted Sales Cr. Memo - Update")
    begin
        PostedSalesCrMemoUpdate.OperationDescription.SetValue(LibraryVariableStorage.DequeueText());
        PostedSalesCrMemoUpdate.OK().Invoke();
    end;

    [ModalPageHandler]
    [Scope('OnPrem')]
    procedure PostedSalesCrMemoUpdateOperationDescrCancelModalPageHandler(var PostedSalesCrMemoUpdate: TestPage "Posted Sales Cr. Memo - Update")
    begin
        PostedSalesCrMemoUpdate.OperationDescription.SetValue(LibraryVariableStorage.DequeueText());
        PostedSalesCrMemoUpdate.Cancel().Invoke();
    end;
