codeunit 144000 "Non-Deductible VAT"
{
    ...
    local procedure CreateVATPostingSetupWithBusPostGroup(var VATPostingSetup: Record "VAT Posting Setup"; VATCalculationType: Option; VATBusinessPostingGroupCode: Code[20]; VATPercent: Decimal; VATIdentifier: Code[20])
    var
