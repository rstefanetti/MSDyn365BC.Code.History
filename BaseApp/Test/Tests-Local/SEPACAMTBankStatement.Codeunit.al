codeunit 144060 "SEPA CAMT Bank Statement"
{
    ...
    local procedure MockCBGStatementLineAddInfo(CBGStatementLine: Record "CBG Statement Line"; InformationType: Option)
    var
        CBGStatementLineAddInfo: Record "CBG Statement Line Add. Info.";
        RecRef: RecordRef;
    begin
    ...
    local procedure VerifyCBGStatementAddInfoEntry(AccountNo: Code[20]; InformationType: Option; FirstExpectedEntry: Text; SecondExpectedEntry: Text)
    var
        CBGStatement: Record "CBG Statement";
        CBGStatementLineAddInfo: Record "CBG Statement Line Add. Info.";
    begin
    ...
    local procedure VerifyCBGStatementAddInfoEntryNotExists(AccountNo: Code[20]; InformationType: Option; FirstExpectedEntry: Text)
    var
        CBGStatement: Record "CBG Statement";
        CBGStatementLineAddInfo: Record "CBG Statement Line Add. Info.";
    begin
