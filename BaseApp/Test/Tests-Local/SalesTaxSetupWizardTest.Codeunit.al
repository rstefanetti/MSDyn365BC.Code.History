codeunit 140552 "Sales Tax Setup Wizard Test"
{
    ...
    begin
        ...
        Assert.IsFalse(AssistedSetup.IsComplete(BaseAppID.Get(), PAGE::"Sales Tax Setup Wizard"), 'Assisted setup status should not be completed.');
    end;
    ...
    begin
        ...
        Assert.IsTrue(AssistedSetup.IsComplete(BaseAppID.Get(), PAGE::"Sales Tax Setup Wizard"), 'Assisted setup status should be completed.');
    end;
