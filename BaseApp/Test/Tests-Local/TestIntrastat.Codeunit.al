codeunit 134153 "Test Intrastat"
{
    ...
    begin
        ...
        LibraryReportDataset.MoveToRow(LibraryReportDataset.FindRow('TariffNo_IntrastatJnlLine', Item."Tariff No.") + 1);
        LibraryReportDataset.AssertCurrentRowValueEquals('TransType_IntrastatJnlLine', IntrastatJnlLine."Transaction Type");
        LibraryReportDataset.AssertCurrentRowValueEquals('TrnsprtMethod_IntrastatJnlLine', IntrastatJnlLine."Transport Method");
    end;
