codeunit 134153 "Test Intrastat"
{
    ...
    begin
        ...
        DACHReportSelections.Validate("Report ID", REPORT::"Intrastat - Make Disk Tax Auth");
        DACHReportSelections.Insert(true);

        DACHReportSelections.Init();
        DACHReportSelections.Validate(Usage, DACHReportSelections.Usage::"Intrastat Form");
        DACHReportSelections.Validate("Report ID", REPORT::"Intrastat - Form");
        DACHReportSelections.Insert(true);
    end;
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure IntratstatJnlFormReqPageHandler(var IntrastatForm: TestRequestPage "Intrastat - Form")
    var
        Type: Variant;
    begin
