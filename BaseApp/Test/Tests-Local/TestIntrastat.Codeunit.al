codeunit 134153 "Test Intrastat"
{
    ...
    var
        ...
        TransactionTypeMustHaveValueErr: Label '%1 must have a value in %2';
    ...
    begin
        ...
        // Verify
        Assert.ExpectedError(
          StrSubstNo(TransactionTypeMustHaveValueErr, IntrastatJnlLine.FieldCaption("Transaction Type"), IntrastatJnlLine.TableCaption));
    end;
