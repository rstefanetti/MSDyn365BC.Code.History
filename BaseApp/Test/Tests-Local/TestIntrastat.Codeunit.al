codeunit 134153 "Test Intrastat"
{
    ...
    local procedure SetTariffNoOnExistingItems()
    var
        Item: Record Item;
    begin
        Item.SetFilter("Tariff No.", '%1', '');
        Item.ModifyAll("Tariff No.", LibraryUtility.CreateCodeRecord(DATABASE::"Tariff Number"));
    end;
