codeunit 141008 "UT PAG Bank Deposit"
{
    ...
    begin
        ...
        Deposit.OpenNew();
        Deposit."No.".SetValue(DepositNo);
        Deposit.Subform."Account Type".SetValue(GenJournalLine."Account Type"::"G/L Account");
        Deposit.Subform."Account No.".SetValue(GLAccountNo);
        Deposit.Close();

        DepositHeader.Get(DepositNo);
        DepositHeader.TestField("Journal Template Name", GenJournalBatch."Journal Template Name");
        DepositHeader.TestField("Journal Batch Name", GenJournalBatch.Name);
        ...
        Deposit.Subform."Account Type".AssertEquals(GenJournalLine."Account Type");
        Deposit.Subform."Account No.".AssertEquals(GenJournalLine."Account No.");
        Deposit.Close();
    end;
