codeunit 142068 "UT REP LOWVAL"
{
    ...
    var
        ...
        GLRegWarningMsg: Label 'This function only regulated customer, vendor and bank accounts and additional currency. If you use foreign currencies in G/L, you have to run the report "Adjust Exchange Rates G/L".';
    ...
    [Test]
    [HandlerFunctions('AdjustExchangeRatesValuationMethodRequestPageHandler,MessageHandler')]
    [TransactionModel(TransactionModel::AutoRollback)]
    [Scope('OnPrem')]
    ...
    [Test]
    [HandlerFunctions('AdjustExchangeRatesValPerEndRequestPageHandler,MessageHandler')]
    [TransactionModel(TransactionModel::AutoRollback)]
    [Scope('OnPrem')]
    ...
    [Test]
    [HandlerFunctions('AdjustExchangeRatesCurrencyRequestPageHandler,ConfirmHandlerTRUE,MessageHandler')]
    [TransactionModel(TransactionModel::AutoRollback)]
    [Scope('OnPrem')]
    ...
    [Test]
    [HandlerFunctions('AdjustExchangeRatesBankAccounts,ConfirmHandlerTRUE,MessageHandler')]
    [Scope('OnPrem')]
    ...
    begin
        ...
        LibraryVariableStorage.Enqueue(GLRegWarningMsg);
        REPORT.Run(REPORT::"Adjust Exchange Rates");
    end;
