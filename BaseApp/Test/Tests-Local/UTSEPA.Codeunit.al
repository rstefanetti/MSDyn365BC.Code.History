codeunit 144058 "UT SEPA"
{
    ...
    var
        ...
        IBANTxt: Label 'FR14 2004 1010 0505 0001 3M02 606';
    ...
    begin
        ...
        Assert.ExpectedErrorCode(TestFieldCap);
    end;
    ...
    var
        PaymentHeader: Record "Payment Header";
        VendorBankAccount: Record "Vendor Bank Account";
        PaymentLinesList: TestPage "Payment Lines List";
        No: Code[20];
    begin
    ...
    var
        ...
        PaymentHeaderArchive2: Record "Payment Header Archive";
    begin
    ...
    var
        ...
        PaymentLineArchive2: Record "Payment Line Archive";
    begin
    ...
    [RequestPageHandler]
    [Scope('OnPrem')]
    procedure SEPAISO20022RequestPageHandler(var SEPAISO20022: TestRequestPage "SEPA ISO20022")
    var
        No: Variant;
    begin
