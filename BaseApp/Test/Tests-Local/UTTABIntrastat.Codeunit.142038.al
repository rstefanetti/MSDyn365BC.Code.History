codeunit 142038 "UT TAB Intrastat"
{
    ...
    var
        ...
        IntrastatJnlLine: Record "Intrastat Jnl. Line";
    begin
        // Purpose of the test is to validate, Country Region of Origin Code - OnValidate of Intrastat Journal Line.

        // Setup: Create Item with Tariff Number. Create Intrastat Journal Line of Type Shipment.
        CreateItemWithTariffNumber(Item);
        CreateIntrastatJournalLine(IntrastatJnlLine, Item."No.", IntrastatJnlLine.Type::Shipment);

        // Exercise: Update Country Region of Origin Code on Intrastat Journal Line.
        asserterror IntrastatJnlLine.Validate("Country/Region of Origin Code");

        // Verify: Verify the Type Error validate the Country Region of Origin Code.
