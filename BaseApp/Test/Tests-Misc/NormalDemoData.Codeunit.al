codeunit 138200 "Normal DemoData"
{
    ...
    local procedure AssertVATStatementLineExists(RowNo: Code[10]; LineType: Enum "VAT Statement Line Type"; VATProdPostingGroupCode: Code[20]; AmountType: Option; RowTotaling: Text[50])
    var
        VATStatementLine: Record "VAT Statement Line";
    begin
