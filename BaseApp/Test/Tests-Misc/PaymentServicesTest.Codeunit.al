codeunit 134425 "Payment Services Test"
{
    ...
    [Test]
    [HandlerFunctions('SalesInvoiceReportRequestPageHandler')]
    [Scope('OnPrem')]
    ...
    begin
        ...
        VerifyTargetURLIsCorrect(SalesInvoiceHeader, TempPaymentReportingArgument);
    ...
    [HandlerFunctions('SalesInvoiceReportRequestPageHandler')]
    [Scope('OnPrem')]
    procedure TestSalesInvoiceReportDifferentCurrency()
    var
        TempPaymentServiceSetup: Record "Payment Service Setup" temporary;
        PaymentMethod: Record "Payment Method";
        SalesHeader: Record "Sales Header";
    ...
    begin
        ...
        CreatePaymentMethod(PaymentMethod, false);
        CreateSalesInvoice(SalesHeader, PaymentMethod, LibraryERM.CreateCurrencyWithRandomExchRates);
    ...
    begin
        ...
        CreatePaymentMethod(PaymentMethod, false);
        CreateAndPostSalesInvoice(SalesInvoiceHeader, PaymentMethod);
        CreateAndPostSalesInvoice(SalesInvoiceHeader2, PaymentMethod);

        TempPaymentServiceSetup.CreateReportingArgs(TempPaymentReportingArgument, SalesInvoiceHeader);
        VerifyTargetURLIsCorrect(SalesInvoiceHeader, TempPaymentReportingArgument);

        TempPaymentServiceSetup.CreateReportingArgs(TempPaymentReportingArgument2, SalesInvoiceHeader2);
        VerifyTargetURLIsCorrect(SalesInvoiceHeader2, TempPaymentReportingArgument2);
    ...
    [HandlerFunctions('SalesInvoiceReportRequestPageHandler')]
    [Scope('OnPrem')]
    procedure TestSalesInvoiceReportMultipleInvoicesMultiplePaymentServices()
    var
        TempTemplatePaymentServiceSetup: Record "Payment Service Setup" temporary;
        TempPaymentServiceSetup: Record "Payment Service Setup" temporary;
        PaymentMethod: Record "Payment Method";
    ...
    begin
        ...
        TempPaymentServiceSetup.CreateReportingArgs(TempPaymentReportingArgument, SalesInvoiceHeader);
        TempPaymentServiceSetup.CreateReportingArgs(TempPaymentReportingArgument2, SalesInvoiceHeader2);
        Assert.AreEqual(TempPaymentReportingArgument.Count, 2 * NumberOfServices, 'Wrong number of reporting arguments was generated');
        Assert.AreEqual(TempPaymentReportingArgument2.Count, 2 * NumberOfServices, 'Wrong number of reporting arguments was generated');
        ...
        TempPaymentReportingArgument2.Find('-');
        repeat
            VerifyTargetURLIsCorrect(SalesInvoiceHeader2, TempPaymentReportingArgument2);
            VerifyPaymentServiceIsInReportDataset(TempPaymentReportingArgument2);
        until TempPaymentReportingArgument2.Next = 0;
    end;

    [Test]
    [HandlerFunctions('SalesInvoiceReportRequestPageHandler')]
    [Scope('OnPrem')]
    procedure TestPrintingReportWithoutPaymentServices()
    var
        TempPaymentServiceSetup: Record "Payment Service Setup" temporary;
        PaymentMethod: Record "Payment Method";
        SalesInvoiceHeader: Record "Sales Invoice Header";
    ...
    begin
        ...
        // Verify
        Assert.IsTrue(TempPaymentReportingArgument.IsEmpty, 'No Payment reporting Arguments should be created');
        VerifyPaymentServiceIsNotInReportDataset;
    end;

    [Test]
    [HandlerFunctions('SalesInvoiceReportRequestPageHandler')]
    [Scope('OnPrem')]
    procedure TestSalesInvoiceCannotPrintDisabledService()
    var
        TempTemplatePaymentServiceSetup: Record "Payment Service Setup" temporary;
        TempPaymentServiceSetup: Record "Payment Service Setup" temporary;
        PaymentMethod: Record "Payment Method";
    ...
    begin
        ...
        TempPaymentServiceSetup.Validate(Enabled, false);
        TempPaymentServiceSetup.Modify();
        PaymentServiceExtensionMock.SetPaymentServiceAccounts(TempPaymentServiceSetup);
