codeunit 134681 "RC Page Dispatcher Test"
{
    ...
    begin
        ...
        // [GIVEN] New pricing feature is on
        LibraryPriceCalculation.EnableExtendedPriceCalculation();
        // [WHEN] Run "Role Center Page Dispatcher" as Report "List Price Sheet"
        RunRoleCenterPageDispatcher(AllObjWithCaption."Object Type"::Report, Report::"List Price Sheet");
        // [THEN] Report "List Price Sheet V16" is open
        // handled by ListPriceSheetV16Handler
    end;
    ...
    begin
        ...
        // [GIVEN] New pricing feature is on
        LibraryPriceCalculation.EnableExtendedPriceCalculation();
        // [WHEN] Run "Role Center Page Dispatcher" as Report "Sales Promotion"
        RunRoleCenterPageDispatcher(AllObjWithCaption."Object Type"::Report, Report::"Sales Promotion");
    ...
    [RequestPageHandler]
    procedure ListPriceSheetV16Handler(var ListPriceSheetV16: TestRequestPage "List Price Sheet V16")
    begin
        ListPriceSheetV16.Cancel().Invoke();
    end;
