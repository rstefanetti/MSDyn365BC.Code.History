codeunit 139453 "O365 Customer Permission Test"
{
    ...
    begin
        ...
        // [SCENARIO 308913] Edit Posted Sales Credit Memo with "Posted Sales Cr. Memo - Update" from "Posted Sales Credit Memo" card with "D365 Sales Doc, Post" permission set.
        Initialize();
    ...
    begin
        // [FEATURE] [Sales Credit Memo]
        // [SCENARIO 308913] Edit Posted Sales Credit Memo with "Posted Sales Cr. Memo - Update" from "Posted Sales Credit Memos" list with "D365 Sales Doc, Post" permission set.
        Initialize();
        LibraryVariableStorage.Enqueue(LibraryPurchase.CreateVendorNo());  // "Consignor No."
