codeunit 139453 "O365 Customer Permission Test"
{
    ...
    [ModalPageHandler]
    [Scope('OnPrem')]
    procedure PostedSalesInvoiceUpdateOKModalPageHandler(var PstdSalesCrMemoUpdate: TestPage "Posted Sales Invoice - Update")
    begin
    ...
    [ModalPageHandler]
    [Scope('OnPrem')]
    procedure PostedSalesCrMemoUpdateOKModalPageHandler(var PostedSalesCrMemoUpdate: TestPage "Pstd. Sales Cr. Memo - Update")
    begin
