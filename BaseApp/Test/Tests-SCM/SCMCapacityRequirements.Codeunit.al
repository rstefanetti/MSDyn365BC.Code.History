codeunit 137074 "SCM Capacity Requirements"
{
    ...
    begin
        ...
        FindFirstProdOrderRoutingLine(ProdOrderRoutingLine, ProductionOrder."No.");
        VerifyCapacityNeedTime(ProdOrderRoutingLine, ProdOrderCapacityNeed."Time Type"::Setup, SetupTime, SetupTime);
        VerifyCapacityNeedTime(ProdOrderRoutingLine, ProdOrderCapacityNeed."Time Type"::Run, RunTime * Qty, RunTime * Qty);
        ...
        VerifyCapacityNeedTime(ProdOrderRoutingLine, ProdOrderCapacityNeed."Time Type"::Setup, SetupTime / 2, SetupTime);
        VerifyCapacityNeedTime(ProdOrderRoutingLine, ProdOrderCapacityNeed."Time Type"::Run, RunTime * Qty / 2, RunTime * Qty);
    end;
