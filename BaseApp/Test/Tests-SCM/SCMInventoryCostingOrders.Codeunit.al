codeunit 137292 "SCM Inventory Costing Orders"
{
    ...
    begin
        ...
        Item.Modify(true);
        UpdateInventorySetup(false, false, AverageCostCalcType::Item);
    ...
    begin
        ...
        UpdateInventorySetup(false, true, AverageCostCalcType::Item);
    ...
    local procedure UpdateInventorySetup(AutomaticCostPosting: Boolean; ExpectedCostPostingtoGL: Boolean; AvgCostCalcType: Option)
    var
        InventorySetup: Record "Inventory Setup";
    begin
