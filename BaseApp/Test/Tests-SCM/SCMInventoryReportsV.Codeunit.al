codeunit 137352 "SCM Inventory Reports - V"
{
    ...
    local procedure CreatePurchaseDocumentWithIT(var PurchaseLine: Record "Purchase Line"; DocumentType: Option; UseTrackingOption: Option; SNSpecific: Boolean; LocationCode: Code[10]; BinCode: Code[20])
    var
        Item: Record Item;
    begin
        LibraryInventory.CreateTrackedItem(
    ...
    local procedure CreateSalesDocumentWithIT(var SalesLine: Record "Sales Line"; DocumentType: Option; ItemNo: Code[20]; Quantity: Decimal; UseTrackingOption: Option)
    begin
