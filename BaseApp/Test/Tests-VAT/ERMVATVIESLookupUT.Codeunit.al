codeunit 134193 "ERM VAT VIES Lookup UT"
{
    ...
    begin
        ...
        UpdateVATRegLog(VATRegistrationLog, 'GB', VATRegLogAccountType::Customer, '10000');
    ...
    begin
        ...
        UpdateVATRegLog(VATRegistrationLog, 'GB', VATRegLogAccountType::Customer, Customer."No.");
    ...
    begin
        ...
        MockVATRegLog(VATRegistrationLog, VATRegLogDetailsStatus::"Not Valid");
        UpdateVATRegLog(VATRegistrationLog, 'GB', VATRegLogAccountType::Vendor, Vendor."No.");
    ...
    begin
        ...
        MockVATRegLog(VATRegistrationLog, VATRegLogDetailsStatus::"Not Valid");
        UpdateVATRegLog(VATRegistrationLog, 'GB', VATRegLogAccountType::Contact, Contact."No.");
    ...
    begin
        ...
        MockVATRegLog(VATRegistrationLog, VATRegLogDetailsStatus::"Not Valid");
        UpdateVATRegLog(VATRegistrationLog, 'GB', VATRegLogAccountType::"Company Information", '');
        PrepareVATRegLog(
    ...
    begin
        ...
        VATRegistrationLog."Account Type" := AccountType.AsInteger();
    ...
    begin
        ...
        VATRegistrationLogDetails.TestField("Account Type", VATRegLogAccountType);
