codeunit 18135 "GST Purchase Unregistered"
{
    ...
    procedure PostFormGSTPurchaseOrderUnregisterdVendorWithITCWithLineDiscountForFixedAsset()
    var
    ...
    [Test]
    [HandlerFunctions('TaxRatePageHandler')]
    procedure PostFormGSTPurchaseInvoiceUnregisterdVendorWithITCWithLineDiscountForFixedAsset()
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
        DocumentNo: Code[20];
    ...
    [Test]
    [HandlerFunctions('TaxRatePageHandler')]
    procedure PostFormGSTPurchaseOrderUnregisterdVendorWithoutITCWithLineDiscountForFixedAsset()
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
        DocumentNo: Code[20];
    ...
    [Test]
    [HandlerFunctions('TaxRatePageHandler')]
    procedure PostFormGSTPurchaseInvoiceUnregisterdVendorWithoutITCWithLineDiscountForFixedAsset()
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
        DocumentNo: Code[20];
    ...
    [HandlerFunctions('TaxRatePageHandler')]
    procedure PostFromGSTPurchaseOrderWithInputTaxCreditWithMultipleHSNCodeWiseForIntraStateUnreg()
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
        GSTGroupType: Enum "GST Group Type";
    ...
    [HandlerFunctions('TaxRatePageHandler')]
    procedure PostFromGSTPurchaseInvoiceWithInputTaxCreditWithMultipleHSNCodeWiseForIntraStateUnreg()
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
        GSTGroupType: Enum "GST Group Type";
    ...
    [HandlerFunctions('TaxRatePageHandler')]
    procedure PostFromGSTPurchaseOrderWithInputTaxCreditWithMultipleHSNCodeWiseForInterStateUnreg()
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
        GSTGroupType: Enum "GST Group Type";
    ...
    [HandlerFunctions('TaxRatePageHandler')]
    procedure PostFromGSTPurchaseInvoiceWithInputTaxCreditWithMultipleHSNCodeWiseForInterStateUnreg()
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
        GSTGroupType: Enum "GST Group Type";
    ...
    [HandlerFunctions('TaxRatePageHandler')]
    procedure PostFromGSTPurchaseOrderWithoutAvailmentWithMultipleHSNCodeWiseForInterStateUnreg()
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
        GSTGroupType: Enum "GST Group Type";
    ...
    [HandlerFunctions('TaxRatePageHandler')]
    procedure PostFromGSTPurchaseInvoiceWithoutAvailmentWithMultipleHSNCodeWiseForInterStateUnreg()
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
        GSTGroupType: Enum "GST Group Type";
    ...
    [Test]
    [HandlerFunctions('TaxRatePageHandler')]
    procedure CreatePurchaseOrderFromQuoteForGoodsUnRegisteredWithReverseExemptIntraSate()
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
    ...
    [Test]
    [HandlerFunctions('TaxRatePageHandler')]
    procedure PostFromPurchaseOrderForServiceUnregisteredWithReverseExemptIntraSate()
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
        GSTGroupType: Enum "GST Group Type";
    ...
    [Test]
    [HandlerFunctions('TaxRatePageHandler')]
    procedure PostFromPurchaseInvoiceForServiceUnregisteredWithReverseExemptIntraSate()
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
        GSTGroupType: Enum "GST Group Type";
    ...
    [Test]
    [HandlerFunctions('TaxRatePageHandler')]
    procedure CreatePurchaseOrderFromQuoteForServiceUnregisteredWithReverseExemptIntraSate()
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
        LibraryPurchase: codeunit "Library - Purchase";
    ...
    [Test]
    [HandlerFunctions('TaxRatePageHandler')]
    procedure PostFromPurchaseOrderUnregisteredVendorForFixedAssetWithLineDiscountWithITCForIntraState()
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
        GSTGroupType: Enum "GST Group Type";
    ...
    [Test]
    [HandlerFunctions('TaxRatePageHandler')]
    procedure PostFromPurchaseInvoiceUnregisteredVendorForFixedAssetWithLineDiscountWithITCForIntraState()
    var
        PurchaseHeader: Record "Purchase Header";
        PurchaseLine: Record "Purchase Line";
        GSTGroupType: Enum "GST Group Type";
