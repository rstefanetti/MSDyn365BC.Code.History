report 18002 "Archived Sales Order GST"
{
    DefaultLayout = RDLC;
    RDLCLayout = './rdlc/ArchivedSalesOrder.rdl';
        ...
        dataitem("Sales Header Archive"; "Sales Header Archive")
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(STRSUBSTNO_Text004_CopyText_; StrSubstNo(SalesOrderLbl, CopyText))
                    {
                    }
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        column(RoundLoopBody3Visibility; TempSalesLineArch.Type = TempSalesLineArch.Type::" ")
                        {
                        }
                        ...
                        column(RoundLoopBody4Visibility; TempSalesLineArch.Type <> TempSalesLineArch.Type::" ")
                        {
                        }
                        ...
                        begin
                            ...
                            if (TempSalesLineArch.Type = TempSalesLineArch.Type::"G/L Account") and (not ShowInterInfo) then
    ...
    var
        ...
        LocalCurreLbl: Label 'Local Currency';
