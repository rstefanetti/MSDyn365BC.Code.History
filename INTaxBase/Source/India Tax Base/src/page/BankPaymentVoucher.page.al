page 18550 "Bank Payment Voucher"
{
        ...
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                field("Job Queue Status"; "Job Queue Status")
                {
                    ...
                    ToolTip = 'Specifies the status of a job queue entry or task that handles the posting of Bank Payment Vouchers.';
                ...
                field("Applied Automatically"; "Applied Automatically")
                {
                    ApplicationArea = Basic, Suite;
                    Editable = false;
                    ToolTip = 'Specifies that the Bank Payment Voucher line has been automatically applied with a matching payment using the Apply Automatically function.';
                    Visible = false;
                }
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action(GetStandardJournals)
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    ToolTip = 'Select a standard Bank Payment Voucher to be inserted.';
            ...
            group("Opening Balance")
            {
                ...
                group("Prepare journal")
                {
                    ...
                    action("G/L Accounts Opening balance ")
                    {
                        ...
                        ToolTip = 'Creates Bank Payment Voucher line per G/L account to enable manual entry of G/L account open balances during the setup of a new company';
                    ...
                    action("Customers Opening balance")
                    {
                        ...
                        Image = TransferToGeneralJournal;
                        ToolTip = 'Creates Bank Payment Voucher line per Customer to enable manual entry of Customer open balances during the setup of a new company';
                    ...
                    action("Vendors Opening balance")
                    {
                        ...
                        Image = TransferToGeneralJournal;
                        ToolTip = 'Creates a Bank Payment Voucher line for each vendor. This lets you manually enter open balances for vendors when you set up a new company.';
            ...
            group("Page")
            {
                ...
                action(ClassicView)
                {
                    ...
                    begin
                        ...
                        CurrPage.Close();
                        GenJnlManagement.SetJournalSimplePageModePreference(false, Page::"Bank Payment Voucher");
                        GenJnlManagement.SetLastViewedJournalBatchName(Page::"Bank Payment Voucher", CurrentJnlBatchName);
                        Page.Run(Page::"Bank Payment Voucher");
                    end;
                }
                action(SimpleView)
                {
                    ...
                    begin
                        ...
                        CurrPage.Close();
                        GenJnlManagement.SetJournalSimplePageModePreference(true, Page::"Bank Payment Voucher");
                        GenJnlManagement.SetLastViewedJournalBatchName(Page::"Bank Payment Voucher", CurrentJnlBatchName);
                        Page.Run(Page::"Bank Payment Voucher");
                    end;
                }
    ...
    begin
        ...
        VoucherTemplateSelection(Page::"Bank Payment Voucher", VoucherEnum::"Bank Payment Voucher", false, Rec, JnlSelected);
