page 18553 "Bank Receipt Voucher"
{
    ...
    begin
        ...
        VoucherTemplateSelection(Page::"Bank Receipt Voucher", VoucherEnum::"Bank Receipt Voucher", false, Rec, JnlSelected);
    ...
    local procedure GetGnJnlNarration(var GenNarration: Record "Gen. Journal Narration"; LineNarration: Boolean)
    begin
        GenNarration.Reset();
        GenNarration.SetRange("Journal Template Name", "Journal Template Name");
        GenNarration.SetRange("Journal Batch Name", "Journal Batch Name");
