page 18554 "Cash Payment Voucher"
{
    ...
    begin
        ...
        VoucherTemplateSelection(Page::"Cash Payment Voucher", VoucherEnum::"Cash Payment Voucher", false, Rec, JnlSelected);
    ...
    var
        ...
        PageTemplateLbl: Label '%1', Comment = '%1 = PageTemplate';
                ...
                begin
                    ...
                    if not RecurringJnl then begin
                        ...
                        if PageTemplate = PageTemplate::Assets then
                            ...
                            GenJnlTemplate.Description := StrSubstNo(PageTemplateLbl, PageTemplate);
                    end else begin
