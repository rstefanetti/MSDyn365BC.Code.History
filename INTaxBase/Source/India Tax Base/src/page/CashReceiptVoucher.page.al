page 18555 "Cash Receipt Voucher"
{
    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number of the incoming document that this Cash Receipt Voucher line is created for.';
                    Visible = false;
                ...
                field("Job Queue Status"; "Job Queue Status")
                {
                    ...
                    ToolTip = 'Specifies the status of a job queue entry or task that handles the posting of Cash Receipt Vouchers.';
                ...
                field("Applied Automatically"; "Applied Automatically")
                {
                    ApplicationArea = Basic, Suite;
                    Editable = false;
                    ToolTip = 'Specifies that the Cash Receipt Voucher line has been automatically applied with a matching payment using the Apply Automatically function.';
                    Visible = false;
                }
            ...
            group(Narration)
            {
                ...
                field("Narration "; NarrationText)
                {
                    ...
                    trigger OnValidate()
                    begin
                        SplitNarration(NarrationText, false);
                    end;
                }
            }
            group(Control30)
                ...
                fixed(Control1901776101)
                {
                    ...
                    group("Total Debit")
                    {
                        ...
                        field(DisplayTotalDebit; GetTotalDebitAmt())
                        {
                            ...
                            Caption = 'Total Debit';
                            Editable = false;
                            ToolTip = 'Specifies the total debit amount in the Cash Receipt Voucher.';
                        }
                    }
                    group("Total Credit")
                    {
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action(GetStandardJournals)
                {
                    ...
                    Promoted = true;
                    PromotedCategory = Process;
                    ToolTip = 'Select a standard Cash Receipt Voucher to be inserted.';
                    ...
                    begin
                        ...
                        if Page.RunModal(Page::"Standard General Journals", StdGenJnl) = Action::LookupOK then begin
                            ...
                            Message(CashReceiptInsertedMsg, StdGenJnl.Code);
                        end;
            ...
            group("Opening Balance")
            {
                ...
                group("Prepare journal")
                {
                    ...
                    action("G/L Accounts Opening balance ")
                    {
                        ...
                        ToolTip = 'Creates Cash Receipt Voucher line per G/L account to enable manual entry of G/L account open balances during the setup of a new company';
                    ...
                    action("Customers Opening balance")
                    {
                        ...
                        Image = TransferToGeneralJournal;
                        ToolTip = 'Creates Cash Receipt Voucher line per Customer to enable manual entry of Customer open balances during the setup of a new company';
                    ...
                    action("Vendors Opening balance")
                    {
                        ...
                        Image = TransferToGeneralJournal;
                        ToolTip = 'Creates a Cash Receipt Voucher line for each vendor. This lets you manually enter open balances for vendors when you set up a new company.';
            ...
            group("Page")
            {
                ...
                action(ClassicView)
                {
                    ...
                    begin
                        ...
                        CurrPage.Close();
                        GenJnlManagement.SetJournalSimplePageModePreference(false, Page::"Cash Receipt Voucher");
                        GenJnlManagement.SetLastViewedJournalBatchName(Page::"Cash Receipt Voucher", CurrentJnlBatchName);
                        Page.Run(Page::"Cash Receipt Voucher");
                    end;
                }
                action(SimpleView)
                {
                    ...
                    begin
                        ...
                        CurrPage.Close();
                        GenJnlManagement.SetJournalSimplePageModePreference(true, Page::"Cash Receipt Voucher");
                        GenJnlManagement.SetLastViewedJournalBatchName(Page::"Cash Receipt Voucher", CurrentJnlBatchName);
                        Page.Run(Page::"Cash Receipt Voucher");
                    end;
                }
    ...
    begin
        ...
        VoucherTemplateSelection(Page::"Cash Receipt Voucher", VoucherEnum::"Cash Receipt Voucher", false, Rec, JnlSelected);
    ...
    var
        ...
        Text004Msg: Label 'Fixed Asset G/L Journal';
        Text005Msg: Label '%1', Comment = '%1 = PageTemplate';
        Text002Msg: Label 'RECURRING';
        Text003Msg: Label 'Recurring General Journal';
    begin
        JnlSelected := true;
                ...
                begin
                    ...
                    if not RecurringJnl then begin
                        ...
                        if PageTemplate = PageTemplate::Assets then
                            GenJnlTemplate.Description := Text004Msg
                        else
                            GenJnlTemplate.Description := StrSubstNo(Text005Msg, PageTemplate);
                    end else begin
                        GenJnlTemplate.Name := Text002Msg;
                        GenJnlTemplate.Description := Text003Msg;
                    end;
    ...
    local procedure SplitNarration(NarrationText: Text[2000]; IsLineNarration: Boolean)
    var
        SPos: Integer;
        EPos: Integer;
        i: Integer;
    ...
    begin
        ...
        UpdateNarration(SplitedText, IsLineNarration);
    end;

    local procedure UpdateNarration(NarrationText: List of [Text]; IsLineNarration: Boolean)
    var
