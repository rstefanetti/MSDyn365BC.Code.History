...
codeunit 148045 "Test Payroll Imp. Gen. Jnl. Ln"
{
    ...
    local procedure CreateTempGenJnlLine(var TempGenJnlLine: Record "Gen. Journal Line" temporary; GenJnlLineTemplate: Record "Gen. Journal Line"; LineNo: Integer; DocumentNo: Code[20]; AccountNo: Code[20]; PostingDate: Date; Description: Text[50]; TransactionInfo: Text[100]; Amount: Decimal; EntryNo: Integer; ExchLineNo: Integer);
    BEGIN
