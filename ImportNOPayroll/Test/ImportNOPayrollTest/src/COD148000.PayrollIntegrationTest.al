codeunit 148000 "Payroll Integration Test"
{
    ...
    local procedure CreateTempGenJnlLine(var TempGenJnlLine: Record "Gen. Journal Line" temporary; GenJnlLineTemplate: Record "Gen. Journal Line"; LineNo: Integer; DocumentNo: Code[20]; AccountNo: Code[20]; PostingDate: Date; Description: Text[50]; Quantity: Decimal; Amount: Decimal; DimCode1: code[20]; DimCode2: code[20]);
    BEGIN
