codeunit 148041 "MX DIOT UT"
{
    ...
    begin
        ...
        CreateAndPostGenJournalLineForDIOTVendor(VATPostingSetup, Vendor."No.", Vendor."DIOT Type of Operation"::"Prof. Services");
    ...
    local procedure CreateAndPostGeneralJournaLineAppliedToInvoice(var GenJournalLine: Record "Gen. Journal Line"; DocumentType: Option; AccountNo: Code[20]; Amount: Decimal; AppliesToPurchaseInvoiceNo: Code[20])
    begin
