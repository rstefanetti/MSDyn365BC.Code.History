table 11512 "Swiss QR-Bill Setup"
{
    ...
    begin
        if "Journal Template" = '' then
            InitDefaultJournalSetupForGivenType(DummyGenJournalTemplate.Type::Purchases);
    end;

    local procedure InitDefaultJournalSetupForGivenType(GenJournalTemplateType: Option)
    var
