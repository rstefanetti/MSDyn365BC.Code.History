codeunit 148096 "Swiss QR-Bill Test Purchases"
{
    ...
    begin
        ...
        CreatePurchaseHeader(PurchaseHeader, PurchaseHeader."Document Type"::Invoice, '', false, '');
    ...
    begin
        ...
        CreatePurchaseHeader(PurchaseHeader, PurchaseHeader."Document Type"::Invoice, '', true, '');
    ...
    begin
        ...
        CreatePurchaseHeader(PurchaseHeader, PurchaseHeader."Document Type"::Order, '', false, '');
    ...
    begin
        ...
        CreatePurchaseHeader(PurchaseHeader, PurchaseHeader."Document Type"::Order, '', true, '');
    ...
    begin
        ...
        CreatePurchaseHeader(PurchaseHeader, PurchaseHeader."Document Type"::Invoice, VendorNo, false, '');
    ...
    begin
        ...
        SwissQRBillTestLibrary.CreateVendorWithBankAccount(VendorNo, VendorBankAccountNo, IBAN);
        QRCodeText := SwissQRBillTestLibrary.CreateQRCodeText(IBAN, 123.45, 'CHF', PaymentReference, 'Unstr Msg', BillInfo);
        CreatePurchaseHeader(PurchaseHeader, PurchaseHeader."Document Type"::Invoice, VendorNo, true, '123');
    ...
    begin
        ...
        Initialize();
        CreatePurchaseHeader(PurchaseHeader, PurchaseHeader."Document Type"::Invoice, '', true, '123');
    ...
    begin
        ...
        BillInfo := 'S1/10/DOCNO123';
        QRCodeText := SwissQRBillTestLibrary.CreateQRCodeText(IBAN, 123.45, 'CHF', PaymentReference, 'Unstr Msg', BillInfo);
        CreatePurchaseHeader(PurchaseHeader, PurchaseHeader."Document Type"::Invoice, '', false, '123');
    ...
    begin
        ...
        PaymentReference := SwissQRBillTestLibrary.GetRandomQRPaymentReference();
        SwissQRBillTestLibrary.CreateVendorWithBankAccount(VendorNo, VendorBankAccountNo, IBAN);
        CreatePurchaseHeader(PurchaseHeader, PurchaseHeader."Document Type"::Invoice, VendorNo, false, PaymentReference);
    ...
    begin
        ...
        PaymentReference := SwissQRBillTestLibrary.GetRandomQRPaymentReference();
        SwissQRBillTestLibrary.CreateVendorWithBankAccount(VendorNo, VendorBankAccountNo, IBAN);
        CreatePurchaseHeader(PurchaseHeader, PurchaseHeader."Document Type"::Order, VendorNo, false, PaymentReference);
    ...
    begin
        ...
        SwissQRBillTestLibrary.CreateVendorWithBankAccount(VendorNo, VendorBankAccountNo, IBAN);
        QRCodeText := SwissQRBillTestLibrary.CreateQRCodeText(IBAN, 123.45, 'CHF', PaymentReference, 'Unstr Msg', BillInfo);
        CreatePurchaseHeader(PurchaseHeader, PurchaseHeader."Document Type"::Order, VendorNo, false, '');
    ...
    begin
        ...
        CreatePurchaseHeader(PurchaseHeader, PurchaseHeader."Document Type"::Invoice, VendorNo, false, '123');
    ...
    local procedure CreatePurchaseHeader(var PurchaseHeader: Record "Purchase Header"; DocumentType: Option; VendorNo: Code[20]; QRBill: Boolean; PmtRef: Code[50])
    begin
