page 4705 "VAT Group Setup Guide"
{
    ...
    layout
    {
        area(Content)
        {
            ...
            {
                ShowCaption = false;
                Visible = Step = Step::"Setup Member OAuth2";
    ...
    var
        ...
        NextEnabled, BackEnabled, FinishEnabled, TopBannerVisible, DoneVisible, JobQueueVisible, IsJobQueueEnabled, TestConnectionVisible, IsSaaS : Boolean;
