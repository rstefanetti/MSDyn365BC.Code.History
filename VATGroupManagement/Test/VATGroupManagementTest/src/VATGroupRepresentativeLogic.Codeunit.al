codeunit 139746 "VAT Group Representative Logic"
{
    ...
    var
        ...
        GLAccountCategory: Option " ",Assets,Liabilities,Equity,Income,"Cost of Goods Sold",Expense;
    ...
    begin
        LibraryERM.CreateGenJournalTemplate(GenJournalTemplate);
        GenJournalTemplate."No. Series" := LibraryERM.CreateNoSeriesCode();
    ...
    local procedure CreateGLAccountNo(Category: Option): Code[20]
    var
