codeunit 1362 "MS - WorldPay Create Demo Data"
{
    ...
    begin
        ...
        MSWorldPayStandardAccount.Name := DemoAccountPrefixTxt + MSWorldPayStandardAccount.Name;
        MSWorldPayStandardAccount.Description := DemoAccountPrefixTxt + MSWorldPayStandardAccount.Description;
